...
(function (global) {
  ...
  const ANCHORS = {
    ...
    19: { noun: 'magma-rhino calf', features: ['its lava-plated hide', 'its molten horn-nub', 'its stubby armoured legs'], coreLine: 'It lowers its head and barrels straight at danger.' },
    20: { noun: 'magma-rhino', features: ['its fire-hardened plated hide', 'its heat-radiating horn', 'its heat-sensing snout-pits'], coreLine: 'It charges with startling speed, cracking stone.' },
    21: { noun: 'great magma-rhino', features: ['its thick terracotta hide', 'its fire-hardened plates', 'its white-hot charging horn'], coreLine: 'Its charge shatters bedrock and furrows stone.' },
    ...
    40: { noun: 'winged manta-ray', features: ['its broad pectoral wing-fins', 'its flat manta-like head', 'its streamlined blue-grey body'], coreLine: 'It carries the manta’s glide into open water.' },
    ...
    69: { noun: 'seed sprite', features: ['its smooth green seed-body', 'its two tiny sprout-legs', 'the leaf tendrils framing its face'], coreLine: 'Cornered, it tucks into a pod and rolls into a tackle.' },
    70: { noun: 'walking seed-pod', features: ['its split green husk-limbs', 'the soft moss within it', 'its lumbering pod-body'], coreLine: 'It swings its heavy husk-limbs to drive off threats.' },
    71: { noun: 'walking-garden titan', features: ['its enormous overgrown husk', 'the saplings and trees rooted across it', 'its grove-bearing bulk'], coreLine: 'It uproots its own trees to swing at threats to the grove.' },
    ...
    132: { noun: 'obsidian gargoyle', features: ['its jet-black glassy hide', 'its razor wing-ridges', 'its horned brow'], coreLine: 'It perches motionless, then lunges from cover.' },
    133: { noun: 'great obsidian gargoyle', features: ['its broad razor-edged glass wings', 'its near-indestructible obsidian hide', 'its deep-set red eyes'], coreLine: 'By day a still idol; by night it spreads its wings.' },
    ...
    150: { noun: 'spark centipede', features: ['its interlocking metallic plates', 'its many scurrying legs', 'the sparks leaping between its segments'], coreLine: 'Static still leaps segment to segment as it scurries.' },
    151: { noun: 'electric centipede', features: ['its conductive plated length', 'the glowing charged seam down its back', 'its electrified bite'], coreLine: 'A charged core still glows the length of its body.' },
    ...
    191: { noun: 'pebble roly-poly', features: ['its segmented gravel-colored shell', 'its many tiny legs', 'the way it curls into a pebble'], coreLine: 'It curls into a stone-ball when startled.' },
    192: { noun: 'boulder roly-poly', features: ['its overlapping stone plates', 'its many short stony legs', 'its boulder-rolled form'], coreLine: 'It curls into a boulder and rolls downhill in a landslide.' },
    ...
    215: { noun: 'psychic mist-wisp', features: ['its condensed violet energy', 'its shifting sphere-to-mist form', 'the cold haze trailing it'], coreLine: 'It drifts between sphere and shapeless psychic mist.' },
    216: { noun: 'psychic fog', features: ['its rotating particle-body', 'its diffuse violet haze', 'its slow rolling drift'], coreLine: 'Its scattered motes turn like fog in slow thought.' },
    217: { noun: 'bodiless haze-mind', features: ['its near-invisible shimmer', 'the warp it leaves in the air', 'its scattered hazy awareness'], coreLine: 'It presses on the mind from within a shimmering haze.' },
    ...
    242: { noun: 'spark firefly', features: ['its glowing pulsing abdomen', 'its tiny luminous body', 'its delicate wings'], coreLine: 'Its abdomen pulses with paired flashes and a low hum.' },
    ...
    251: { noun: 'young rock-lobster', features: ['its brittle ore-flecked carapace', 'its steel-veined shell', 'its small claws'], coreLine: 'It pries ore from cave walls to harden its shell.' },
    252: { noun: 'armored rock-lobster', features: ['its granite-and-steel carapace', 'its boulder-crushing claws', 'its dense plating'], coreLine: 'Its great claws crush stone to powder.' },
    ...
    261: { noun: 'dream-bloom faun', features: ['its dream-pollen leaf-antlers', 'its overlapping leaf-scales', 'its slender faun frame'], coreLine: 'Its antler-pollen lulls those near it into waking dreams.' },
    ...
    278: { noun: 'iron foal', features: ['its silver-grey fairy-iron barding', 'its small valiant frame', 'its glinting plates'], coreLine: 'It still keeps watch like a sworn young steed.' },
    279: { noun: 'steel unicorn', features: ['its refined steel coat', 'its single straight horn', 'its steadfast stance'], coreLine: 'It still bears itself with regal resolve.' },
    ...
    304: { noun: 'yeti cub', features: ['its frost-crusted white fur', 'its snow-packed pelt', 'the cold radiating off it'], coreLine: 'It huddles with its kind against the cold.' },
    305: { noun: 'adolescent yeti', features: ['its shaggy white coat', 'its heavy muscle', 'its freezing breath'], coreLine: 'Its breath fogs and freezes the mountain air.' },
    306: { noun: 'mountain yeti', features: ['its towering white-furred bulk', 'the glaciers forming in its wake', 'its frozen-stone muscle'], coreLine: 'Glaciers form spontaneously where it walks.' },
    ...
    309: { noun: 'spectral pinniped', features: ['its dark blue-black hide', 'its broad seal-like head', 'its phasing form'], coreLine: 'It still surfaces silent as a drowned memory.' },
    ...
    333: { noun: 'electric eel', features: ['its long blue-black sinuous body', 'the violet voltage glowing along its flanks', 'its needle-fanged bite'], coreLine: 'Stored voltage still crackles down its length.' },
    334: { noun: 'combat battlebot', features: ['its riveted armour plating', 'the high-voltage cabling along its limbs', 'its piston-driven fists'], coreLine: 'Surplus charge arcs between its knuckles with every swing.' },
    ...
    337: { noun: 'young ash golem', features: ['its cooling basalt body', 'its magma-bright cracks', 'the ash it sheds'], coreLine: 'Its basalt shell slowly tempers toward steel.' },
    ...
    342: { noun: 'crowned wraith', features: ['its crown of black flame', 'its bound humanoid wraith-form', 'its commanding presence'], coreLine: 'It rules a small haunt — for now, still bound to a form.' },
    343: { noun: 'formless shadow', features: ['its body of pure living shadow', 'its two luminous violet eyes', 'its ever-shifting silhouette'], coreLine: 'Freed of form, it tears loose from any cast light.' },
    ...
    347: { noun: 'forged steel golem', features: ['its superheated steel body', 'its white-hot joints', 'its forged guardian frame'], coreLine: 'Its seams still glow forge-bright with heat.' },
    ...
    349: { noun: 'young ice golem', features: ['its clear glacial-ice body', 'its embedded raw crystals', 'its keep-like ridges'], coreLine: 'A glacial awareness slowly stirs in its crystal core.' },
    ...
    359: { noun: 'ice sovereign', features: ['its body of deep blue glacial ice', 'its carved idealised form', 'its cold awakened gaze'], coreLine: 'Its awakened glacial mind radiates a profound stillness.' },
    ...
    369: { noun: 'dense gravity golem', features: ['its ultra-dense crystalline body', 'the stones drifting up toward it', 'its mass-warped pull'], coreLine: 'Gravity bends around its sheer crystalline density.' },
    ...
    377: { noun: 'ultra-dense core titan', features: ['its compressed ultra-dense alloy body', 'its planet-core crushing weight', 'the minerals forging within it'], coreLine: 'It carries the weight of a planet’s core.' },
    ...
    385: { noun: 'ancient glacial titan', features: ['its colossal glacier body', 'its earth-fused frozen limbs', 'its deep-freezing ground-aura'], coreLine: 'The ground freezes 50 metres deep beneath its tread.' },
