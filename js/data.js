...
const MOVES_DATA = {
  // --- Normal ---
  collide:       { name:"Collide",        type:"Normal",   power:40,  acc:100, pp:35, cat:"physical", effect:null,        ec:0,   desc:"A basic tackle attack." },
  graze:      { name:"Graze",         type:"Normal",   power:40,  acc:100, pp:35, cat:"physical", effect:null,        ec:0,   desc:"Scratches the foe with sharp claws." },
  cranial_ram:     { name:"Cranial Ram",   type:"Normal",   power:70,  acc:100, pp:15, cat:"physical", effect:"flinch",    ec:30,  desc:"A forceful headbutt that may cause flinching." },
  crushing_bulk:    { name:"Crushing Bulk",  type:"Normal",   power:85,  acc:100, pp:15, cat:"physical", effect:"paralyze",  ec:30,  desc:"Slams the foe with a massive body. May paralyze." },
  radiance_cannon:   { name:"Radiance Cannon",    type:"Normal",   power:150, acc:90,  pp:5,  cat:"special",  effect:"recharge",  ec:100, desc:"A powerful beam. Must recharge next turn." },
  blitz: { name:"Blitz",  type:"Normal",   power:40,  acc:100, pp:30, cat:"physical", effect:"priority",  ec:0,   desc:"Attacks first with blinding speed." },
  daunt:        { name:"Daunt",         type:"Normal",   power:0,   acc:100, pp:40, cat:"status",   effect:"atkdown",   ec:100, desc:"Lowers the foe's Attack." },
  lashing_tail:    { name:"Lashing Tail",  type:"Normal",   power:0,   acc:100, pp:30, cat:"status",   effect:"defdown",   ec:100, desc:"Lowers the foe's Defense." },
  baleful_stare:         { name:"Baleful Stare", type:"Normal",   power:0,   acc:100, pp:30, cat:"status",   effect:"defdown",   ec:100, desc:"Menacing glare lowers the foe's Defense." },
  second_wind:      { name:"Second Wind",   type:"Normal",   power:0,   acc:100, pp:10, cat:"status",   effect:"heal50",    ec:100, desc:"Restores up to half the user's max HP." },
  war_dance: { name:"War Dance",  type:"Normal",   power:0,   acc:100, pp:20, cat:"status",   effect:"atkup2",    ec:100, desc:"Raises the user's Attack by 2 stages." },
  fortify:       { name:"Fortify",       type:"Normal",   power:0,   acc:100, pp:30, cat:"status",   effect:"defup",     ec:100, desc:"Stiffens the body to raise Defense." },
  ...
  inferno_jet: { name:"Inferno Jet",  type:"Fire",     power:90,  acc:100, pp:15, cat:"special",  effect:"atkup",      ec:30,  desc:"Shoots a stream of intense fire. May burn." },
  pyroclasm:   { name:"Pyroclasm",     type:"Fire",     power:110, acc:85,  pp:5,  cat:"special",  effect:"burn",      ec:10,  desc:"A massive fireball. May burn the target." },
  searing_gale:    { name:"Searing Gale",  type:"Fire",     power:95,  acc:90,  pp:10, cat:"special",  effect:"burn",      ec:10,  desc:"Exhales a wave of scorching heat." },
  conflagration:      { name:"Conflagration", type:"Fire",     power:100, acc:85,  pp:5,  cat:"special",  effect:"burn",      ec:100, desc:"A raging inferno that always burns." },
  ...
  // --- Aquatic ---
  aquatic_gun:    { name:"Aquatic Gun",     type:"Aquatic",    power:40,  acc:100, pp:25, cat:"special",  effect:null,        ec:0,   desc:"Squirts water at the foe." },
  tidal_sweep:    { name:"Tidal Sweep",     type:"Aquatic",    power:90,  acc:90,  pp:10, cat:"physical", effect:null,        ec:0,   desc:"Attacks with a powerful water tail." },
  tidal_rush:         { name:"Tidal Rush",          type:"Aquatic",    power:90,  acc:100, pp:15, cat:"special",  effect:null,        ec:0,   desc:"A powerful wave crashes over the foe." },
  tsunami:   { name:"Tsunami",       type:"Aquatic",    power:110, acc:80,  pp:5,  cat:"special",  effect:null,        ec:0,   desc:"Blasts the foe with a powerful water jet." },
  bubble_jet:  { name:"Bubble Jet",   type:"Aquatic",    power:65,  acc:100, pp:20, cat:"special",  effect:"spedown",   ec:10,  desc:"Shoots bubbles that may reduce Speed." },
  ...
  pod_blast:    { name:"Pod Blast",     type:"Nature",    power:80,  acc:100, pp:15, cat:"physical", effect:null,        ec:0,   desc:"Drops a giant seed bomb on the foe." },
  verdant_orb:  { name:"Verdant Orb",   type:"Nature",    power:90,  acc:100, pp:10, cat:"special",  effect:"spdefdown", ec:10,  desc:"A ball of energy drawn from nature." },
  ...
  slumber_dust: { name:"Slumber Dust",  type:"Nature",    power:0,   acc:75,  pp:15, cat:"status",   effect:"sleep",     ec:100, desc:"Scatters a powder that induces sleep." },
  ...
  stormbolt:      { name:"Stormbolt",     type:"Electric", power:110, acc:70,  pp:10, cat:"special",  effect:"paralyze",  ec:30,  desc:"A massive thunderstrike. May paralyze." },
  stun_pulse: { name:"Stun Pulse",    type:"Electric", power:0,   acc:90,  pp:20, cat:"status",   effect:"paralyze",  ec:100, desc:"A weak electrical charge that paralyzes." },
  static_strike:        { name:"Static Strike", type:"Electric", power:65,  acc:100, pp:20, cat:"physical", effect:"paralyze",  ec:30,  desc:"Electric tackle. May paralyze." },
  ...
  // --- Earth ---
  mud_spray:     { name:"Mud Spray",     type:"Earth",   power:55,  acc:95,  pp:15, cat:"special",  effect:"spedown",   ec:100, desc:"Hurls mud at the foe, lowering Speed." },
  tectonic_shift:   { name:"Tectonic Shift", type:"Earth",   power:100, acc:100, pp:10, cat:"physical", effect:null,        ec:0,   desc:"A massive earthquake rattles the field." },
  geoblast:  { name:"Geoblast",      type:"Earth",   power:90,  acc:100, pp:10, cat:"special",  effect:"spdefdown", ec:10,  desc:"The ground heaves beneath the foe." },
  ...
  // --- Wind ---
  breeze:         { name:"Breeze",        type:"Wind",     power:40,  acc:100, pp:35, cat:"special",  effect:null,        ec:0,   desc:"Blows the foe with a gust of wind." },
  wind_scythe:    { name:"Wind Scythe",   type:"Wind",     power:75,  acc:95,  pp:15, cat:"special",  effect:"flinch",    ec:30,  desc:"Slices with a blade of air. May flinch." },
  typhoon:    { name:"Typhoon",       type:"Wind",     power:110, acc:70,  pp:10, cat:"special",  effect:"confuse",   ec:30,  desc:"Slams the foe into a violent hurricane." },
  ...
  // --- Ice ---
  flurries:  { name:"Flurries",      type:"Ice",      power:40,  acc:100, pp:25, cat:"special",  effect:"freeze",    ec:10,  desc:"Pelts the foe with a hail of snow." },
  cold_beam:     { name:"Cold Beam",     type:"Ice",      power:90,  acc:100, pp:10, cat:"special",  effect:"freeze",    ec:10,  desc:"Fires a beam of ice. May freeze." },
  whiteout:     { name:"Whiteout",      type:"Ice",      power:110, acc:70,  pp:5,  cat:"special",  effect:"freeze",    ec:10,  desc:"A howling blizzard. May freeze." },
  glacial_punch:    { name:"Glacial Punch", type:"Ice",      power:75,  acc:100, pp:15, cat:"physical", effect:"freeze",    ec:10,  desc:"A punch with an icy fist. May freeze." },
  frost_crash: { name:"Frost Crash",  type:"Ice",      power:85,  acc:90,  pp:10, cat:"physical", effect:"flinch",    ec:30,  desc:"Drops icicles on the foe. May flinch." },
  rime_shard:{ name:"Rime Shard", type:"Ice",      power:65,  acc:100, pp:20, cat:"physical", effect:"freeze",    ec:15,  desc:"Fires a razor-sharp shard of glacial ice that may freeze the target." },
  cold_snap: { name:"Cold Snap",     type:"Ice",      power:60,  acc:90,  pp:15, cat:"special",  effect:"freeze",    ec:100, desc:"Exhales a breath of supercooled air that always freezes the foe." },
  ...
  // --- Dark ---
  chomp:         { name:"Chomp",          type:"Dark",     power:60,  acc:100, pp:25, cat:"physical", effect:"flinch",    ec:30,  desc:"Bites with dark power. May cause flinching." },
  jaw_crush:       { name:"Jaw Crush",        type:"Dark",     power:80,  acc:100, pp:15, cat:"physical", effect:"defdown",   ec:20,  desc:"Crunches with dark fangs. May lower Defense." },
  nether_sphere:  { name:"Nether Sphere",   type:"Dark",     power:80,  acc:100, pp:15, cat:"special",  effect:"spdefdown", ec:20,  desc:"Hurls a shadowy blob. May lower Sp.Def." },
  dusk_slash:  { name:"Dusk Slash",   type:"Dark",     power:70,  acc:100, pp:15, cat:"physical", effect:"crit",      ec:100, desc:"Slashes in the dark. High critical rate." },
  void_pulse:   { name:"Void Pulse",    type:"Dark",     power:80,  acc:100, pp:15, cat:"special",  effect:"flinch",    ec:20,  desc:"Fires pulses of dark energy." },
  ...
  // --- Metal ---
  metal_wing:   { name:"Metal Wing",    type:"Metal",    power:70,  acc:90,  pp:25, cat:"physical", effect:"defup",     ec:10,  desc:"Strikes with steel wings. May raise Defense." },
  alloy_tail:    { name:"Alloy Tail",     type:"Metal",    power:100, acc:75,  pp:15, cat:"physical", effect:"defdown",   ec:30,  desc:"Slams with a steel-hard tail. May lower Defense." },
  forge_blast_2: { name:"Forge Blast",  type:"Metal",    power:80,  acc:100, pp:10, cat:"special",  effect:"spdefdown", ec:10,  desc:"Fires a flash of steel-colored light." },
  chrome_claw:   { name:"Chrome Claw",    type:"Metal",    power:50,  acc:95,  pp:35, cat:"physical", effect:"atkup",     ec:10,  desc:"Slashes with steel claws. May raise Attack." },
  ...
  // --- Mental ---
  mind_jolt:    { name:"Mind Jolt",     type:"Mental",  power:50,  acc:100, pp:25, cat:"special",  effect:"confuse",   ec:10,  desc:"A telekinetic attack. May confuse." },
  psi_burst:      { name:"Psi Burst",       type:"Mental",  power:65,  acc:100, pp:20, cat:"special",  effect:"confuse",   ec:10,  desc:"Shoots a peculiar ray. May confuse." },
  mental: { name:"Mental",       type:"Mental",  power:90,  acc:100, pp:10, cat:"special",  effect:"spdefdown", ec:10,  desc:"A powerful psychic wave. May lower Sp.Def." },
  psi_strike:    { name:"Psi Strike",     type:"Mental",  power:100, acc:100, pp:10, cat:"special",  effect:null,        ec:0,   desc:"Materializes psychic power to attack." },
  inner_calm:    { name:"Inner Calm",     type:"Mental",  power:0,   acc:100, pp:20, cat:"status",   effect:"calmup",    ec:100, desc:"Raises Sp.Atk and Sp.Def by 1 stage." },
  ...
  saurian_roar:{ name:"Saurian Roar", type:"Draconic",   power:0,   acc:100, pp:15, cat:"status",   effect:"atkdown",   ec:100, desc:"Unleashes a terrifying Saurian Roar that withers the foe's fighting spirit." },
  ...
  // --- Earth ---
  stone_throw:   { name:"Stone Throw",    type:"Earth",     power:50,  acc:90,  pp:15, cat:"physical", effect:null,        ec:0,   desc:"Hurls a small rock at the foe." },
  stone_slide:   { name:"Stone Slide",    type:"Earth",     power:75,  acc:90,  pp:10, cat:"physical", effect:"flinch",    ec:30,  desc:"Large boulders fall on the foe. May flinch." },
  crag_strike:   { name:"Crag Strike",    type:"Earth",     power:100, acc:80,  pp:5,  cat:"physical", effect:"crit",      ec:100, desc:"Stabs with sharp stones. High critical." },
  ...
  // --- Nature ---
  mandible_bite:     { name:"Mandible Bite",      type:"Nature",      power:60,  acc:100, pp:20, cat:"physical", effect:null,        ec:0,   desc:"Bites the foe with bug mandibles." },
  resonance_hum:     { name:"Resonance Hum",      type:"Nature",      power:90,  acc:100, pp:10, cat:"special",  effect:"spdefdown", ec:10,  desc:"Emits a harsh buzzing sound." },
  shear_strike:    { name:"Shear Strike",     type:"Nature",      power:80,  acc:100, pp:15, cat:"physical", effect:null,        ec:0,   desc:"Slashes the foe in an X shape." },
  silk_spray:  { name:"Silk Spray",    type:"Nature",      power:0,   acc:95,  pp:40, cat:"status",   effect:"spedown2",  ec:100, desc:"Binds the foe with string, slowing them." },
  ...
  tundra_tomb: { name:"Tundra Tomb",  type:"Ice",      power:95,  acc:85,  pp:10, cat:"special",  effect:"freeze",    ec:20,  desc:"Encases the foe in a tomb of glacial ice that may leave them frozen." },
  ...
  tenebrous_snare:{ name:"Tenebrous Snare", type:"Dark",     power:70,  acc:95,  pp:15, cat:"special",  effect:"spedown",   ec:30,  desc:"Tendrils of darkness coil around the foe, dragging them into sluggishness." },
  ...
  magma_stone:   { name:"Magma Stone",    type:"Earth",     power:85,  acc:90,  pp:10, cat:"special",  effect:"burn",      ec:20,  desc:"Hurls a boulder of still-molten magma rock that scorches on impact." },
  ...
  lava_spout:    { name:"Lava Spout",    type:"Fire",     power:80,  acc:100, pp:15, cat:"special",  effect:"burn",      ec:30,  desc:"Erupts lava in all directions, likely to burn." },
  ...
  // Grass (+7 → 22)
  verdant_edge:    { name:"Verdant Edge",  type:"Nature",    power:90,  acc:100, pp:15, cat:"physical", effect:"crit",      ec:100, desc:"Slashes with a blade-sharp leaf. High crit rate." },
  regrow:     { name:"Regrow",        type:"Nature",    power:0,   acc:100, pp:10, cat:"status",   effect:"heal50",    ec:100, desc:"Absorbs sunlight to restore the user's health." },
  ...
  galvanic_burst:     { name:"Galvanic Burst", type:"Electric", power:80,  acc:100, pp:15, cat:"special",  effect:"spedown",  ec:30,  desc:"Releases a massive electrical discharge in all directions." },
  ...
  // Ice (+7 → 22)
  icy_shot:     { name:"Icy Shot",      type:"Ice",      power:40,  acc:100, pp:30, cat:"physical", effect:"priority",  ec:0,   desc:"Throws shards of ice that strike first." },
  ...
  roughhouse:    { name:"Roughhouse",    type:"Fairy",    power:90,  acc:90,  pp:10, cat:"physical", effect:"atkdown",   ec:10,  desc:"Plays rough with the foe, lowering their Attack." },
  ...
  // Metal (+7 → 22)
  piston_jab:  { name:"Piston Jab",  type:"Metal",    power:40,  acc:100, pp:30, cat:"physical", effect:"priority",  ec:0,   desc:"Strikes with a steel fist at blinding speed." },
  ...
  vile_cross:  { name:"Vile Cross",  type:"Poison",   power:70,  acc:100, pp:20, cat:"physical", effect:"poison",    ec:10,  desc:"Slashes with a poisonous blade in a cross pattern." },
  barb_jab:    { name:"Barb Jab",    type:"Poison",   power:80,  acc:100, pp:20, cat:"physical", effect:"poison",    ec:30,  desc:"Jabs with a toxin-coated appendage." },
  bane_caltrops:  { name:"Bane Caltrops",  type:"Poison",   power:0,   acc:100, pp:15, cat:"status",   effect:"poison",    ec:100, desc:"Lays a trap of toxic spikes that poisons on contact." },
  sludge_cannon:     { name:"Sludge Cannon",     type:"Poison",   power:120, acc:80,  pp:5,  cat:"physical", effect:"poison",    ec:30,  desc:"Hurls a massive blob of toxic gunk at the foe." },
  caustic_shock:   { name:"Caustic Shock",   type:"Poison",   power:65,  acc:100, pp:15, cat:"special",  effect:"paralyze",  ec:20,  desc:"Shocks the foe with venomous electricity." },
  ...
  // Mental (+6 → 22)
  cortex_ram:  { name:"Cortex Ram",  type:"Mental",  power:80,  acc:90,  pp:15, cat:"physical", effect:"flinch",    ec:20,  desc:"Focuses psychic energy into the forehead and rams the foe." },
  psi_blade:    { name:"Psi Blade",    type:"Mental",  power:70,  acc:100, pp:20, cat:"physical", effect:"crit",      ec:100, desc:"Slashes with psychically sharpened blades. High crit rate." },
  clairvoyance:   { name:"Clairvoyance",   type:"Mental",  power:0,   acc:100, pp:10, cat:"status",   effect:"spatkup",   ec:100, desc:"Reads the foe's mind to sharpen the user's special attack." },
  mesmerize:      { name:"Mesmerize",      type:"Mental",  power:0,   acc:60,  pp:20, cat:"status",   effect:"sleep",     ec:100, desc:"Puts the foe to sleep with hypnotic suggestion." },
  psionic_wave:       { name:"Psionic Wave",       type:"Mental",  power:75,  acc:100, pp:15, cat:"special",  effect:null,        ec:0,   desc:"Attacks with a telekinetic wave of force." },
  ...
  serpent_rage:   { name:"Serpent Rage",   type:"Draconic",   power:55,  acc:100, pp:15, cat:"special",  effect:null,        ec:0,   desc:"Blasts the foe with an ancient draconic fury." },
  ...
  all_out_assault:      { name:"All-Out Assault",   type:"Normal",   power:100, acc:100, pp:15, cat:"physical", effect:"recoil",    ec:100, desc:"A reckless life-risking tackle that also damages the user." },

  // --- Fire (+7) ---
  hexflame:      { name:"Hexflame",           type:"Fire",     power:0,   acc:85,  pp:15, cat:"status",   effect:"burn",      ec:100, desc:"Shoots a sinister flame that reliably burns the target." },
  ...
  pyroclastic_burst:         { name:"Pyroclastic Burst",  type:"Fire",     power:140, acc:85,  pp:5,  cat:"special",  effect:"recoil",    ec:100, desc:"Erupts with volcanic force, dealing immense damage at a cost to the user." },
  ...
  flame_spiral:        { name:"Flame Spiral",       type:"Fire",     power:35,  acc:85,  pp:15, cat:"special",  effect:"spedown",   ec:100, desc:"Traps the foe in a swirling vortex of fire, slowing it down." },
  ...
  sun_ray:       { name:"Sun Ray",           type:"Nature",    power:120, acc:100, pp:10, cat:"special",  effect:"recharge",  ec:100, desc:"Absorbs sunlight on the first turn, then unleashes a powerful beam." },
  ...
  absolute_zero:       { name:"Absolute Zero",     type:"Ice",      power:0,   acc:30,  pp:5,  cat:"special",  effect:"freeze",    ec:100, desc:"An intense cold snap of absolute zero. Rarely lands, but always freezes." },
  ...
  // --- Dark (+8) ---
  provoke:            { name:"Provoke",             type:"Dark",     power:0,   acc:100, pp:20, cat:"status",   effect:"atkdown",   ec:100, desc:"Provokes the target with taunts, rattling their composure and lowering Attack." },
  run_down:          { name:"Run Down",           type:"Dark",     power:40,  acc:100, pp:20, cat:"physical", effect:null,        ec:0,   desc:"Relentlessly pursues the foe, cutting off any attempt to flee." },
  ...
  sinister_scheme:       { name:"Sinister Scheme",        type:"Dark",     power:0,   acc:100, pp:20, cat:"status",   effect:"spatkup",   ec:100, desc:"Schemes devious plots that sharply raise the user's Special Attack." },
  null_void:        { name:"Null Void",         type:"Dark",     power:0,   acc:80,  pp:10, cat:"status",   effect:"sleep",     ec:100, desc:"Drags the foe into a void of darkness, pulling them into deep slumber." },
  ...
  wraith_drive:     { name:"Wraith Drive",      type:"Dark",     power:120, acc:100, pp:5,  cat:"physical", effect:null,        ec:0,   desc:"Vanishes into shadow then reappears to deliver a devastating strike." },
  ...
  glimmering_song:   { name:"Glimmering Song",    type:"Fairy",    power:90,  acc:100, pp:10, cat:"special",  effect:null,        ec:0,   desc:"Sings a sparkling aria that resonates with magical force." },
  fairy_blast:    { name:"Fairy Blast",     type:"Fairy",    power:140, acc:90,  pp:5,  cat:"special",  effect:"recoil",    ec:100, desc:"Draws in destructive light for a catastrophic blast at the user's expense." },
  sprite_lock:       { name:"Sprite Lock",        type:"Fairy",    power:0,   acc:100, pp:15, cat:"status",   effect:"spedown",   ec:100, desc:"Seals the battlefield with fairy magic, slowing the foe with mystical bonds." },
  ...
  // --- Poison (+7) ---
  pestilent_dust:    { name:"Pestilent Dust",     type:"Poison",   power:0,   acc:75,  pp:35, cat:"status",   effect:"poison",    ec:100, desc:"Scatters toxic powder that poisons the target on contact." },
  ...
  // --- Mental (+8) ---
  astral_guard:     { name:"Astral Guard",      type:"Mental",  power:0,   acc:100, pp:20, cat:"status",   effect:"defup",     ec:100, desc:"Absorbs the energy of the cosmos to raise the user's Defense and resilience." },
  latent_force:     { name:"Latent Force",      type:"Mental",  power:60,  acc:100, pp:10, cat:"special",  effect:"spatkup",   ec:30,  desc:"Unleashes stored psychic energy — the more the user is powered up, the harder it hits." },
  ...
  noetic_burst:       { name:"Noetic Burst",        type:"Mental",  power:85,  acc:100, pp:10, cat:"special",  effect:"spaup", ec:30,  desc:"Causes an explosive burst inside the target's mind, weakening special defenses." },
  prophecy:     { name:"Prophecy",      type:"Mental",  power:120, acc:100, pp:10, cat:"special",  effect:"recharge",  ec:100, desc:"Focuses psychic power that strikes the foe two turns later with tremendous force." },
  ...
  sky_surge:    { name:"Sky Surge",     type:"Draconic",   power:120, acc:100, pp:5,  cat:"physical", effect:"defdown",   ec:100, desc:"Ascends with dragon power and crashes down, lowering the user's defenses." },
  wyvern_maw:       { name:"Wyvern Maw",        type:"Draconic",   power:85,  acc:95,  pp:10, cat:"physical", effect:"flinch",    ec:20,  desc:"Snaps with powerful dragon jaws. The sheer force may cause flinching." },

  // --- Rock (+8) ---
  embedded_spike:     { name:"Embedded Spike",      type:"Earth",     power:0,   acc:100, pp:20, cat:"status",   effect:"atkdown",   ec:100, desc:"Lays a trap of razor-sharp rocks that weakens foes as they enter battle." },
  mineral_polish:      { name:"Mineral Polish",       type:"Earth",     power:0,   acc:100, pp:20, cat:"status",   effect:"speup",     ec:100, desc:"Polishes the body's rocky surface until frictionless, sharply raising Speed." },
  ...
  brood_tide:       { name:"Brood Tide",       type:"Nature",     power:40,  acc:95,  pp:10, cat:"special",  effect:"spedown",   ec:30, hits:3, desc:"Fulgureis summons a torrent of charged insects in three cascading waves, each slowing the target further." },
  ...
  psychic_blizzard:    { name:"Psychic Blizzard",    type:"Mental", power:135, acc:85,  pp:5,  cat:"special",  effect:"recoil",    ec:100,desc:"Duskmourn amplifies psychic energy to a destructive extreme, generating a psychic blizzard. The mental strain is brutal." },
  ...
  icebound_lattice:    { name:"Icebound Lattice",    type:"Ice",     power:100, acc:95,  pp:10, cat:"special",  effect:"spedown",   ec:30, desc:"Sparkeis weaves a crystalline lattice of ice energy around the target, restricting their movement and slowing their reactions." },
  ...
  draconic_pummels:   { name:"Draconic Pummels",   type:"Fighting",power:40,  acc:90,  pp:10, cat:"physical", effect:"defdown",   ec:20, hits:3, desc:"Alloydrax delivers three relentless draconic strikes in sequence, each eroding the target's defensive stance." },
  ...
  // --- Sonic (regular) ---
  shake_smash:            { name:"Shake Smash", type:"Sonic", power:50, acc:100, pp:30, cat:"physical", effect:null, ec:0, target:"single", alwaysCrit:true, desc:"Body-vibration impact; always lands a critical hit." },
  ...
  echo_pulse:             { name:"Echo Pulse", type:"Sonic", power:35, acc:100, pp:40, cat:"special", effect:null, ec:0, target:"single", desc:"Single resonating pulse." },
  ...
  ember_focus:             { name:"Ember Focus", type:"Fire", power:0, acc:100, pp:15, cat:"status", effect:"focus", ec:100, target:"self", desc:"Sharpens flame for high critical-hit ratio." },
  ...
  sylvan_radiance:        { name:"Sylvan Radiance", type:"Nature", dualType:["Nature","Stellar"], power:85, acc:90, pp:10, cat:"special", effect:"crit", ec:100, target:"single", desc:"Bright life-radiance with high crit ratio. Dual Nature+Stellar." },
  ...
  overcharge_coil:       { name:"Overcharge Coil", type:"Electric", power:0, acc:100, pp:10, cat:"status", effect:"spaup2", ec:100, target:"self", desc:"Floods circuits (+2 SpA)." },
  ...
  telluric_wave:           { name:"Telluric Wave", type:"Earth", power:75, acc:95, pp:15, cat:"special", effect:"spedown", ec:30, target:"wide", breakerVs:"Aether", desc:"Plate-shift wave; super vs Aether; may slow all foes." },
  ...
  sand_storm_polish:          { name:"Sand Storm Polish", type:"Earth", power:0, acc:100, pp:15, cat:"status", effect:"atkup", ec:100, target:"self", desc:"Sand-grinding sharpens claws (+1 Atk)." },
  ...
  thunderstorm_eruption:      { name:"Thunderstorm Eruption", type:"Wind", dualType:["Wind","Electric"], power:130, acc:85, pp:5, cat:"special", effect:"strained", ec:30, target:"wide", desc:"Lightning-laced windstorm. Dual Wind+Electric; may inflict Strained on all foes." },
  ...
  mistral_focus:              { name:"Mistral Focus", type:"Wind", power:0, acc:100, pp:15, cat:"status", effect:"accup", ec:100, target:"self", desc:"Reads wind currents; raises own Accuracy." },
  ...
  // --- Ice (regular) ---
  frigid_jab:               { name:"Frigid Jab", type:"Ice", power:45, acc:100, pp:30, cat:"physical", effect:null, ec:0, target:"single", breakerVs:"Aquatic", desc:"Quick Frigid-Jab; super vs Aquatic (Freeze-Dry analogue)." },
  ...
  boreal_armor:             { name:"Boreal Armor", type:"Ice", power:0, acc:100, pp:15, cat:"status", effect:"defup2", ec:100, target:"self", desc:"Boreal-Armor (+2 Def)." },
  ...
  polar_swift:           { name:"Polar Swift", type:"Ice", power:0, acc:100, pp:15, cat:"status", effect:"speup", ec:100, target:"self", desc:"Smooths surface like ice (+1 Speed)." },
  ...
  stygian_whisper:            { name:"Stygian Whisper", type:"Dark", power:50, acc:100, pp:25, cat:"special", effect:"confuse", ec:20, target:"wide", desc:"Disturbing whispers on all foes; may confuse." },
  ...
  nymph_mist:              { name:"Nymph Mist", type:"Fairy", power:45, acc:100, pp:30, cat:"special", effect:"atkdown", ec:20, target:"wide", breakerVs:"Metal", desc:"Corrosive Nymph-Mist; super vs Metal; may lower Atk." },
  ...
  sylph_focus:             { name:"Sylph Focus", type:"Fairy", power:0, acc:100, pp:15, cat:"status", effect:"accup", ec:100, target:"self", desc:"Focused fairy-sense (+1 Accuracy)." },
  ...
  wrought_shockwave:          { name:"Wrought Shockwave", type:"Metal", power:60, acc:100, pp:20, cat:"special", effect:"defdown", ec:30, target:"wide", desc:"Iron-density shockwave on all foes; may lower Def." },
  ...
  mental_pulse:              { name:"Mental Pulse", type:"Mental", power:70, acc:100, pp:15, cat:"special", effect:"spdefdown", ec:20, target:"wide", desc:"Pulse on all foes; may lower SpDef." },
  cognition_meld:                   { name:"Cognition Meld", type:"Mental", power:90, acc:95, pp:10, cat:"special", effect:null, ec:0, target:"single", breakerVs:"Aether", desc:"Mental fusion strike." },
  mnemonic_focus:                { name:"Mnemonic Focus", type:"Mental", power:0, acc:100, pp:15, cat:"status", effect:"focus", ec:100, target:"self", desc:"Focused mind; high crit." },
  ...
  draco_pulse:               { name:"Draco Pulse", type:"Draconic", power:70, acc:100, pp:15, cat:"special", effect:null, ec:0, target:"single", alwaysCrit:true, desc:"Draconic pulse." },
  reptilian_gust:                 { name:"Reptilian Gust", type:"Draconic", dualType:["Draconic","Wind"], power:90, acc:90, pp:10, cat:"special", effect:null, ec:0, target:"wide", desc:"Wide reptilian gust. Dual Draconic+Wind." },
  ...
  drake_armor:                  { name:"Drake Armor", type:"Draconic", power:0, acc:100, pp:15, cat:"status", effect:"defup2", ec:100, target:"self", desc:"+2 Def." },
  basilisk_might:              { name:"Basilisk Might", type:"Draconic", power:0, acc:100, pp:15, cat:"status", effect:"atkup", ec:100, target:"self", desc:"+1 Atk." },
  arcane_roar:               { name:"Arcane Roar", type:"Draconic", power:0, acc:100, pp:15, cat:"status", effect:"spaup", ec:100, target:"self", desc:"+1 SpA." },
  ...
  wraith_focus:                 { name:"Wraith Focus", type:"Spectral", power:0, acc:100, pp:15, cat:"status", effect:"focus", ec:100, target:"self", desc:"High crit ratio." },
  ...
  eidolon_dance:               { name:"Eidolon Dance", type:"Spectral", power:0, acc:100, pp:15, cat:"status", effect:"calmup", ec:100, target:"self", desc:"Calm-up self." },
  ...
  galaxy_punch_2:           { name:"Galaxy Punch", type:"Fighting", power:95, acc:95, pp:10, cat:"special", effect:"crit", ec:100, target:"single", desc:"High-crit galaxy-fist." },
  ...
  fighter_s_resolve:             { name:"Fighter's Resolve", type:"Fighting", power:0, acc:100, pp:15, cat:"status", effect:"atkup2", ec:100, target:"self", desc:"+2 Atk." },
  swift_form:                  { name:"Swift Form", type:"Fighting", power:0, acc:100, pp:15, cat:"status", effect:"speup", ec:100, target:"self", desc:"+1 Speed." },
  warrior_block:               { name:"Warrior Block", type:"Fighting", power:0, acc:100, pp:15, cat:"status", effect:"spdefup", ec:100, target:"self", desc:"+1 SpDef." },
  ...
  recovery_stance:              { name:"Recovery Stance", type:"Fighting", power:0, acc:100, pp:10, cat:"status", effect:"heal50", ec:100, target:"self", desc:"Restores half HP." },
  ...
  mystic_blow:               { name:"Mystic Blow", type:"Aether", power:70, acc:100, pp:15, cat:"physical", effect:null, ec:0, target:"single", desc:"Mystic Blow." },
  ...
  empyrean_focus:                { name:"Empyrean Focus", type:"Aether", power:0, acc:100, pp:15, cat:"status", effect:"focus", ec:100, target:"self", desc:"High crit." },
  ...
  quartz_punch:               { name:"Quartz Punch", type:"Crystal", power:60, acc:100, pp:20, cat:"physical", effect:null, ec:0, target:"single", desc:"Crystal-fist punch." },
  ...
  geode_smash:               { name:"Geode Smash", type:"Crystal", power:100, acc:85, pp:10, cat:"physical", effect:"defdown", ec:30, target:"single", desc:"Geode Smash; may lower Def." },
  ...
  beryl_press:               { name:"Beryl Press", type:"Crystal", dualType:["Crystal","Mineral"], power:110, acc:85, pp:5, cat:"physical", effect:null, ec:0, target:"wide", desc:"Wide Beryl-Press. Dual Crystal+Mineral." },
  ...
  facet_focus:               { name:"Facet Focus", type:"Crystal", power:0, acc:100, pp:15, cat:"status", effect:"focus", ec:100, target:"self", desc:"High crit." },
  opaline_armor:                 { name:"Opaline Armor", type:"Crystal", power:0, acc:100, pp:15, cat:"status", effect:"defup2", ec:100, target:"self", desc:"+2 Def." },
  jade_lattice:             { name:"Jade Lattice", type:"Crystal", power:0, acc:100, pp:15, cat:"status", effect:"spdefup2", ec:100, target:"self", desc:"+2 SpDef." },
  ...
  sapphire_charge:              { name:"Sapphire Charge", type:"Crystal", power:0, acc:100, pp:15, cat:"status", effect:"atkup", ec:100, target:"self", desc:"+1 Atk." },
  ...
  bestial_roar:                     { name:"Bestial Roar", type:"Primal", power:50, acc:100, pp:30, cat:"special", effect:"atkdown", ec:30, target:"wide", desc:"Bestial Roar; may lower Atk." },
  ...
  soul_eater:                    { name:"Soul Eater", type:"Primal", power:90, acc:95, pp:10, cat:"special", effect:"drain", ec:100, target:"single", breakerVs:"Aether", desc:"Drains essence." },
  primeval_eruption:                 { name:"Primeval Eruption", type:"Primal", power:100, acc:85, pp:10, cat:"special", effect:null, ec:0, target:"wide", desc:"Wide Primeval Eruption." },
  ...
  atavistic_focus:                    { name:"Atavistic Focus", type:"Primal", power:0, acc:100, pp:15, cat:"status", effect:"focus", ec:100, target:"self", desc:"High crit." },
  ...
  untamed_meditation:               { name:"Untamed Meditation", type:"Primal", power:0, acc:100, pp:15, cat:"status", effect:"calmup", ec:100, target:"self", desc:"Calm-up." },
  ...
  smog_drill:                     { name:"Smog Drill", type:"Vapor", power:95, acc:95, pp:10, cat:"physical", effect:null, ec:0, target:"single", desc:"Vapor-condensed drill." },
  mist_pulse:                          { name:"Mist Pulse", type:"Vapor", power:40, acc:100, pp:30, cat:"special", effect:null, ec:0, target:"wide", desc:"Wide mist pulse." },
  ...
  brume_resonance:                      { name:"Brume Resonance", type:"Vapor", power:75, acc:95, pp:15, cat:"special", effect:null, ec:0, target:"wide", desc:"Wide Brume Resonance." },
  boil:                          { name:"Boil", type:"Vapor", power:80, acc:95, pp:15, cat:"special", effect:"burn", ec:30, target:"single", desc:"Boil-attack; may burn." },
  ...
  nimbus_eruption:                  { name:"Nimbus Eruption", type:"Vapor", power:100, acc:85, pp:10, cat:"special", effect:null, ec:0, target:"wide", desc:"Wide Nimbus Eruption." },
  ...
  geyser_storm:                     { name:"Geyser Storm", type:"Vapor", power:95, acc:90, pp:10, cat:"special", effect:"burn", ec:20, target:"wide", desc:"Geyser Storm; may burn." },
  nimbus_flood:                      { name:"Nimbus Flood", type:"Vapor", power:110, acc:85, pp:5, cat:"special", effect:null, ec:0, target:"wide", desc:"Flooding mist on all foes." },
  ...
  haze_focus:                     { name:"Haze Focus", type:"Vapor", power:0, acc:100, pp:15, cat:"status", effect:"focus", ec:100, target:"self", desc:"High crit." },
  mist_veil:                       { name:"Mist Veil", type:"Vapor", power:0, acc:100, pp:15, cat:"status", effect:"defup", ec:100, target:"self", desc:"+1 Def." },
  murk_screen:                      { name:"Murk Screen", type:"Vapor", power:0, acc:100, pp:15, cat:"status", effect:"spdefup", ec:100, target:"self", desc:"+1 SpDef." },
  ...
  wisp_speed:                      { name:"Wisp Speed", type:"Vapor", power:0, acc:100, pp:15, cat:"status", effect:"speup", ec:100, target:"self", desc:"+1 Speed." },
  ...
  cumulus_meditation:                 { name:"Cumulus Meditation", type:"Vapor", power:0, acc:100, pp:15, cat:"status", effect:"calmup", ec:100, target:"self", desc:"Calm-up." },
  smoke_calm:                      { name:"Smoke Calm", type:"Vapor", power:0, acc:100, pp:10, cat:"status", effect:"defup2", ec:100, target:"self", desc:"+2 Def." },
  ...
  flint_focus:                   { name:"Flint Focus", type:"Mineral", power:0, acc:100, pp:15, cat:"status", effect:"focus", ec:100, target:"self", desc:"High crit." },
  slate_armor:                       { name:"Slate Armor", type:"Mineral", power:0, acc:100, pp:15, cat:"status", effect:"defup2", ec:100, target:"self", desc:"+2 Def." },
  shard_form:                      { name:"Shard Form", type:"Mineral", power:0, acc:100, pp:15, cat:"status", effect:"atkup", ec:100, target:"self", desc:"+1 Atk." },
  mica_lattice:                 { name:"Mica Lattice", type:"Mineral", power:0, acc:100, pp:15, cat:"status", effect:"spdefup2", ec:100, target:"self", desc:"+2 SpDef." },
  sediment_heal:                    { name:"Sediment Heal", type:"Mineral", power:0, acc:100, pp:10, cat:"status", effect:"heal50", ec:100, target:"self", desc:"Restores half HP." },
  ...
  blight_strike:               { name:"Blight Strike", type:"Toxin", power:95, acc:90, pp:10, cat:"physical", effect:null, ec:0, target:"single", breakerVs:"Fairy", desc:"Blight-Strike." },
  toxin_pulse:                       { name:"Toxin Pulse", type:"Toxin", power:45, acc:100, pp:30, cat:"special", effect:null, ec:0, target:"single", desc:"Single toxin-pulse." },
  venom_ray:                   { name:"Venom Ray", type:"Toxin", power:65, acc:100, pp:20, cat:"special", effect:"poison", ec:30, target:"single", desc:"Venom ray." },
  acid_burst_2:                  { name:"Acid Burst", type:"Toxin", power:80, acc:95, pp:15, cat:"special", effect:"spdefdown", ec:30, target:"wide", desc:"Acid burst." },
  miasma_blast:                { name:"Miasma Blast", type:"Toxin", power:90, acc:95, pp:10, cat:"special", effect:"poison", ec:30, target:"wide", desc:"Miasma blast." },
  virulent_storm:                  { name:"Virulent Storm", type:"Toxin", power:100, acc:85, pp:10, cat:"special", effect:null, ec:0, target:"wide", desc:"Wide Virulent Storm." },
  plague_wave:                 { name:"Plague Wave", type:"Toxin", dualType:["Toxin","Dream"], power:110, acc:85, pp:5, cat:"special", effect:null, ec:0, target:"wide", desc:"Wide plague-wave. Dual Toxin+Dream." },
  noxious_focus:                       { name:"Noxious Focus", type:"Toxin", power:0, acc:100, pp:15, cat:"status", effect:"focus", ec:100, target:"self", desc:"High crit." },
  squalid_field:                 { name:"Squalid Field", type:"Toxin", power:0, acc:100, pp:15, cat:"status", effect:"atkup", ec:100, target:"self", desc:"+1 Atk." },
  caustic_shell:                  { name:"Caustic Shell", type:"Toxin", power:0, acc:100, pp:15, cat:"status", effect:"defup", ec:100, target:"self", desc:"+1 Def." },
  corrosive_step:              { name:"Corrosive Step", type:"Toxin", power:0, acc:100, pp:15, cat:"status", effect:"speup", ec:100, target:"self", desc:"+1 Speed." },
  tainted_screen:               { name:"Tainted Screen", type:"Toxin", power:0, acc:100, pp:15, cat:"status", effect:"spdefup", ec:100, target:"self", desc:"+1 SpDef." },
  poison_resolve:              { name:"Poison Resolve", type:"Toxin", power:0, acc:100, pp:10, cat:"status", effect:"atkup2", ec:100, target:"self", desc:"+2 Atk." },
  rancid_charge:               { name:"Rancid Charge", type:"Toxin", power:0, acc:100, pp:15, cat:"status", effect:"spaup", ec:100, target:"self", desc:"+1 SpA." },
  putrid_calm:                        { name:"Putrid Calm", type:"Toxin", power:0, acc:100, pp:10, cat:"status", effect:"heal50", ec:100, target:"self", desc:"Restores half HP." },
  pox_mark:                  { name:"Pox Mark", type:"Toxin", power:0, acc:100, pp:15, cat:"status", effect:"atkdown", ec:100, target:"single", desc:"Lowers foe's Atk." },
  acidic_glance:               { name:"Acidic Glance", type:"Toxin", power:0, acc:100, pp:15, cat:"status", effect:"defdown", ec:100, target:"single", desc:"Lowers foe's Def." },
  miasma_lure:                 { name:"Miasma Lure", type:"Toxin", power:0, acc:100, pp:15, cat:"status", effect:"spedown", ec:100, target:"single", desc:"Lowers foe's Speed." },
  fester_meditation:           { name:"Fester Meditation", type:"Toxin", power:0, acc:100, pp:15, cat:"status", effect:"calmup", ec:100, target:"self", desc:"Calm-up." },
  ...
  aeon_smash:                    { name:"Aeon Smash", type:"Chrono", power:95, acc:90, pp:10, cat:"physical", effect:null, ec:0, target:"single", desc:"Aeon-Smash." },
  ...
  clockwork_press:                    { name:"Clockwork Press", type:"Chrono", dualType:["Chrono","Aether"], power:110, acc:85, pp:5, cat:"physical", effect:null, ec:0, target:"single", desc:"Clockwork-Press. Dual Chrono+Aether." },
  ...
  millennium_burst:                       { name:"Millennium Burst", type:"Chrono", power:80, acc:90, pp:10, cat:"special", effect:null, ec:0, target:"wide", desc:"Millennium Burst." },
  continuum_blast:                    { name:"Continuum Blast", type:"Chrono", power:90, acc:90, pp:10, cat:"special", effect:null, ec:0, target:"single", desc:"Continuum Blast." },
  ...
  hourglass_focus:                    { name:"Hourglass Focus", type:"Chrono", power:0, acc:100, pp:15, cat:"status", effect:"focus", ec:100, target:"self", desc:"High crit." },
  ...
  sundial_calm:                        { name:"Sundial Calm", type:"Chrono", power:0, acc:100, pp:10, cat:"status", effect:"heal50", ec:100, target:"self", desc:"Restores half HP." },
  aevum_speed:                    { name:"Aevum Speed", type:"Chrono", power:0, acc:100, pp:10, cat:"status", effect:"speup2", ec:100, target:"self", desc:"+2 Speed." },
  ...
  eternity_lock:                     { name:"Eternity Lock", type:"Chrono", power:0, acc:100, pp:15, cat:"status", effect:"spedown", ec:100, target:"single", desc:"Lowers foe's Speed." },
  ...
  galaxy_punch:                { name:"Galaxy Punch", type:"Stellar", power:85, acc:95, pp:15, cat:"physical", effect:null, ec:0, target:"single", alwaysCrit:true, rarity:"exclusive", desc:"Galaxy-punch." },
  ...
  quasar_finisher:                 { name:"Quasar Finisher", type:"Stellar", power:120, acc:85, pp:5, cat:"physical", effect:null, ec:0, target:"single", rarity:"exclusive", desc:"Closing cosmic blow." },
  ...
  pulsar_storm:                    { name:"Pulsar Storm", type:"Stellar", power:95, acc:90, pp:10, cat:"special", effect:null, ec:0, target:"wide", desc:"Pulsar Storm." },
  ...
  starfall_2:                      { name:"Starfall", type:"Stellar", power:100, acc:90, pp:10, cat:"special", effect:null, ec:0, target:"single", desc:"Starfall." },
  comet_flare:                    { name:"Comet Flare", type:"Stellar", power:90, acc:95, pp:10, cat:"special", effect:null, ec:0, target:"single", desc:"Comet Flare." },
  ...
  zodiac_meditation:               { name:"Zodiac Meditation", type:"Stellar", power:0, acc:100, pp:15, cat:"status", effect:"calmup", ec:100, target:"self", rarity:"exclusive", desc:"Calm-up." },
  meteor_armor:                      { name:"Meteor Armor", type:"Stellar", power:0, acc:100, pp:15, cat:"status", effect:"defup", ec:100, target:"self", rarity:"exclusive", desc:"+1 Def." },
  orbital_calm:                       { name:"Orbital Calm", type:"Stellar", power:0, acc:100, pp:10, cat:"status", effect:"heal50", ec:100, target:"self", rarity:"exclusive", desc:"Restores half HP." },
  ...
  astral_resolve:               { name:"Astral Resolve", type:"Stellar", power:0, acc:100, pp:10, cat:"status", effect:"atkup2", ec:100, target:"self", desc:"+2 Atk." },
  astral_focus:                    { name:"Astral Focus", type:"Stellar", power:0, acc:100, pp:10, cat:"status", effect:"spaup2", ec:100, target:"self", desc:"+2 SpA." },
  celestial_aura:                     { name:"Celestial Aura", type:"Stellar", power:0, acc:100, pp:15, cat:"status", effect:"accup", ec:100, target:"self", rarity:"exclusive", desc:"+1 Acc." },
  ...
  lucid_beam:                      { name:"Lucid Beam", type:"Dream", power:65, acc:100, pp:20, cat:"special", effect:null, ec:0, target:"wide", desc:"Wide Lucid Beam." },
  dread_burst:                 { name:"Dread Burst", type:"Dream", power:75, acc:95, pp:15, cat:"special", effect:"sleep", ec:20, target:"wide", desc:"Wide; may sleep." },
  ...
  eternal_dream:                 { name:"Eternal Dream", type:"Dream", power:130, acc:85, pp:5, cat:"special", effect:null, ec:0, target:"wide", desc:"Wide eternal dream." },
  reverie_focus:                     { name:"Reverie Focus", type:"Dream", power:0, acc:100, pp:15, cat:"status", effect:"focus", ec:100, target:"self", desc:"High crit." },
  phobia_aura:                  { name:"Phobia Aura", type:"Dream", power:0, acc:100, pp:15, cat:"status", effect:"atkdown", ec:100, target:"single", desc:"Lowers foe's Atk." },
  doze_calm:                     { name:"Doze Calm", type:"Dream", power:0, acc:100, pp:10, cat:"status", effect:"heal50", ec:100, target:"self", desc:"Restores half HP." },
  trance_meditation:                { name:"Trance Meditation", type:"Dream", power:0, acc:100, pp:15, cat:"status", effect:"calmup", ec:100, target:"self", desc:"Calm-up." },
  nocturne_charge:                  { name:"Nocturne Charge", type:"Dream", power:0, acc:100, pp:15, cat:"status", effect:"spaup", ec:100, target:"self", desc:"+1 SpA." },
  slumber_armor:                     { name:"Slumber Armor", type:"Dream", power:0, acc:100, pp:15, cat:"status", effect:"defup", ec:100, target:"self", desc:"+1 Def." },
  fright_resolve:               { name:"Fright Resolve", type:"Dream", power:0, acc:100, pp:15, cat:"status", effect:"atkup", ec:100, target:"self", desc:"+1 Atk." },
  hypnos_speed:                    { name:"Hypnos Speed", type:"Dream", power:0, acc:100, pp:15, cat:"status", effect:"speup", ec:100, target:"self", desc:"+1 Speed." },
  lucid_acuity:                 { name:"Lucid Acuity", type:"Dream", power:0, acc:100, pp:15, cat:"status", effect:"accup", ec:100, target:"self", desc:"+1 Acc." },
  phantasm_lock:                  { name:"Phantasm Lock", type:"Dream", power:0, acc:100, pp:15, cat:"status", effect:"spedown", ec:100, target:"single", desc:"Lowers foe's Speed." },
  ...
  inferno_s_grasp:          { name:"Inferno's Grasp", type:"Fire", power:120, acc:85, pp:5, cat:"physical", effect:"burn", ec:100, target:"single", rarity:"exclusive", desc:"Guaranteed-burn physical grip — signature legendary move." },
  ...
  eye_of_the_storm:            { name:"Eye of the Storm", type:"Electric", power:0, acc:100, pp:5, cat:"status", effect:"echolocation_and_speup_self", ec:100, target:"single", rarity:"exclusive", desc:"Locks Echolocation on target AND raises own Speed." },
  ...
  stratosphere_pierce:          { name:"Stratosphere Pierce", type:"Wind", power:150, acc:80, pp:5, cat:"physical", effect:"recharge_and_marked_target", ec:100, target:"single", rarity:"exclusive", desc:"Sky-diving pierce; locks Marked; requires rest." },
  ...
  tainted_breath:              { name:"Tainted Breath", type:"Toxin", power:130, acc:85, pp:5, cat:"special", effect:"tainted", ec:100, target:"wide", rarity:"exclusive", desc:"Locks Tainted on all foes." },
  plague_bringer_2:              { name:"Plague Bringer", type:"Toxin", power:0, acc:100, pp:5, cat:"status", effect:"poison_and_atkdown_target", ec:100, target:"wide", rarity:"exclusive", desc:"Poisons all foes AND lowers Atk." },
  necrotic_apocalypse:         { name:"Necrotic Apocalypse", type:"Toxin", power:150, acc:80, pp:5, cat:"special", effect:"recharge_and_severe_bleed_target", ec:30, target:"wide", rarity:"exclusive", desc:"May inflict Severe Bleed; needs rest." },
...
const MONSTERS_DATA = {
  ...
  2: { id:2, name:"Pyrevix",    emoji:"🦊", types:["Fire"],
    ...
    learnset:[[1,"collide"],[2,"flicker"],[3,"blitz"],[4,"flame_fang"],[5,"scorch_veil"],[6,"embercloak"],[8,"cinder_lance"],[10,"afterimage"],[15,"flame_spiral"],[20,"ember_focus"],[24,"inferno_jet"],[25,"blazing_rush"],[28,"scorch_kick"],[32,"second_wind"],[34,"searing_gale"],[35,"pyroclasm"],[40,"all_out_assault"],[43,"conflagration"]],
  ...
  4: { id:4, name:"Aquatter",     emoji:"💧", types:["Aquatic"],
    ...
    learnset:[[1,"collide",[20,"frost_current"]],[1,"lashing_tail"],[4,"aquatic_gun"],[6,"wave_dash"],[8,"bubble_jet"],[13,"tidal_sweep"],[15,"aquatic_pulse"],[19,"second_wind"],[27,"tidal_rush"],[38,"tsunami",[5,"tidecaller"]]],
  ...
  6: { id:6, name:"Banksnout",    emoji:"🦦", types:["Aquatic","Dark"],
    ...
    learnset:[[1,"tidal_rush"],[2,"tidal_sweep"],[3,"fortify"],[4,"tidecaller"],[5,"deepwater_hymn"],[10,"abyssal_wave"],[15,"ocean_crash"],[20,"torrent_fang"],[30,"wicked_torrent"],[35,"flood_tide"],[37,"tsunami"],[39,"ocean_tempest"],[40,"abyssal_jet"],[44,"mud_spray"],[48,"coral_barrage"],[52,"auger_strike"],[56,"geoblast"],[60,"fissure_slam"],[64,"tectonic_slam"]],
    evolveTo:null, evolveLevel:null, catchRate:10, expYield:265, rarity:"rare",
  ...
  7: { id:7, name:"Verdkin",  emoji:"🌱", types:["Nature"],
    ...
    learnset:[[1,"collide",[20,"root_lance"]],[1,"daunt"],[4,"vine_lash"],[8,"sharp_leaves"],[13,"pod_blast"],[19,"war_dance"],[27,"verdant_orb"],[38,"petal_blitz",[5,"slumber_dust"]]],
  ...
  8: { id:8, name:"Barknell",   emoji:"🦕", types:["Nature"],
    ...
    learnset:[[1,"vine_lash"],[2,"sharp_leaves"],[3,"pod_blast"],[4,"collide"],[5,"slumber_dust"],[16,"war_dance"],[24,"verdant_orb"],[30,"canopy_crash"],[35,"petal_blitz"],[44,"verdant_surge"],[6,"spore_burst"],[33,"second_wind"]],
  ...
  9: { id:9, name:"Garlawarden",   emoji:"🌸", types:["Nature","Fairy"],
    ...
    learnset:[[1,"pod_blast"],[2,"verdant_orb"],[3,"vine_lash"],[4,"slumber_dust"],[5,"spore_burst"],[10,"fairy_jab"],[15,"sylph_focus"],[20,"faewind"],[25,"healing_circle"],[36,"celestial_wave"],[40,"verdant_surge"],[41,"lashing_tail"],[44,"fairy_wind"],[47,"petal_blitz"],[48,"graze"],[52,"prism_flare"],[56,"root_lance"],[60,"lunar_burst"]],
    evolveTo:null, evolveLevel:null, catchRate:10, expYield:265, rarity:"rare",
  ...
  11: { id:11, name:"Heliocoon",  emoji:"🥚", types:["Fire","Wind"],
    ...
    learnset:[[1,"fortify"],[1,"flicker"],[4,"mandible_bite"],[5,"embercloak"],[6,"kindle"],[8,"chitin_guard"],[10,"cocoon_guard"],[14,"scorch_veil"],[18,"sun_burst"],[20,"second_wind"],[22,"metamorphosis"],[26,"fortify"],[32,"embercloak"],[36,"searing_gale"],[39,"conflagration"]],
  ...
  17: { id:17, name:"Searburn",   emoji:"🐉", types:["Draconic","Earth"],
    ...
    learnset:[[1,"flicker"],[2,"inferno_jet"],[3,"cinderwhirl"],[4,"scorch_veil"],[21,"vital_pulse"],[26,"char_dance"],[32,"draconic_breath"],[38,"draconic_claw"],[44,"searing_gale"],[50,"conflagration"],[56,"rampage"],[62,"solar_flare"],[5,"embercloak"],[41,"leviathan_rush"]],
  ...
  42: { id:42, name:"Cryonik",    emoji:"🦭", types:["Ice","Aquatic"],
    ...
    learnset:[[1,"collide",[22,"frost_current"]],[1,"flurries"],[10,"aquatic_gun"],[18,"cold_beam"],[20,"baleful_stare"],[26,"tidal_sweep"],[34,"whiteout",[5,"permafrost"]],[36,"cryo_lance"],[3,"winter_shroud"],[31,"tidal_rush"]],
  ...
  43: { id:43, name:"Boreon",  emoji:"🦭", types:["Ice","Aquatic"],
    ...
    learnset:[[1,"flurries"],[2,"aquatic_gun"],[3,"cold_beam"],[4,"permafrost"],[31,"whiteout"],[33,"fortify"],[38,"abyssal_jet"],[43,"hoarfrost_bite"],[48,"frost_crash"],[53,"tidal_rush"],[58,"tundra_tomb"],[63,"tsunami"],[5,"winter_shroud"],[41,"tidal_sweep"]],
  ...
  67: { id:67, name:"Loamvin", emoji:"🐌", types:["Nature","Earth"],
    ...
    learnset:[[1,"sharp_leaves"],[2,"pod_blast"],[3,"slumber_dust"],[22,"verdant_orb"],[27,"daunt"],[32,"collide"],[37,"sandstrike"],[42,"sand_geyser"],[47,"root_lance"],[52,"geoblast"],[57,"tectonic_shift"],[62,"petal_blitz"],[4,"spore_burst"],[40,"scorched_earth"]],
  ...
  81: { id:81, name:"Joltan",    emoji:"🐎", types:["Electric"],
    ...
    learnset:[[1,"graze",[20,"volt_surge"]],[1,"jolt"],[3,"charge_burst"],[6,"nuzzle"],[8,"blitz"],[10,"thunder_jab"],[16,"static_strike"],[18,"shock_pulse"],[22,"volt_jet"],[24,"static_charge"],[29,"second_wind"],[30,"stun_pulse"],[32,"baleful_stare"],[38,"stormbolt",[5,"static_cage"]]],
  ...
  82: { id:82, name:"Galvanos",    emoji:"🐴", types:["Electric"],
    ...
    learnset:[[1,"jolt"],[2,"blitz"],[3,"static_strike"],[4,"static_cage"],[10,"chain_spark"],[18,"lightning_rush"],[20,"volt_jet"],[24,"relay_shock"],[27,"stun_pulse"],[28,"daunt"],[34,"fortify"],[35,"stormbolt"],[41,"wild_tumble"],[42,"baleful_stare"],[48,"arc_flash"],[55,"plasma_strike"],[62,"crushing_bulk"]],
  ...
  85: { id:85, name:"Shockharpe",  emoji:"🪰", types:["Electric","Nature"],
    ...
    learnset:[[1,"jolt"],[2,"mandible_bite"],[3,"stun_pulse"],[4,"static_cage"],[15,"shock_net"],[23,"volt_jet"],[29,"lashing_tail"],[31,"resonance_hum"],[33,"shear_strike"],[36,"graze"],[42,"mandible_crush"],[43,"silk_bind"],[50,"swarm_dive"],[57,"volt_surge"],[64,"stormbolt"]],
  ...
  88: { id:88, name:"Sparkrel",    emoji:"🐟", types:["Electric","Aquatic"],
    ...
    learnset:[[1,"jolt"],[2,"aquatic_gun"],[3,"volt_jet"],[4,"bubble_jet"],[5,"stun_pulse"],[32,"voltaic_fang"],[33,"tidal_rush"],[35,"lashing_tail"],[42,"graze"],[49,"stormbolt"],[56,"tsunami"],[63,"overcharge"],[6,"static_cage"],[43,"tidal_sweep"]],
  ...
  90: { id:90, name:"Zephyrel",  emoji:"🐦", types:["Electric","Wind"],
    ...
    learnset:[[1,"breeze",[20,"volt_surge"]],[1,"jolt"],[10,"wingbeat"],[14,"daunt"],[18,"volt_jet"],[24,"collide"],[26,"wind_scythe"],[33,"static_strike"],[34,"stormbolt",[5,"stun_pulse"]],[42,"cyclone_blade"],[3,"static_cage"],[32,"storm_surge"]],
  ...
  96: { id:96, name:"Seismith",  emoji:"🦏", types:["Earth","Electric"],
    ...
    learnset:[[1,"mud_spray"],[2,"cranial_ram"],[3,"tectonic_shift"],[4,"dust_veil"],[29,"geoblast"],[31,"fortify"],[37,"crushing_bulk"],[38,"static_strike"],[43,"stone_slide"],[49,"crystal_lance"],[55,"fissure_slam"],[61,"voltaic_rush"],[5,"clay_armor"],[41,"magma_stone"]],
  ...
  99: { id:99, name:"Toxivenoth",  emoji:"🦂", types:["Earth","Poison"],
    ...
    learnset:[[1,"septic_prick"],[2,"fissure_slam"],[3,"mud_spray"],[4,"tectonic_shift"],[5,"virulent_surge"],[6,"dust_veil"],[31,"ooze_bomb"],[38,"vital_pulse"],[39,"toxify"],[46,"miasma_cloud"],[54,"geoblast"],[62,"plague_burst"],[7,"clay_armor"],[42,"venom_lance"]],
  ...
  101: { id:101, name:"Limoux",     emoji:"🐊", types:["Earth","Aquatic"],
    ...
    learnset:[[1,"graze",[22,"sandstrike"]],[1,"mud_spray"],[10,"aquatic_gun"],[18,"bubble_jet"],[20,"lashing_tail"],[26,"tectonic_shift"],[34,"tidal_rush",[5,"dust_veil"]],[36,"whirlpool_dive"],[3,"clay_armor"],[31,"sea_serpent_strike"]],
  ...
  102: { id:102, name:"Dunoloth",   emoji:"🐊", types:["Earth","Aquatic"],
    ...
    learnset:[[1,"mud_spray"],[2,"aquatic_gun"],[3,"dust_veil"],[23,"tectonic_shift"],[28,"battle_cry"],[31,"tidal_rush"],[34,"frost_current"],[40,"boulder_roll"],[46,"crushing_bulk"],[52,"geoblast"],[58,"tidal_crush"],[64,"tsunami"],[4,"clay_armor"],[42,"tidal_sweep"]],
  ...
  109: { id:109, name:"Siroccomane",    emoji:"🦁", types:["Wind","Electric"],
    ...
    learnset:[[1,"breeze"],[2,"wingbeat"],[3,"mistveil"],[22,"wind_scythe"],[28,"zephyr_dance"],[29,"typhoon"],[34,"vital_pulse"],[40,"jolt"],[46,"arc_flash"],[52,"volt_jet"],[58,"gale_cannon"],[64,"stormbolt"],[4,"vortex_trap"],[42,"storm_surge"]],
  ...
  111: { id:111, name:"Aeolin",  emoji:"🐦", types:["Wind","Normal"],
    ...
    learnset:[[1,"collide",[20,"jetstream"]],[1,"breeze"],[8,"blitz"],[16,"wingbeat"],[21,"fortify"],[24,"wind_scythe"],[32,"crushing_bulk",[5,"mistveil"]],[36,"instinct_slash"],[3,"zephyr_dance"],[31,"wild_tumble"]],
  ...
  114: { id:114, name:"Nimbusel",   emoji:"☁️", types:["Wind","Fairy"],
    ...
    learnset:[[1,"collide",[22,"mistveil"]],[1,"breeze"],[3,"vortex_trap"],[9,"fairy_wind"],[12,"breeze_blade"],[15,"squall"],[17,"bewitching_kiss"],[20,"lashing_tail"],[24,"breeze_blast"],[25,"wind_scythe"],[31,"storm_surge"],[33,"lunar_burst",[5,"zephyr_dance"]],[36,"prism_flare"]],
  ...
  115: { id:115, name:"Aetherworn",  emoji:"👻", types:["Wind","Dark"],
    ...
    learnset:[[1,"breeze"],[2,"wind_scythe"],[3,"collide"],[4,"mistveil"],[30,"daunt"],[35,"shadowstep"],[40,"dusk_slash"],[45,"void_pulse"],[50,"nether_sphere"],[55,"cyclone_blade"],[60,"nightmare_pulse"],[65,"typhoon"],[5,"zephyr_dance"],[42,"storm_surge"]],
  ...
  47: { id:47, name:"Hexaprowl",    emoji:"🐺", types:["Ice"],
    ...
    learnset:[[1,"graze",[22,"rime_shard"]],[1,"flurries"],[8,"blitz"],[16,"frost_crash"],[24,"cold_beam"],[29,"second_wind"],[32,"glacial_punch"],[40,"whiteout",[5,"permafrost"]],[3,"winter_shroud"],[31,"baleful_stare"]],
  ...
  48: { id:48, name:"Hailgorge",emoji:"🐺", types:["Ice"],
    ...
    learnset:[[1,"flurries"],[2,"blitz"],[3,"cold_beam"],[4,"frost_crash"],[5,"graze"],[6,"permafrost"],[28,"second_wind"],[29,"glacial_punch"],[37,"whiteout"],[40,"hoarfrost_bite"],[52,"crushing_bulk"],[64,"avalanche_drive"],[7,"winter_shroud"],[44,"baleful_stare"]],
  ...
  53: { id:53, name:"Mistwhirl",  emoji:"🦉", types:["Ice","Wind"],
    ...
    learnset:[[1,"flurries",[22,"cryo_lance"]],[1,"breeze"],[12,"wingbeat"],[20,"cold_beam"],[28,"wind_scythe"],[31,"tundra_tomb"],[36,"whiteout"],[44,"typhoon",[5,"permafrost"]],[3,"winter_shroud"],[33,"thermal_dive"]],
  ...
  45: { id:45, name:"Slatis",   emoji:"🌨️", types:["Ice","Aquatic"],
    ...
    learnset:[[1,"collide",[20,"cold_snap"]],[1,"aquatic_gun"],[6,"icy_shot"],[9,"flurries"],[11,"frost_bite"],[14,"daunt"],[16,"frigid_jab"],[17,"cold_beam"],[24,"graze"],[25,"tidal_rush"],[33,"whiteout",[5,"permafrost"]],[34,"bubble_jet"],[42,"riptide_slam"],[3,"winter_shroud"],[32,"tidal_sweep"]],
  ...
  121: { id:121, name:"Spiraloom",     emoji:"🦇", types:["Dark","Wind"],
    ...
    learnset:[[1,"chomp",[22,"shadowstep"]],[1,"breeze"],[9,"wingbeat"],[17,"void_pulse"],[25,"wind_scythe"],[29,"soul_rend"],[33,"nether_sphere"],[41,"typhoon",[5,"eclipse_shroud"]],[3,"dread_howl"],[32,"void_rend"]],
  ...
  122: { id:122, name:"Caveshroud", emoji:"🦇", types:["Dark","Wind"],
    ...
    learnset:[[1,"void_pulse"],[2,"wingbeat"],[3,"wind_scythe"],[4,"shadowstep"],[5,"eclipse_shroud"],[6,"dread_howl"],[8,"shadow_jab"],[20,"shadow_cloak"],[30,"nether_sphere"],[35,"daunt"],[38,"typhoon"],[42,"collide"],[43,"void_rend"],[49,"dusk_slash"],[56,"nightmare_pulse"],[63,"cyclone_blade"]],
  ...
  123: { id:123, name:"Nocturil", emoji:"🦎", types:["Dark","Poison"],
    ...
    learnset:[[1,"graze",[22,"obsidian_fang"]],[1,"chomp"],[10,"septic_prick"],[18,"dusk_slash"],[26,"ooze_bomb"],[34,"jaw_crush"],[42,"void_pulse"],[50,"toxify",[5,"eclipse_shroud"]],[3,"dread_howl"],[36,"blackout_bomb"]],
  ...
  148: { id:148, name:"Stoicguard",  emoji:"🦾", types:["Metal"],
    ...
    learnset:[[1,"chrome_claw"],[2,"forge_blast_2"],[3,"metal_wing"],[4,"magnetize"],[5,"ironskin"],[10,"armor_meld"],[18,"flywheel"],[24,"smart_strike"],[28,"baleful_stare"],[30,"alloy_tail"],[35,"battle_cry"],[38,"crushing_bulk"],[42,"blitz"],[43,"second_wind"],[49,"rivet_barrage"],[56,"forge_strike"],[63,"tungsten_ram"]],
  ...
  156: { id:156, name:"Venekon",   emoji:"🐸", types:["Poison","Aquatic"],
    ...
    learnset:[[1,"septic_prick"],[2,"bubble_jet"],[3,"toxic_surge"],[4,"toxin_bloom"],[5,"barb_jab"],[15,"coil"],[20,"corrosive_bite"],[24,"toxify"],[26,"sludge_cannon"],[28,"venom_jab"],[30,"virulent_surge"],[32,"lashing_tail"],[33,"sludge_wave"],[38,"ooze_bomb"],[40,"graze"],[43,"tidal_sweep"],[48,"venom_lance"],[56,"tidal_rush"],[64,"tsunami"]],
    evolveTo:null, evolveLevel:null, catchRate:45, expYield:205, rarity:"uncommon",
  ...
  158: { id:158, name:"Corrodisc",  emoji:"🫧", types:["Poison","Earth"],
    ...
    learnset:[[1,"toxify"],[2,"collide"],[3,"virulent_surge"],[4,"toxic_surge"],[32,"daunt"],[35,"sludge_wave"],[38,"mud_spray"],[39,"ooze_bomb"],[44,"loam_leech"],[50,"terra_spike"],[56,"geoblast"],[62,"tectonic_shift"],[5,"toxin_bloom"],[41,"aftershock"]],
  ...
  166: { id:166, name:"Projectery",     emoji:"🐩", types:["Mental"],
    ...
    learnset:[[1,"collide",[22,"synaptic_shatter"]],[1,"mind_jolt"],[3,"clairvoyance"],[6,"psy_jab"],[8,"blitz"],[12,"cerebral_calm"],[16,"psi_burst"],[20,"psy_blast"],[24,"mental"],[29,"baleful_stare"],[31,"second_wind"],[32,"inner_calm"],[40,"psi_strike",[5,"prism_ward"]]],
  ...
  171: { id:171, name:"Drakorius",    emoji:"🐲", types:["Draconic"],
    ...
    learnset:[[1,"draconic_breath",[28,"synaptic_shatter"]],[1,"mind_jolt"],[13,"psi_burst"],[21,"draconic_claw"],[24,"war_dance"],[29,"mental"],[37,"draconic_pulse"],[44,"astral_rend"],[45,"psi_strike"],[53,"rampage",[5,"inner_calm"]],[3,"prism_ward"],[38,"eon_crash"]],
  ...
  172: { id:172, name:"Scalurin",    emoji:"🐣", types:["Draconic"],
    ...
    learnset:[[1,"graze",[22,"wyrm_strike"]],[1,"draconic_breath"],[12,"draconic_claw"],[20,"vital_pulse"],[22,"draconic_pulse"],[30,"hydra_dance"],[36,"cataclysm_breath"],[40,"rampage",[5,"saurian_roar"]],[3,"primordial_roar"],[31,"second_wind"]],
  ...
  321: { id:321, name:"Dragemian",  emoji:"🐉", types:["Draconic","Fire"],
    ...
    learnset:[[1,"rampage"],[2,"draconic_pulse"],[3,"scale_storm"],[4,"radiance_cannon"],[5,"hydra_dance"],[58,"char_dance"],[61,"daunt"],[64,"fortify"],[65,"flame_fang"],[66,"pyre_fang"],[67,"searing_gale"],[68,"conflagration"],[69,"ancient_breath"],[70,"pyroclasm"]],
  ...
  178: { id:178, name:"Fluffen",     emoji:"🐱", types:["Normal"],
    ...
    learnset:[[1,"collide",[20,"momentum_rush"]],[1,"daunt"],[3,"baleful_stare"],[6,"quick_jab"],[8,"graze"],[12,"rapid_strike"],[16,"blitz"],[22,"body_blow"],[24,"crushing_bulk"],[29,"fortify"],[31,"endure_pulse"],[32,"cranial_ram"],[40,"radiance_cannon",[5,"lashing_tail"]]],
  ...
  179: { id:179, name:"Velvetine",    emoji:"🐈", types:["Normal"],
    ...
    learnset:[[1,"graze"],[2,"blitz"],[3,"daunt"],[21,"crushing_bulk"],[26,"fortify"],[29,"cranial_ram"],[30,"baleful_stare"],[37,"radiance_cannon"],[38,"war_dance"],[47,"vital_pulse"],[56,"instinct_slash"],[65,"dusk_slash"],[4,"lashing_tail"],[44,"collide"]],
  ...
  180: { id:180, name:"Leapbun",     emoji:"🐰", types:["Normal"],
    ...
    learnset:[[1,"collide",[20,"wild_tumble"]],[1,"lashing_tail"],[8,"blitz"],[16,"cranial_ram"],[17,"second_wind"],[24,"crushing_bulk",[5,"daunt"]],[29,"fortify"],[39,"vital_pulse"]],
  ...
  181: { id:181, name:"Racehare",  emoji:"🐇", types:["Normal"],
    ...
    learnset:[[1,"blitz"],[2,"cranial_ram"],[3,"collide"],[4,"second_wind"],[5,"daunt"],[6,"lashing_tail"],[7,"quick_jab"],[12,"afterimage"],[18,"wild_tumble"],[21,"crushing_bulk"],[27,"baleful_stare"],[30,"tornado_grab"],[36,"battle_cry"],[43,"graze"],[45,"war_dance"],[54,"momentum_rush"],[63,"radiance_cannon"]],
  ...
  185: { id:185, name:"Hoverrow",   emoji:"🐦", types:["Normal","Wind"],
    ...
    learnset:[[1,"collide",[22,"wild_tumble"]],[1,"breeze"],[8,"blitz"],[14,"fortify"],[16,"wingbeat"],[24,"wind_scythe"],[25,"vortex_trap"],[32,"crushing_bulk",[5,"daunt"]],[34,"instinct_slash"],[42,"skyfall"],[3,"lashing_tail"],[33,"feral_swipe"]],
  ...
  187: { id:187, name:"Norindel",     emoji:"🐷", types:["Normal"],
    ...
    learnset:[[1,"collide",[22,"momentum_rush"]],[1,"daunt"],[3,"baleful_stare"],[10,"cranial_ram"],[14,"second_wind"],[18,"body_blow"],[20,"crushing_bulk"],[24,"battle_cry"],[26,"relentless_fury"],[30,"war_dance"],[32,"blitz"],[33,"graze"],[36,"last_stand"],[40,"radiance_cannon",[5,"lashing_tail"]],[42,"wild_tumble"]],
  ...
  199: { id:199, name:"Aeridaleth",emoji:"🦋", types:["Nature","Wind"],
    ...
    learnset:[[14,"baleful_stare"],[18,"silk_spray"],[22,"breeze"],[26,"graze"],[30,"silk_bind"],[34,"sonic_buzz"],[38,"wind_scythe"],[42,"prism_flare"],[46,"shear_strike"],[50,"resonance_hum"],[54,"stinger_volley"],[58,"typhoon"],[3,"chitin_guard"],[39,"cocoon_burst"]],
  ...
  201: { id:201, name:"Scarabion",  emoji:"🪲", types:["Nature","Metal"],
    ...
    learnset:[[1,"shear_strike"],[2,"silk_spray"],[25,"stone_slide"],[30,"fortify"],[31,"crag_strike"],[33,"swarm_dive"],[35,"pheromone_rush"],[40,"forge_blast_2"],[45,"resonance_hum"],[50,"stinger_volley"],[55,"alloy_tail"],[60,"radiance_cannon"],[3,"chitin_guard"],[39,"cocoon_burst"]],
  ...
  207: { id:207, name:"Venodrak", emoji:"🐉", types:["Poison","Draconic"],
    ...
    learnset:[[1,"ooze_bomb"],[1,"draconic_claw"],[20,"toxify"],[28,"draconic_pulse"],[36,"venom_lance"],[44,"rampage"],[52,"sludge_wave"],[60,"radiance_cannon"]],
  ...
  208: { id:208, name:"Wyrmvenom", emoji:"🐲", types:["Poison","Draconic"],
    ...
    learnset:[[1,"venom_lance"],[1,"rampage"],[30,"sludge_wave"],[38,"draconic_pulse"],[46,"hydra_dance"],[54,"corrosion_fang"],[62,"ancient_breath"],[70,"radiance_cannon"]],
  ...
  209: { id:209, name:"Boltfur", emoji:"🐇", types:["Normal","Electric"],
    ...
    learnset:[[1,"jolt"],[1,"collide"],[6,"nuzzle"],[10,"thunder_jab"],[12,"static_strike"],[16,"shock_pulse"],[20,"static_charge"],[22,"volt_jet"],[32,"galvanic_burst"],[42,"volt_surge"],[52,"ball_lightning"],[60,"radiance_cannon"]],
  ...
  210: { id:210, name:"Thundermane", emoji:"🐰", types:["Normal","Electric"],
    ...
    learnset:[[1,"volt_jet"],[1,"crushing_bulk"],[6,"rapid_strike"],[10,"bolt_smash"],[14,"body_blow"],[16,"coil_strike"],[22,"lightning_rush"],[24,"galvanic_burst"],[28,"storm_sovereignty"],[30,"relentless_fury"],[32,"volt_surge"],[40,"stormbolt"],[48,"ball_lightning"],[56,"plasma_strike"],[64,"radiance_cannon"]],
  ...
  211: { id:211, name:"Cinderfrost", emoji:"🔥", types:["Fire","Ice"],
    ...
    learnset:[[1,"flicker"],[1,"flurries"],[12,"inferno_jet"],[22,"cold_beam"],[32,"pyroclasm"],[42,"whiteout"],[52,"solar_flare"],[62,"radiance_cannon"]],
  ...
  212: { id:212, name:"Frostscorch", emoji:"🌡️", types:["Fire","Ice"],
    ...
    learnset:[[1,"inferno_jet"],[1,"cold_beam"],[22,"pyroclasm"],[30,"whiteout"],[38,"cold_snap"],[46,"solar_flare"],[54,"tundra_tomb"],[62,"radiance_cannon"]],
  ...
  213: { id:213, name:"Infriglace", emoji:"🌋", types:["Fire","Ice"],
    ...
    learnset:[[1,"pyroclasm"],[1,"whiteout"],[32,"solar_flare"],[40,"tundra_tomb"],[48,"searing_gale"],[56,"frost_crash"],[64,"caldera_meltdown"],[72,"radiance_cannon"]],
  ...
  218: { id:218, name:"Duskmist", emoji:"🌑", types:["Dark"],
    ...
    learnset:[[1,"chomp"],[1,"void_pulse"],[14,"dusk_slash"],[24,"eclipse_shroud"],[34,"jaw_crush"],[44,"soul_rend"],[54,"dread_howl"],[60,"radiance_cannon"]],
  ...
  219: { id:219, name:"Nightmont", emoji:"🖤", types:["Dark"],
    ...
    learnset:[[1,"void_pulse"],[1,"eclipse_shroud"],[28,"dusk_slash"],[36,"jaw_crush"],[44,"soul_rend"],[52,"dread_howl"],[60,"void_pulse"],[68,"radiance_cannon"]],
  ...
  220: { id:220, name:"Umbrajest", emoji:"🎭", types:["Dark","Vapor"],
    ...
    learnset:[[1,"chomp"],[1,"mind_jolt"],[5,"vapor_jab"],[7,"dark_focus"],[8,"drizzle"],[10,"mist_pulse"],[11,"shadow_jab"],[12,"void_pulse"],[14,"haze_strike"],[16,"fog_beam"],[18,"cheap_shot"],[20,"fog_kick"],[22,"psi_burst"],[24,"haze_focus"],[26,"provoke"],[28,"brume_resonance"],[32,"dusk_slash"],[42,"mental"],[52,"eclipse_shroud"],[60,"radiance_cannon"]],
  ...
  222: { id:222, name:"Mindpuff", emoji:"🫧", types:["Mental"],
    ...
    learnset:[[1,"mind_jolt"],[1,"psi_burst"],[6,"psionic_wave"],[10,"inner_calm"],[14,"mnemonic_focus"],[20,"mental"],[24,"mental_pulse"],[30,"lunar_burst"],[40,"psi_strike"],[50,"neural_storm"],[60,"radiance_cannon"]],
  ...
  223: { id:223, name:"Recallum", emoji:"🧠", types:["Mental"],
    ...
    learnset:[[1,"psi_burst"],[1,"inner_calm"],[18,"mental"],[28,"lunar_burst"],[38,"psi_strike"],[48,"neural_storm"],[56,"astral_rend"],[64,"radiance_cannon"]],
  ...
  224: { id:224, name:"Psytheon", emoji:"🔮", types:["Mental","Fairy"],
    ...
    learnset:[[1,"mental"],[1,"lunar_burst"],[15,"cerebral_punch"],[20,"prophecy"],[25,"gravitational_pull"],[30,"psyche_lock"],[32,"psi_strike"],[35,"mindbreaker"],[38,"thought_wave"],[40,"neural_storm"],[48,"astral_rend"],[56,"prism_flare"],[64,"celestial_wave"],[72,"radiance_cannon"]],
  ...
  226: { id:226, name:"Spectroo", emoji:"🌈", types:["Normal","Mental"],
    ...
    learnset:[[1,"collide"],[1,"mind_jolt"],[8,"psy_jab"],[10,"aural_ray"],[14,"psi_burst"],[18,"mental_pulse"],[22,"fairy_wind"],[24,"lumiwave"],[30,"lunar_burst"],[35,"radiant_burst_2"],[40,"mental"],[50,"radiance_cannon"]],
  ...
  227: { id:227, name:"Spectrace", emoji:"🔥", types:["Fire","Mental"],
    ...
    learnset:[[1,"inferno_jet"],[1,"mental"],[28,"pyroclasm"],[36,"psi_strike"],[44,"astral_rend"],[52,"solar_flare"],[60,"neural_storm"],[68,"radiance_cannon"]],
  ...
  231: { id:231, name:"Wyvaxis", emoji:"🐲", types:["Draconic","Aquatic"],
    ...
    learnset:[[1,"draconic_claw"],[1,"tidal_rush"],[15,"drake_tail"],[20,"scale_shot"],[25,"wyrm_gale"],[30,"draconic_pulse"],[38,"hydra_dance"],[46,"tsunami"],[54,"rampage"],[62,"ancient_breath"],[70,"radiance_cannon"]],
    evolveTo:null, evolveLevel:null, catchRate:45, expYield:220, rarity:"uncommon",
  ...
  232: { id:232, name:"Serphaxon", emoji:"🐲", types:["Draconic"],
    ...
    learnset:[[1,"collide"],[1,"mud_spray"],[14,"draconic_breath"],[24,"tectonic_shift"],[34,"draconic_claw"],[44,"draconic_pulse"],[54,"rampage"],[64,"radiance_cannon"]],
  ...
  233: { id:233, name:"Serpenthorn", emoji:"🐍", types:["Draconic","Earth"],
    ...
    learnset:[[1,"draconic_claw"],[1,"tectonic_shift"],[15,"breaking_swipe"],[20,"serpent_coil"],[26,"geoblast"],[30,"serpent_rage"],[34,"draconic_pulse"],[42,"hydra_dance"],[50,"rampage"],[58,"bedrock_slam"],[66,"radiance_cannon"]],
  ...
  234: { id:234, name:"Wyvernak", emoji:"🐉", types:["Draconic","Earth"],
    ...
    learnset:[[1,"rampage"],[1,"tectonic_shift"],[20,"sky_surge"],[28,"wyvern_maw"],[36,"hydra_dance"],[40,"comet_crash"],[44,"geoblast"],[52,"draconic_pulse"],[60,"bedrock_slam"],[68,"ancient_breath"],[76,"radiance_cannon"]],
  ...
  237: { id:237, name:"Icevault", emoji:"❄️", types:["Ice","Earth"],
    ...
    learnset:[[1,"cold_beam"],[1,"stone_slide"],[24,"whiteout"],[32,"crag_strike"],[40,"cryo_lance"],[48,"frost_crash"],[56,"avalanche_drive"],[64,"radiance_cannon"]],
  ...
  238: { id:238, name:"Snowble", emoji:"☃️", types:["Ice"],
    ...
    learnset:[[1,"flurries"],[1,"collide"],[10,"cold_snap"],[18,"cryo_lance"],[26,"cold_beam"],[36,"whiteout"],[46,"avalanche_drive"],[56,"radiance_cannon"]],
  ...
  239: { id:239, name:"Blizzariel", emoji:"☃️", types:["Ice"],
    ...
    learnset:[[1,"frost_crash"],[1,"cold_beam"],[12,"arctic_calm"],[18,"hail_barrage"],[22,"whiteout"],[30,"permafrost"],[38,"cryo_lance"],[46,"frost_crash"],[54,"avalanche_drive"],[62,"radiance_cannon"]],
  ...
  240: { id:240, name:"Tundrafox", emoji:"☃️", types:["Ice","Dark"],
    ...
    learnset:[[1,"whiteout"],[1,"void_pulse"],[8,"fear_aura"],[12,"arctic_calm"],[16,"backstab"],[18,"aurora_blast"],[20,"throat_chop"],[22,"blizzard_charge"],[26,"cryogenic_breath"],[28,"wraith_drive"],[30,"frostbite_strike"],[32,"cryo_lance"],[36,"glacial_lance"],[40,"frost_crash"],[44,"ice_claw"],[48,"avalanche_drive"],[52,"ice_hammer"],[56,"tundra_tomb"],[60,"absolute_zero"],[64,"sleet_barrage"],[68,"starlight_obliteration"],[72,"dusk_slash"]],
  ...
  243: { id:243, name:"Stuntrap", emoji:"🪲", types:["Electric","Nature"],
    ...
    learnset:[[1,"volt_jet"],[1,"shear_strike"],[24,"galvanic_burst"],[32,"resonance_hum"],[40,"stormbolt"],[48,"volt_surge"],[56,"ball_lightning"],[64,"radiance_cannon"]],
    evolveTo:null, evolveLevel:null, catchRate:50, expYield:215, rarity:"uncommon",
  ...
  247: { id:247, name:"Sparkeen", emoji:"🦋", types:["Electric"],
    ...
    learnset:[[1,"volt_jet"],[1,"resonance_hum"],[18,"galvanic_burst"],[28,"shear_strike"],[38,"stormbolt"],[48,"volt_surge"],[58,"ball_lightning"],[68,"radiance_cannon"]],
    evolveTo:null, evolveLevel:null, catchRate:50, expYield:210, rarity:"uncommon",
  ...
  248: { id:248, name:"Pebblard", emoji:"🪨", types:["Earth"],
    ...
    learnset:[[1,"stone_throw"],[1,"collide"],[12,"stone_slide"],[22,"geoblast"],[32,"crag_strike"],[42,"tectonic_shift"],[52,"bedrock_slam"],[60,"radiance_cannon"]],
  ...
  252: { id:252, name:"Stonegrip", emoji:"🛡️", types:["Earth","Metal"],
    ...
    learnset:[[1,"crag_strike"],[1,"forge_blast_2"],[28,"alloy_tail"],[36,"forge_strike"],[44,"tectonic_shift"],[52,"bedrock_slam"],[60,"heavy_slam"],[68,"radiance_cannon"]],
  ...
  253: { id:253, name:"Ashrock", emoji:"🌋", types:["Fire","Mineral"],
    ...
    learnset:[[1,"stone_throw"],[1,"flicker"],[18,"stone_slide"],[28,"inferno_jet"],[38,"crag_strike"],[48,"magma_stone"],[58,"pyroclasm"],[68,"radiance_cannon"]],
  ...
  254: { id:254, name:"Bubblepuff", emoji:"🫧", types:["Aquatic","Mental"],
    ...
    learnset:[[1,"aquatic_gun"],[1,"mind_jolt"],[10,"bubble_jet"],[20,"psi_burst"],[30,"tidal_rush"],[40,"mental"],[50,"tsunami"],[60,"radiance_cannon"]],
  ...
  255: { id:255, name:"Psychotide", emoji:"🌊", types:["Aquatic","Mental"],
    ...
    learnset:[[1,"tidal_rush"],[1,"mental"],[22,"tsunami"],[30,"psi_strike"],[38,"tidal_sweep"],[46,"neural_storm"],[54,"geyser_burst"],[62,"radiance_cannon"]],
    evolveTo:null, evolveLevel:null, catchRate:45, expYield:220, rarity:"uncommon",
  ...
  256: { id:256, name:"Scolphin", emoji:"🐬", types:["Aquatic"],
    ...
    learnset:[[1,"aquatic_gun"],[1,"flurries"],[12,"bubble_jet"],[22,"cold_beam"],[32,"tidal_rush"],[42,"whiteout"],[52,"tsunami"],[60,"radiance_cannon"]],
  ...
  257: { id:257, name:"Reefhorn", emoji:"🦄", types:["Aquatic","Ice"],
    ...
    learnset:[[1,"cold_beam"],[1,"tidal_rush"],[20,"whiteout"],[28,"tidal_sweep"],[36,"cryo_lance"],[44,"tsunami"],[52,"frost_crash"],[60,"radiance_cannon"]],
  ...
  258: { id:258, name:"Torrentox", emoji:"🐋", types:["Aquatic","Ice"],
    ...
    learnset:[[1,"tsunami"],[1,"whiteout"],[30,"tidal_sweep"],[38,"cryo_lance"],[46,"frost_crash"],[54,"tundra_tomb"],[62,"geyser_burst"],[70,"radiance_cannon"]],
  ...
  260: { id:260, name:"Sproutix", emoji:"🌱", types:["Nature"],
    ...
    learnset:[[1,"vine_lash"],[1,"fairy_wind"],[12,"sharp_leaves"],[22,"lunar_burst"],[32,"verdant_orb"],[42,"petal_blitz"],[52,"prism_flare"],[60,"radiance_cannon"]],
  ...
  262: { id:262, name:"Transluceed", emoji:"🌿", types:["Fighting","Toxin"],
    ...
    learnset:[[1,"vine_lash"],[1,"septic_prick"],[5,"caustic_shell"],[8,"ki_blast"],[10,"sharp_leaves"],[12,"warrior_block"],[15,"corrosive_step"],[18,"martial_aura"],[20,"ooze_bomb"],[25,"acid_burst_2"],[30,"verdant_orb"],[40,"toxify"],[50,"petal_blitz"],[60,"radiance_cannon"]],
  ...
  263: { id:263, name:"Tendrilisk", emoji:"🌵", types:["Fighting","Toxin"],
    ...
    learnset:[[1,"sharp_leaves"],[1,"ooze_bomb"],[15,"focus_pose"],[18,"verdant_orb"],[20,"acrid_claw"],[22,"martial_intent"],[25,"acid_slash"],[28,"toxify"],[30,"acid_burst_2"],[33,"crippling_blow"],[36,"petal_blitz"],[44,"venom_lance"],[45,"acid_press"],[52,"grove_wrath"],[60,"radiance_cannon"]],
  ...
  264: { id:264, name:"Impenezard", emoji:"🌳", types:["Fighting","Toxin"],
    ...
    learnset:[[1,"petal_blitz"],[1,"venom_lance"],[10,"flying_press"],[15,"acrid_claw"],[18,"focused_beam"],[20,"corrosive_step"],[24,"recovery_stance"],[28,"acid_slash"],[30,"grove_wrath"],[35,"martial_finish"],[38,"toxify"],[45,"acid_press"],[46,"verdant_orb"],[54,"sludge_wave"],[62,"briar_lash"],[70,"radiance_cannon"]],
  ...
  269: { id:269, name:"Grimshade", emoji:"🦝", types:["Dark"],
    ...
    learnset:[[1,"chomp"],[1,"void_pulse"],[5,"dark_focus"],[8,"cheap_shot"],[14,"dusk_slash"],[18,"shadow_cloak"],[24,"eclipse_shroud"],[28,"backstab"],[34,"jaw_crush"],[44,"soul_rend"],[54,"dread_howl"],[60,"radiance_cannon"]],
  ...
  270: { id:270, name:"Eclipsoon", emoji:"🌑", types:["Dark","Fairy"],
    ...
    learnset:[[1,"void_pulse"],[1,"lunar_burst"],[6,"beguile"],[8,"sinister_scheme"],[10,"enchant"],[12,"umbral_pulse"],[14,"fairy_jab"],[16,"shadow_lance"],[20,"abyss_stare"],[24,"eclipse_burst"],[26,"misty_explosion"],[28,"eclipse_shroud"],[32,"shadowstorm"],[34,"dream_drain"],[36,"soul_rend"],[40,"stygian_whisper"],[44,"dread_howl"],[48,"wicked_torrent"],[52,"fae_requiem"],[56,"abyssal_dominion"],[60,"nether_sphere"],[68,"radiance_cannon"]],
  ...
  273: { id:273, name:"Blazeon", emoji:"🔥", types:["Fire","Draconic"],
    ...
    learnset:[[1,"inferno_jet"],[1,"draconic_claw"],[26,"pyroclasm"],[34,"draconic_pulse"],[42,"rampage"],[50,"hydra_dance"],[58,"caldera_meltdown"],[66,"radiance_cannon"]],
  ...
  274: { id:274, name:"Cindling", emoji:"🪨", types:["Fire","Mineral"],
    ...
    learnset:[[1,"flicker"],[1,"stone_throw"],[10,"stone_slide"],[15,"mica_lattice"],[20,"inferno_jet"],[30,"crag_strike"],[40,"pyroclasm"],[50,"magma_stone"],[60,"radiance_cannon"]],
  ...
  275: { id:275, name:"Infernox", emoji:"🌋", types:["Fire","Mineral"],
    ...
    learnset:[[1,"inferno_jet"],[1,"crag_strike"],[8,"coal_smash"],[12,"ember_focus"],[16,"flash_fire"],[20,"lava_drop"],[22,"pyroclasm"],[26,"magma_strike"],[30,"magma_stone"],[34,"molten_tide"],[38,"stone_slide"],[42,"pyre_strike"],[44,"searing_glare"],[46,"tectonic_shift"],[50,"volcanic_wrath"],[54,"caldera_meltdown"],[62,"radiance_cannon"]],
  ...
  279: { id:279, name:"Steelhorn", emoji:"🦌", types:["Metal","Fairy"],
    ...
    learnset:[[1,"forge_blast_2"],[1,"lunar_burst"],[28,"alloy_tail"],[36,"prism_flare"],[44,"forge_strike"],[52,"heavy_slam"],[60,"celestial_wave"],[68,"radiance_cannon"]],
    evolveTo:null, evolveLevel:null, catchRate:38, expYield:228, rarity:"rare",
  ...
  280: { id:280, name:"Gearbit", emoji:"🔩", types:["Metal","Fighting"],
    ...
    learnset:[[1,"chrome_claw"],[1,"mud_spray"],[8,"spinning_kick"],[12,"forge_blast_2"],[16,"high_kick"],[22,"geoblast"],[32,"alloy_tail"],[42,"tectonic_shift"],[52,"forge_strike"],[60,"radiance_cannon"]],
  ...
  281: { id:281, name:"Cogvex", emoji:"⚙️", types:["Metal","Fighting"],
    ...
    learnset:[[1,"forge_blast_2"],[1,"geoblast"],[15,"shockwave_kick"],[22,"alloy_tail"],[26,"iron_will"],[30,"tectonic_shift"],[38,"forge_strike"],[46,"bedrock_slam"],[54,"heavy_slam"],[62,"radiance_cannon"]],
  ...
  282: { id:282, name:"Mechavast", emoji:"🤖", types:["Metal","Fighting"],
    ...
    learnset:[[1,"forge_strike"],[1,"tectonic_shift"],[15,"flying_press"],[20,"smart_strike"],[24,"focused_beam"],[26,"metal_roller"],[30,"martial_finish"],[32,"heavy_slam"],[36,"titan_blade"],[40,"bedrock_slam"],[48,"alloy_tail"],[56,"geoblast"],[64,"forge_blast_2"],[72,"radiance_cannon"]],
  ...
  284: { id:284, name:"Fluffkin", emoji:"☁️", types:["Normal","Wind"],
    ...
    learnset:[[1,"collide"],[1,"breeze"],[12,"wind_scythe"],[22,"crushing_bulk"],[32,"typhoon"],[42,"downdraft"],[52,"gale_cannon"],[60,"radiance_cannon"]],
  ...
  285: { id:285, name:"Cloudrift", emoji:"🌤️", types:["Normal","Wind"],
    ...
    learnset:[[1,"wind_scythe"],[1,"crushing_bulk"],[20,"typhoon"],[28,"gale_cannon"],[36,"downdraft"],[44,"squall_slash"],[52,"tempest_wrath"],[60,"radiance_cannon"]],
    evolveTo:null, evolveLevel:null, catchRate:45, expYield:218, rarity:"uncommon",
  ...
  289: { id:289, name:"Bouncyblob", emoji:"🎱", types:["Normal"],
    ...
    learnset:[[1,"collide"],[1,"crushing_bulk"],[18,"cranial_ram"],[28,"reckless_charge"],[38,"heavy_slam"],[48,"battle_cry"],[58,"iron_press"],[68,"radiance_cannon"]],
  ...
  291: { id:291, name:"Breezekin", emoji:"🌬️", types:["Wind"],
    ...
    learnset:[[1,"breeze"],[1,"wind_scythe"],[6,"gust_jab"],[10,"breeze_blade"],[12,"downdraft"],[16,"updraft"],[22,"typhoon"],[32,"gale_cannon"],[42,"squall_slash"],[52,"tempest_wrath"],[60,"radiance_cannon"]],
  ...
  292: { id:292, name:"Galehorn", emoji:"🌪️", types:["Wind","Sonic"],
    ...
    learnset:[[1,"wind_scythe"],[1,"volt_jet"],[8,"drumstroke"],[10,"falcon_dive"],[12,"soundproof"],[14,"mistral_focus"],[16,"wail"],[18,"slicing_gale"],[22,"typhoon"],[26,"slipstream"],[30,"stormbolt"],[34,"gale_strike"],[38,"tempest_wrath"],[42,"windshear"],[44,"zephyr_arrow"],[46,"gale_cannon"],[54,"squall_slash"],[62,"radiance_cannon"]],
    evolveTo:null, evolveLevel:null, catchRate:45, expYield:220, rarity:"uncommon",
  ...
  297: { id:297, name:"Blightwing", emoji:"🦟", types:["Poison","Toxin"],
    ...
    learnset:[[1,"shear_strike"],[1,"ooze_bomb"],[10,"vile_cross"],[12,"gunk_blast"],[15,"plague_claw"],[18,"toxic_lash"],[20,"toxify"],[22,"plague_strike"],[25,"blight_strike"],[28,"virulent_surge"],[35,"toxin_pulse"],[36,"resonance_hum"],[44,"venom_lance"],[52,"sludge_wave"],[60,"radiance_cannon"]],
  ...
  299: { id:299, name:"Stinglet", emoji:"🐝", types:["Toxin","Sonic"],
    ...
    learnset:[[1,"resonance_hum"],[1,"septic_prick"],[5,"toxic_kiss"],[8,"discord"],[12,"shear_strike"],[15,"squalid_field"],[18,"silent_strike"],[22,"ooze_bomb"],[32,"toxify"],[42,"virulent_surge"],[52,"venom_lance"],[60,"radiance_cannon"]],
  ...
  300: { id:300, name:"Nettleclaw", emoji:"🐝", types:["Toxin","Sonic"],
    ...
    learnset:[[1,"shear_strike"],[1,"venom_lance"],[6,"discord"],[8,"quill_barrage"],[10,"echo_chamber"],[12,"mantis_slash"],[15,"toxic_kiss"],[18,"maul"],[20,"venom_ray"],[22,"toxify"],[25,"squalid_field"],[28,"infestation"],[30,"virulent_surge"],[32,"pox_mark"],[34,"twin_sting"],[36,"hivemind_surge"],[38,"ooze_bomb"],[40,"swarm_assault"],[44,"locust_fury"],[46,"resonance_hum"],[50,"swarm_strike"],[54,"sludge_wave"],[62,"radiance_cannon"]],
  ...
  302: { id:302, name:"Lightpuff", emoji:"🌟", types:["Fairy"],
    ...
    learnset:[[1,"fairy_wind"],[1,"prism_flare"],[14,"lunar_burst"],[24,"celestial_wave"],[34,"glitter_storm"],[44,"fae_requiem"],[54,"moonveil"],[60,"radiance_cannon"]],
  ...
  303: { id:303, name:"Lumivane", emoji:"🌠", types:["Fairy","Mental"],
    ...
    learnset:[[1,"lunar_burst"],[1,"mental"],[12,"sparkle_shot"],[18,"misty_terrain"],[24,"starfall"],[28,"celestial_wave"],[32,"supernova_glow"],[36,"psi_strike"],[44,"glitter_storm"],[52,"neural_storm"],[60,"fae_requiem"],[68,"radiance_cannon"]],
  ...
  305: { id:305, name:"Geoshard", emoji:"🗻", types:["Earth","Ice"],
    ...
    learnset:[[1,"cold_beam"],[1,"crag_strike"],[22,"cryo_lance"],[30,"whiteout"],[38,"bedrock_slam"],[46,"frost_crash"],[54,"avalanche_drive"],[62,"radiance_cannon"]],
  ...
  306: { id:306, name:"Crystallon", emoji:"🏔️", types:["Earth","Ice"],
    ...
    learnset:[[1,"whiteout"],[1,"bedrock_slam"],[32,"avalanche_drive"],[40,"frost_crash"],[48,"crag_strike"],[56,"tundra_tomb"],[64,"worldseed_quake"],[72,"radiance_cannon"]],
  ...
  313: { id:313, name:"Sandrix", emoji:"🪨", types:["Earth","Dark"],
    ...
    learnset:[[1,"tectonic_shift"],[1,"void_pulse"],[8,"bone_cudgel"],[12,"earthen_wall"],[16,"mineral_polish"],[20,"erosion_wave"],[24,"quicksand_trap"],[26,"dusk_slash"],[28,"sand_storm_polish"],[30,"smack_down"],[34,"geoblast"],[36,"ancient_tide"],[40,"underground_crush"],[42,"eclipse_shroud"],[44,"scorched_sand"],[46,"run_down"],[50,"bedrock_slam"],[54,"world_root_bind"],[58,"soul_rend"],[66,"radiance_cannon"]],
  ...
  315: { id:315, name:"Ashvanus",   emoji:"🌋", types:["Fire","Earth"],
    ...
    learnset:[[1,"flicker"],[1,"stone_throw"],[7,"flame_fang"],[14,"stone_slide"],[21,"magma_surge"],[28,"crag_strike"],[35,"ashfall"],[42,"inferno_jet"],[49,"magma_stone"],[56,"pyroclasm"],[63,"caldera_meltdown"],[70,"bedrock_slam"],[77,"radiance_cannon"]],
    evolveTo:null, evolveLevel:null, catchRate:3, expYield:310, rarity:"legendary",
  ...
  92: { id:92, name:"Arcspine", emoji:"⚡", types:["Electric","Earth"],
    ...
    learnset:[[1,"stone_throw",[22,"arc_flash"]],[1,"jolt"],[10,"static_strike"],[18,"stone_slide"],[20,"second_wind"],[26,"volt_jet"],[34,"crag_strike",[5,"stun_pulse"]],[36,"volt_surge"],[3,"static_cage"],[31,"ball_lightning"]],
  ...
  19: { id:19, name:"Magmaurin", emoji:"🐾", types:["Fire","Earth"],
    ...
    learnset:[[1,"flicker",[22,"magma_surge"]],[1,"graze"],[9,"mud_spray"],[17,"flame_fang"],[20,"baleful_stare"],[25,"tectonic_shift"],[33,"inferno_jet",[5,"scorch_veil"]],[36,"cinderwhirl"],[3,"embercloak"],[31,"wildfire_surge"]],
  ...
  72: { id:72, name:"Floralin", emoji:"🌸", types:["Fairy","Nature"],
    ...
    learnset:[[1,"collide",[20,"stardust_veil"]],[1,"fairy_wind"],[8,"vine_lash"],[16,"prism_flare"],[21,"baleful_stare"],[24,"sharp_leaves"],[32,"lunar_burst",[5,"bewitching_kiss"]],[36,"pod_blast"],[3,"charm_bloom"],[31,"verdant_edge"]],
  ...
  104: { id:104, name:"Arenikin", emoji:"🐾", types:["Normal","Earth"],
    ...
    learnset:[[1,"collide",[22,"sandstrike"]],[1,"daunt"],[8,"mud_spray"],[16,"blitz"],[20,"clay_armor"],[24,"cranial_ram"],[32,"tectonic_shift",[5,"lashing_tail"]],[36,"boulder_roll"],[3,"baleful_stare"],[31,"mire_burst"]],
  ...
  31: { id:31, name:"Toxaquil", emoji:"🐙", types:["Aquatic","Poison"],
    ...
    learnset:[[1,"aquatic_gun",[22,"putrid_pulse"]],[1,"septic_prick"],[10,"bubble_jet"],[18,"ooze_bomb"],[20,"second_wind"],[26,"tidal_rush"],[34,"toxify",[5,"tidecaller"]],[36,"corrosion_fang"],[3,"deepwater_hymn"],[31,"sludge_wave"]],
  ...
  37: { id:37, name:"Coralossus", emoji:"🪸", types:["Aquatic","Metal"],
    ...
    learnset:[[1,"aquatic_gun",[25,"ironskin"]],[1,"chrome_claw"],[11,"fortify"],[16,"war_dance"],[19,"tidal_sweep"],[27,"forge_blast_2"],[29,"rivet_barrage"],[35,"tidal_rush"],[40,"tidal_crush"],[43,"alloy_tail",[5,"tidecaller"]],[3,"deepwater_hymn"],[33,"smelt_crush"]],
  ...
  39: { id:39, name:"Gossafin", emoji:"🐬", types:["Aquatic","Wind"],
    ...
    learnset:[[1,"aquatic_gun",[24,"tidal_crush"]],[1,"breeze"],[12,"bubble_jet"],[20,"wingbeat"],[25,"war_dance"],[28,"tidal_rush"],[36,"wind_scythe"],[44,"tsunami"],[45,"riptide_slam"],[52,"typhoon",[5,"tidecaller"]],[3,"deepwater_hymn"],[37,"storm_surge"]],
  ...
  116: { id:116, name:"Zephyrin", emoji:"🌀", types:["Wind","Mental"],
    ...
    learnset:[[1,"breeze",[22,"synaptic_shatter"]],[1,"mind_jolt"],[9,"blitz"],[17,"wind_scythe"],[25,"psi_burst"],[29,"psi_strike"],[33,"typhoon"],[41,"mental",[5,"mistveil"]],[3,"zephyr_dance"],[32,"astral_rend"]],
  ...
  78: { id:78, name:"Sylvnox", emoji:"🌿", types:["Nature","Dark"],
    ...
    learnset:[[1,"vine_lash",[22,"root_lance"]],[1,"chomp"],[10,"sharp_leaves"],[18,"dusk_slash"],[26,"verdant_orb"],[30,"grove_wrath"],[34,"jaw_crush"],[42,"void_pulse",[5,"slumber_dust"]],[3,"spore_burst"],[32,"void_rend"]],
  ...
  128: { id:128, name:"Cranivade", emoji:"🔮", types:["Mental","Spectral"],
    ...
    learnset:[[1,"mind_jolt",[22,"telepathic_slam"]],[1,"chomp"],[3,"prism_ward"],[10,"psi_burst"],[14,"sinister_scheme"],[18,"void_pulse"],[20,"ectoplasm_wave"],[25,"wraith_focus"],[26,"mental"],[30,"neural_storm"],[32,"blackout_bomb"],[34,"nether_sphere"],[42,"psi_strike",[5,"inner_calm"]]],
  ...
  130: { id:130, name:"Necralia", emoji:"🌿", types:["Dark","Nature"],
    ...
    learnset:[[1,"chomp",[24,"obsidian_fang"]],[1,"vine_lash"],[11,"dusk_slash"],[19,"sharp_leaves"],[23,"second_wind"],[27,"jaw_crush"],[35,"verdant_orb"],[42,"nightmare_pulse"],[43,"void_pulse"],[51,"nether_sphere",[5,"eclipse_shroud"]],[3,"dread_howl"],[37,"savage_blow"]],
  ...
  202: { id:202, name:"Sculptweave", emoji:"🕷️", types:["Nature","Fairy"],
    ...
    learnset:[[1,"silk_spray",[22,"silk_bind"]],[1,"fairy_wind"],[9,"mandible_bite"],[17,"prism_flare"],[20,"second_wind"],[25,"shear_strike"],[33,"lunar_burst",[5,"chitin_guard"]],[36,"swarm_dive"],[3,"compound_glare"],[31,"resonance_hum"]],
  ...
  41: { id:41, name:"Titanomare", emoji:"🐋", types:["Aquatic","Metal"],
    ...
    learnset:[[1,"tidal_rush",[1,"sea_serpent_strike"]],[1,"alloy_tail"],[1,"tidal_sweep"],[1,"forge_blast_2"],[18,"daunt"],[31,"collide"],[44,"bubble_jet"],[55,"tsunami"],[58,"temper_edge"],[65,"radiance_cannon",[5,"tidecaller"]],[3,"deepwater_hymn"],[41,"forge_strike"]],
  ...
  93: { id:93, name:"Stonebolt", emoji:"🪨", types:["Electric","Earth"],
    ...
    learnset:[[1,"stone_slide"],[2,"volt_jet"],[3,"static_strike"],[4,"stun_pulse"],[31,"crag_strike"],[33,"volt_surge"],[35,"vital_pulse"],[40,"geode_burst"],[45,"tectonic_shift"],[50,"stormbolt"],[55,"overcharge"],[60,"radiance_cannon"],[5,"static_cage"],[39,"voltaic_rush"]],
  ...
  135: { id:135, name:"Steelvex", emoji:"🦇", types:["Metal","Dark"],
    ...
    learnset:[[1,"forge_blast_2"],[2,"void_pulse"],[3,"magnetize"],[30,"jaw_crush"],[33,"nether_sphere"],[34,"fortify"],[38,"rivet_barrage"],[43,"metal_wing"],[48,"dusk_slash"],[53,"forge_strike"],[58,"void_rend"],[63,"alloy_tail"],[4,"ironskin"],[41,"smelt_crush"]],
  ...
  73: { id:73, name:"Faelomis", emoji:"🌺", types:["Fairy","Nature"],
    ...
    learnset:[[1,"fairy_wind"],[2,"prism_flare"],[3,"vine_lash"],[4,"bewitching_kiss"],[21,"sharp_leaves"],[27,"lashing_tail"],[29,"lunar_burst"],[34,"graze"],[41,"moonveil"],[48,"celestial_wave"],[55,"verdant_orb"],[62,"petal_blitz"],[5,"stardust_veil"],[42,"verdant_edge"]],
  ...
  105: { id:105, name:"Dravanas", emoji:"🐾", types:["Normal","Earth"],
    ...
    learnset:[[1,"mud_spray"],[2,"daunt"],[22,"cranial_ram"],[28,"vital_pulse"],[29,"tectonic_shift"],[33,"boulder_roll"],[34,"war_dance"],[40,"wild_tumble"],[46,"momentum_rush"],[52,"crushing_bulk"],[58,"geoblast"],[64,"radiance_cannon"],[3,"lashing_tail"],[42,"loam_leech"]],
    evolveTo:null, evolveLevel:null, catchRate:55, expYield:200, rarity:"uncommon",
  ...
  32: { id:32, name:"Noxaquith", emoji:"🦑", types:["Aquatic","Poison"],
    ...
    learnset:[[1,"ooze_bomb"],[2,"tidal_rush"],[3,"tidecaller"],[31,"toxify"],[33,"corrosion_fang"],[34,"daunt"],[38,"collide"],[43,"blight_mist"],[48,"virulent_surge"],[53,"void_pulse"],[58,"sludge_wave"],[63,"tsunami"],[4,"deepwater_hymn"],[41,"venom_lance"]],
  ...
  117: { id:117, name:"Pneumathos", emoji:"🌪️", types:["Wind","Mental"],
    ...
    learnset:[[1,"wind_scythe"],[2,"psi_burst"],[3,"psi_strike"],[4,"synaptic_shatter"],[5,"mistveil"],[6,"zephyr_dance"],[10,"air_barrier"],[14,"wind_barrier"],[18,"air_resonance"],[22,"suction_wave"],[26,"cyclone_smash"],[30,"tempest_wave"],[32,"typhoon"],[34,"tornado_slam"],[38,"mental"],[39,"fortify"],[41,"astral_rend"],[44,"inner_calm"],[48,"hurricane_blast"],[50,"insight_flare"],[56,"thought_crush"],[62,"radiance_cannon"]],
  ...
  79: { id:79, name:"Morraveth", emoji:"🌳", types:["Nature","Dark"],
    ...
    learnset:[[1,"sharp_leaves"],[2,"verdant_orb"],[3,"dusk_slash"],[4,"slumber_dust"],[31,"jaw_crush"],[35,"fortify"],[39,"void_pulse"],[40,"photon_leaf"],[45,"nether_sphere"],[50,"blackout_bomb"],[55,"void_rend"],[60,"petal_blitz"],[5,"spore_burst"],[38,"verdant_edge"]],
  ...
  203: { id:203, name:"Arachnalis", emoji:"🕸️", types:["Nature","Fairy"],
    ...
    learnset:[[1,"prism_flare"],[2,"shear_strike"],[3,"silk_spray"],[30,"lunar_burst"],[31,"charm_bloom"],[34,"fortify"],[38,"pheromone_rush"],[42,"wild_tumble"],[46,"gossamer_lance"],[50,"moonveil"],[54,"resonance_hum"],[58,"fae_requiem"],[4,"chitin_guard"],[37,"mandible_crush"]],
  ...
  56: { id:56, name:"Deepfreeze", emoji:"⚔️", types:["Ice","Metal"],
    ...
    learnset:[[1,"glacial_punch"],[2,"forge_blast_2"],[3,"frost_crash"],[4,"alloy_tail"],[5,"permafrost"],[40,"whiteout"],[41,"winter_shroud"],[44,"war_dance"],[48,"rime_shard"],[52,"metal_wing"],[56,"avalanche_drive"],[60,"radiance_cannon"],[6,"frostfire_veil"],[37,"subzero_slash"]],
  ...
  60: { id:60, name:"Boreadrake", emoji:"🐉", types:["Ice","Draconic"],
    ...
    learnset:[[1,"cold_beam"],[2,"draconic_pulse"],[3,"frost_crash"],[4,"permafrost"],[41,"whiteout"],[44,"war_dance"],[48,"hydra_dance"],[49,"rampage"],[52,"rime_shard"],[56,"avalanche_drive"],[60,"ancient_breath"],[64,"radiance_cannon"],[5,"winter_shroud"],[38,"drake_rush"]],
  ...
  22: { id:22, name:"Hallucigaze", emoji:"🔥", types:["Fire","Mental"],
    ...
    learnset:[[1,"flicker",[20,"cinderwhirl"]],[1,"mind_jolt"],[3,"embercloak"],[7,"psy_jab"],[9,"psi_burst"],[13,"cerebral_punch"],[15,"mind_strike"],[17,"inferno_jet"],[21,"second_wind"],[25,"mental"],[31,"conflagration"],[33,"pyroclasm",[5,"scorch_veil"]],[36,"magma_surge"]],
  ...
  23: { id:23, name:"Pyraxis", emoji:"🦎", types:["Fire","Mental"],
    ...
    learnset:[[1,"inferno_jet"],[2,"mental"],[3,"scorch_veil"],[4,"embercloak"],[15,"mind_strike"],[20,"brain_blast"],[25,"telekinetic_throw"],[30,"pyroclasm"],[32,"battle_cry"],[36,"inner_calm"],[38,"thought_crush"],[40,"dreamweave"],[44,"searing_gale"],[48,"psi_strike"],[52,"synaptic_shatter"],[56,"conflagration"],[60,"solar_flare"]],
  ...
  76: { id:76, name:"Sparkwood", emoji:"🌳", types:["Nature","Electric"],
    ...
    learnset:[[1,"sharp_leaves"],[2,"second_wind"],[3,"vine_lash"],[4,"volt_surge"],[5,"slumber_dust"],[22,"verdant_orb"],[29,"volt_jet"],[30,"war_dance"],[38,"petal_blitz"],[46,"verdant_surge"],[54,"stormbolt"],[62,"radiance_cannon"],[6,"spore_burst"],[42,"canopy_crash"]],
  ...
  154: { id:154, name:"Terragolem", emoji:"🤖", types:["Metal","Earth"],
    ...
    learnset:[[1,"forge_blast_2"],[2,"tectonic_shift"],[3,"magnetize"],[4,"ironskin"],[15,"iron_bulwark"],[20,"wrought_shockwave"],[26,"magnet_burst"],[30,"alloy_tail"],[31,"battle_cry"],[33,"metal_roller"],[34,"loam_leech"],[37,"aftershock"],[38,"stone_slide"],[42,"temper_edge"],[46,"crushing_bulk"],[50,"geoblast"],[54,"tungsten_ram"],[58,"anvil_drop"]],
  ...
  107: { id:107, name:"Quakeon", emoji:"🐲", types:["Draconic","Earth"],
    ...
    learnset:[[1,"draconic_claw"],[2,"tectonic_shift"],[3,"hydra_dance"],[32,"draconic_pulse"],[36,"battle_cry"],[40,"saurian_roar"],[44,"tremor_stomp"],[48,"geoblast"],[52,"eon_crash"],[56,"ancient_breath"],[60,"rampage"],[64,"radiance_cannon"],[4,"primordial_roar"],[39,"scale_storm"]],
    evolveTo:null, evolveLevel:null, catchRate:25, expYield:260, rarity:"rare",
  ...
  189: { id:189, name:"Woolcalm", emoji:"🐑", types:["Normal","Mental"],
    ...
    learnset:[[1,"collide",[22,"future_echo"]],[1,"mind_jolt"],[3,"baleful_stare"],[6,"mesmerize"],[9,"daunt"],[12,"cerebral_calm"],[17,"psi_burst"],[20,"mental_pulse"],[25,"second_wind"],[29,"dreamweave"],[32,"psi_blade"],[33,"mental"],[41,"inner_calm",[5,"lashing_tail"]]],
  ...
  204: { id:204, name:"Muddite", emoji:"🐛", types:["Nature","Earth"],
    ...
    learnset:[[1,"mandible_bite",[22,"chitin_guard"]],[1,"mud_spray"],[10,"silk_spray"],[18,"shear_strike"],[20,"baleful_stare"],[26,"tectonic_shift"],[34,"resonance_hum",[5,"compound_glare"]],[36,"swarm_dive"],[3,"moth_dust"],[31,"aftershock"]],
  ...
  205: { id:205, name:"Quarrix", emoji:"🪲", types:["Nature","Earth"],
    ...
    learnset:[[1,"shear_strike"],[2,"silk_spray"],[24,"tectonic_shift"],[29,"war_dance"],[31,"resonance_hum"],[34,"sandstrike"],[39,"stone_slide"],[44,"mandible_crush"],[49,"cocoon_burst"],[54,"geoblast"],[59,"crag_strike"],[64,"radiance_cannon"],[3,"chitin_guard"],[41,"auger_strike"]],
    evolveTo:null, evolveLevel:null, catchRate:45, expYield:215, rarity:"uncommon",
  ...
  145: { id:145, name:"Faerrin", emoji:"📌", types:["Fairy","Metal"],
    ...
    learnset:[[1,"fairy_wind",[22,"ironskin"]],[1,"chrome_claw"],[9,"prism_flare"],[17,"forge_blast_2"],[20,"second_wind"],[25,"lunar_burst"],[33,"alloy_tail",[5,"bewitching_kiss"]],[36,"gossamer_lance"],[3,"stardust_veil"],[31,"glitter_storm"]],
  ...
  146: { id:146, name:"Shinarith", emoji:"🛡️", types:["Fairy","Metal"],
    ...
    learnset:[[1,"prism_flare"],[2,"forge_blast_2"],[3,"lunar_burst"],[4,"chrome_claw"],[5,"bewitching_kiss"],[30,"alloy_tail"],[32,"daunt"],[38,"collide"],[44,"metal_wing"],[50,"temper_edge"],[56,"moonveil"],[62,"radiance_cannon"],[6,"stardust_veil"],[41,"forge_strike"]],
    evolveTo:null, evolveLevel:null, catchRate:35, expYield:230, rarity:"rare",
  ...
  317: { id:317, name:"Temporith", emoji:"⏳", types:["Mental","Draconic"],
    ...
    learnset:[[1,"mind_jolt"],[1,"draconic_breath"],[7,"psi_burst"],[10,"ancient_meditation"],[14,"inner_calm"],[16,"arcane_roar"],[18,"prophecy"],[21,"draconic_claw"],[24,"draco_pulse"],[25,"gravitational_pull"],[28,"mental"],[35,"draconic_pulse"],[42,"prism_ward"],[45,"temporal_collapse"],[49,"astral_rend"],[56,"ancient_breath"],[63,"temporal_rift"],[70,"neural_storm"],[77,"radiance_cannon"]],
  ...
  91: { id:91, name:"Vortexathos", emoji:"🦅", types:["Electric","Wind"],
    ...
    learnset:[[1,"jolt"],[1,"downdraft"],[2,"volt_jet"],[3,"wind_scythe"],[4,"static_cage"],[30,"arc_flash"],[35,"tempest_wrath"],[40,"stormbolt"],[45,"volt_surge"],[50,"typhoon"],[55,"plasma_strike"],[60,"ball_lightning"],[6,"charge_burst"],[42,"wingbeat"]],
  ...
  186: { id:186, name:"Continemic", emoji:"🕊️", types:["Normal","Wind"],
    ...
    learnset:[[1,"collide"],[1,"downdraft"],[2,"blitz"],[3,"wind_scythe"],[4,"crushing_bulk"],[29,"wingbeat"],[34,"wild_tumble"],[38,"momentum_rush"],[43,"typhoon"],[48,"battle_cry"],[53,"radiance_cannon"],[58,"gale_cannon"],[5,"zephyr_dance"],[41,"baleful_stare"]],
  ...
  188: { id:188, name:"Plentorus", emoji:"🐗", types:["Normal"],
    ...
    learnset:[[1,"collide"],[1,"daunt"],[2,"cranial_ram"],[3,"crushing_bulk"],[4,"fortify"],[5,"battle_cry"],[20,"body_blow"],[28,"relentless_fury"],[31,"war_dance"],[35,"wild_tumble"],[39,"second_wind"],[40,"baleful_stare"],[43,"momentum_rush"],[45,"last_stand"],[48,"crushing_bulk"],[53,"instinct_slash"],[58,"radiance_cannon"]],
  ...
  131: { id:131, name:"Necrothon", emoji:"🌑", types:["Dark","Nature"],
    ...
    learnset:[[1,"chomp"],[1,"vine_lash"],[2,"void_pulse"],[3,"pod_blast"],[4,"eclipse_shroud"],[41,"nether_sphere"],[45,"petal_blitz"],[49,"dusk_slash"],[53,"verdant_surge"],[57,"tenebrous_snare"],[61,"soul_rend"],[65,"dread_howl"],[5,"mycelia_net"],[46,"war_dance"]],
  ...
  38: { id:38, name:"Titanariel", emoji:"🗿", types:["Aquatic","Metal"],
    ...
    learnset:[[1,"graze"],[1,"aquatic_gun"],[2,"tidal_sweep"],[3,"forge_blast_2"],[4,"fortify"],[45,"tsunami"],[49,"alloy_tail"],[53,"tidal_crush"],[57,"magnetize"],[61,"sea_serpent_strike"],[65,"forge_strike"],[69,"anvil_drop"],[5,"tidecaller"],[50,"war_dance"]],
  ...
  24: { id:24, name:"Ignitheon", emoji:"🔮", types:["Fire","Mental"],
    ...
    learnset:[[1,"inferno_jet"],[1,"mental"],[2,"scorch_veil"],[3,"psi_strike"],[4,"searing_gale"],[5,"embercloak"],[20,"latent_force"],[28,"telekinetic_throw"],[38,"pyroclasm"],[42,"inner_calm"],[44,"astral_rend"],[46,"solar_flare"],[50,"thought_crush"],[54,"conflagration"],[58,"synaptic_shatter"],[62,"neural_storm"]],
    evolveTo:null, evolveLevel:null, catchRate:30, expYield:270, rarity:"rare",
  ...
  44: { id:44, name:"Nagislither", emoji:"🧊", types:["Ice","Aquatic"],
    ...
    learnset:[[1,"flurries"],[1,"tidal_rush"],[2,"cold_beam"],[3,"permafrost"],[4,"winter_shroud"],[38,"whiteout"],[42,"hoarfrost_bite"],[46,"frost_crash"],[50,"tsunami"],[54,"tundra_tomb"],[58,"cryo_lance"],[62,"abyssal_jet"],[5,"tidecaller"],[44,"frost_current"]],
    evolveTo:null, evolveLevel:null, catchRate:30, expYield:265, rarity:"rare",
  ...
  80: { id:80, name:"Morralyn", emoji:"🪵", types:["Nature","Dark"],
    ...
    learnset:[[1,"sharp_leaves"],[1,"dusk_slash"],[2,"verdant_orb"],[3,"void_pulse"],[4,"slumber_dust"],[5,"spore_burst"],[8,"bark_shield"],[14,"root_drain"],[20,"regrow"],[26,"nature_pulse"],[30,"fae_petals"],[34,"primordial_growth"],[38,"petal_blitz"],[40,"sinister_scheme"],[42,"nether_sphere"],[44,"tenebrous_snare"],[46,"void_rend"],[50,"verdant_surge"],[54,"soul_rend"],[58,"canopy_crash"],[60,"sylvan_radiance"],[62,"eclipse_shroud"]],
    evolveTo:null, evolveLevel:null, catchRate:30, expYield:265, rarity:"rare",
  ...
  74: { id:74, name:"Faevernal", emoji:"🌸", types:["Fairy","Nature"],
    ...
    learnset:[[1,"fairy_wind"],[1,"vine_lash"],[2,"prism_flare"],[3,"lunar_burst"],[4,"bewitching_kiss"],[38,"celestial_wave"],[42,"petal_blitz"],[46,"glitter_storm"],[50,"verdant_surge"],[54,"fae_requiem"],[58,"verdant_orb"],[62,"moonveil"],[5,"stardust_veil"],[44,"slumber_dust"]],
    evolveTo:null, evolveLevel:null, catchRate:30, expYield:265, rarity:"rare",
  ...
  77: { id:77, name:"Thorncharge", emoji:"⚡", types:["Nature","Electric"],
    ...
    learnset:[[1,"sharp_leaves"],[1,"volt_jet"],[2,"verdant_orb"],[3,"volt_surge"],[4,"slumber_dust"],[5,"spore_burst"],[8,"thorn_barrage"],[20,"leafblade_swirl"],[36,"foliage_tempest"],[38,"stormbolt"],[42,"petal_blitz"],[44,"charge_burst"],[46,"verdant_surge"],[50,"plasma_strike"],[54,"canopy_crash"],[58,"ion_cannon"],[62,"arc_flash"]],
    evolveTo:null, evolveLevel:null, catchRate:30, expYield:265, rarity:"rare",
  ...
  83: { id:83, name:"Voltanox", emoji:"🐎", types:["Electric"],
    ...
    learnset:[[1,"jolt"],[1,"volt_jet"],[2,"static_strike"],[3,"stun_pulse"],[4,"blitz"],[5,"static_cage"],[10,"bolt_smash"],[15,"coil_strike"],[20,"rising_voltage"],[25,"overcharge_coil"],[30,"tesla_fists"],[36,"storm_sovereignty"],[38,"stormbolt"],[42,"arc_flash"],[44,"voltaic_rush"],[46,"plasma_strike"],[48,"arc_cannon"],[50,"volt_surge"],[54,"ion_cannon"],[58,"charge_burst"],[62,"voltaic_fang"]],
  ...
  103: { id:103, name:"Calciderm", emoji:"🐊", types:["Earth","Aquatic"],
    ...
    learnset:[[1,"tectonic_shift"],[1,"tidal_rush"],[2,"geoblast"],[3,"tidal_crush"],[4,"mud_spray"],[38,"tsunami"],[42,"sand_geyser"],[46,"tidal_sweep"],[50,"scorched_earth"],[54,"sea_serpent_strike"],[58,"boulder_roll"],[62,"abyssal_jet"],[5,"clay_armor"],[44,"frost_current"]],
  ...
  110: { id:110, name:"Aeolarch", emoji:"🦁", types:["Wind","Electric"],
    ...
    learnset:[[1,"breeze"],[1,"volt_jet"],[2,"wind_scythe"],[3,"zephyr_dance"],[4,"arc_flash"],[38,"typhoon"],[42,"stormbolt"],[46,"gale_cannon"],[50,"plasma_strike"],[54,"volt_surge"],[58,"tempest_wrath"],[62,"ion_cannon"],[5,"vortex_trap"],[44,"squall_slash"]],
    evolveTo:null, evolveLevel:null, catchRate:30, expYield:265, rarity:"rare",
  ...
  120: { id:120, name:"Nightwolf", emoji:"🐕", types:["Dark"],
    ...
    learnset:[[1,"chomp"],[1,"jaw_crush"],[2,"dusk_slash"],[3,"void_pulse"],[4,"eclipse_shroud"],[38,"nether_sphere"],[42,"void_rend"],[46,"soul_rend"],[50,"tenebrous_snare"],[54,"dread_howl"],[58,"crushing_bulk"],[62,"blitz"],[5,"shadowstep"],[44,"second_wind"]],
    evolveTo:null, evolveLevel:null, catchRate:30, expYield:265, rarity:"rare",
  ...
  125: { id:125, name:"Venotitan", emoji:"🐍", types:["Dark","Poison"],
    ...
    learnset:[[1,"chomp"],[1,"venom_lance"],[2,"void_pulse"],[3,"sludge_wave"],[4,"eclipse_shroud"],[38,"void_rend"],[42,"acid_rain"],[46,"nether_sphere"],[50,"soul_rend"],[54,"toxic_surge"],[58,"corrosion_fang"],[62,"dread_howl"],[5,"shadowstep"],[44,"tenebrous_snare"]],
    evolveTo:null, evolveLevel:null, catchRate:25, expYield:270, rarity:"rare",
  ...
  149: { id:149, name:"Eternarmor", emoji:"🐩", types:["Metal"],
    ...
    learnset:[[1,"chrome_claw"],[1,"forge_blast_2"],[2,"alloy_tail"],[3,"magnetize"],[4,"forge_strike"],[38,"anvil_drop"],[42,"iron_press"],[46,"slag_shield"],[50,"temper_edge"],[54,"metal_wing"],[58,"crushing_bulk"],[62,"radiance_cannon"],[5,"ironskin"],[44,"second_wind"]],
    evolveTo:null, evolveLevel:null, catchRate:25, expYield:275, rarity:"rare",
  ...
  136: { id:136, name:"Metalibat", emoji:"🦇", types:["Metal","Dark"],
    ...
    learnset:[[1,"chrome_claw"],[1,"void_pulse"],[2,"forge_blast_2"],[3,"jaw_crush"],[4,"magnetize"],[38,"forge_strike"],[42,"void_rend"],[46,"alloy_tail"],[50,"nether_sphere"],[54,"anvil_drop"],[58,"dusk_slash"],[62,"soul_rend"],[5,"ironskin"],[44,"eclipse_shroud"]],
    evolveTo:null, evolveLevel:null, catchRate:30, expYield:265, rarity:"rare",
  ...
  159: { id:159, name:"Dissotoad", emoji:"🐸", types:["Poison","Earth"],
    ...
    learnset:[[1,"toxify"],[1,"tectonic_shift"],[2,"sludge_wave"],[3,"geoblast"],[4,"toxic_surge"],[38,"acid_rain"],[42,"venom_lance"],[46,"sand_geyser"],[50,"ooze_bomb"],[54,"virulent_surge"],[58,"scorched_earth"],[62,"putrid_pulse"],[5,"miasma_cloud"],[44,"corrosion_fang"]],
    evolveTo:null, evolveLevel:null, catchRate:25, expYield:270, rarity:"rare",
  ...
  323: { id:323, name:"Toxicore", emoji:"🧪", types:["Poison","Fire"],
    ...
    learnset:[[1,"flicker"],[8,"septic_prick"],[18,"inferno_jet"],[28,"ooze_bomb"],[38,"searing_gale"],[48,"acid_rain"],[58,"conflagration"],[5,"toxify"],[42,"venom_lance"]],
  ...
  324: { id:324, name:"Chittering", emoji:"🦂", types:["Nature","Dark"],
    ...
    learnset:[[1,"mandible_bite"],[12,"shadowstep"],[22,"resonance_hum"],[32,"umbral_claw"],[42,"phantom_claw"],[52,"nether_sphere"],[62,"resonance_hum"],[5,"shade_dash"],[38,"void_rend"]],
  ...
  325: { id:325, name:"Dunespike", emoji:"🏜️", types:["Earth","Poison"],
    ...
    learnset:[[1,"geoblast"],[10,"septic_prick"],[22,"terra_spike"],[32,"ooze_bomb"],[42,"fissure_slam"],[52,"acid_rain"],[62,"geoblast"],[5,"toxify"],[35,"venom_lance"]],
  ...
  328: { id:328, name:"Smogveil", emoji:"🌫️", types:["Poison","Wind"],
    ...
    learnset:[[1,"breeze"],[10,"miasma_cloud"],[20,"wind_scythe"],[30,"ooze_bomb"],[40,"sludge_wave"],[50,"acid_rain"],[60,"tailwind_strike"],[5,"toxify"],[38,"neural_storm"]],
  ...
  332: { id:332, name:"Glacicore", emoji:"🧊", types:["Ice","Metal"],
    ...
    learnset:[[1,"glacial_punch"],[10,"chrome_claw"],[20,"cold_beam"],[30,"alloy_tail"],[40,"cryo_lance"],[50,"forge_blast_2"],[60,"whiteout"],[5,"fortify"],[38,"winter_shroud"]],
  ...
  335: { id:335, name:"Frostprowl", emoji:"🐆", types:["Ice","Wind"],
    ...
    learnset:[[1,"flurries"],[8,"breeze"],[18,"wind_scythe"],[28,"cold_beam"],[38,"cryo_lance"],[48,"whiteout"],[58,"tailwind_strike"],[5,"winter_shroud"],[38,"zephyr_dance"]],
  ...
  336: { id:336, name:"Coilstrike", emoji:"🐍", types:["Electric","Poison"],
    ...
    learnset:[[1,"jolt"],[10,"septic_prick"],[20,"volt_jet"],[30,"ooze_bomb"],[40,"stormbolt"],[50,"acid_rain"],[60,"volt_surge"],[5,"stun_pulse"],[38,"toxic_surge"]],
    catchRate:28, expYield:252, rarity:"rare",
  ...
  337: { id:337, name:"Ashgolem", emoji:"🔥", types:["Fire","Mineral"],
    ...
    learnset:[[1,"flicker"],[5,"fortify"],[10,"stone_throw"],[15,"molten_armor"],[20,"inferno_jet"],[30,"stone_slide"],[40,"searing_gale"],[40,"magma_surge"],[50,"fossil_rush"],[60,"pyroclasm"]],
  ...
  338: { id:338, name:"Rimeclaw", emoji:"🦅", types:["Ice"],
    ...
    learnset:[[1,"flurries"],[8,"breeze"],[18,"glacial_punch"],[28,"wind_scythe"],[38,"cryo_lance"],[48,"whiteout"],[58,"tailwind_strike"],[5,"zephyr_dance"],[35,"cold_beam"]],
    catchRate:25, expYield:258, rarity:"rare",
  ...
  339: { id:339, name:"Voltbeetle", emoji:"⚡", types:["Electric","Sonic"],
    ...
    learnset:[[1,"mandible_bite"],[10,"jolt"],[20,"chrome_claw"],[30,"volt_jet"],[40,"resonance_hum"],[50,"volt_surge"],[60,"stormbolt"],[5,"fortify"],[38,"alloy_edge"]],
  ...
  341: { id:341, name:"Mirestone", emoji:"🪨", types:["Earth","Mental"],
    ...
    learnset:[[1,"stone_throw"],[10,"mental"],[20,"stone_slide"],[30,"psi_strike"],[40,"fossil_rush"],[50,"synaptic_shatter"],[60,"neural_storm"],[5,"prism_ward"],[38,"fortify"]],
  ...
  342: { id:342, name:"Wraithking", emoji:"👑", types:["Dark","Spectral"],
    ...
    learnset:[[1,"nether_sphere"],[5,"toxify"],[10,"void_rend"],[15,"null_void"],[20,"umbral_claw"],[25,"ectoplasm_strike"],[30,"phantom_claw"],[35,"spectral_lock"],[38,"synaptic_shatter"],[40,"shade_dash"],[50,"shadowstep"],[60,"neural_storm"]],
  ...
  344: { id:344, name:"Glimmeritch", emoji:"🧚", types:["Fairy","Spectral"],
    ...
    learnset:[[1,"fairy_wind"],[5,"dreamweave"],[10,"nether_sphere"],[12,"nymph_mist"],[15,"fade"],[20,"fae_requiem"],[22,"dream_drain"],[25,"eidolon_dance"],[28,"misty_explosion"],[30,"psi_strike"],[35,"veil_shroud"],[38,"prism_ward"],[40,"phantom_claw"],[45,"disarming_voice"],[50,"void_rend"],[60,"fae_requiem"]],
  ...
  345: { id:345, name:"Voidcoil", emoji:"🌀", types:["Dark","Draconic"],
    ...
    learnset:[[1,"draconic_breath"],[10,"void_rend"],[20,"draconic_claw"],[30,"nether_sphere"],[40,"wyrm_strike"],[50,"phantom_claw"],[60,"cataclysm_breath"],[5,"hydra_dance"],[38,"primordial_roar"]],
  ...
  346: { id:346, name:"Astralwing", emoji:"🌟", types:["Mental","Wind"],
    ...
    learnset:[[1,"breeze"],[10,"mental"],[20,"wind_scythe"],[30,"psi_strike"],[40,"tailwind_strike"],[50,"synaptic_shatter"],[60,"neural_storm"],[5,"zephyr_dance"],[38,"dreamweave"]],
  ...
  351: { id:351, name:"Spectravore", emoji:"🌈", types:["Mental","Mineral"],
    ...
    learnset:[[1,"fairy_wind"],[10,"mental"],[20,"fae_requiem"],[25,"ore_ray"],[30,"psi_strike"],[40,"synaptic_shatter"],[45,"quartz_blast"],[50,"neural_storm"],[60,"fae_requiem"],[5,"dreamweave"],[38,"prism_ward"]],
  ...
  352: { id:352, name:"Voidlord", emoji:"🕳️", types:["Mental","Spectral"],
    ...
    learnset:[[1,"void_rend"],[5,"dreamweave"],[10,"synaptic_shatter"],[15,"ectoplasm_wave"],[20,"phantom_claw"],[25,"spectral_lock"],[30,"neural_storm"],[40,"shadowstep"],[45,"prism_ward"],[50,"psi_strike"],[60,"cataclysm_breath"]],
  ...
  354: { id:354, name:"Riftwhale", emoji:"🐋", types:["Aquatic","Mental"],
    ...
    learnset:[[1,"tidal_rush"],[10,"mental"],[20,"tsunami"],[30,"psi_strike"],[40,"sea_serpent_strike"],[50,"synaptic_shatter"],[60,"neural_storm"],[5,"tidecaller"],[38,"dreamweave"]],
  ...
  355: { id:355, name:"Abyssalith", emoji:"🌊", types:["Aquatic","Toxin"],
    ...
    learnset:[[1,"tidal_rush"],[5,"shadowstep"],[10,"void_rend"],[15,"corrosive_rain"],[20,"tidal_crush"],[22,"bilious_drown"],[25,"gunk_blast"],[30,"nether_sphere"],[32,"acidic_glance"],[35,"venom_drown"],[38,"phantom_claw"],[40,"tsunami"],[45,"virulent_storm"],[50,"sea_serpent_strike"],[60,"sludge_wave"]],
    catchRate:10, expYield:318, rarity:"rare",
  ...
  356: { id:356, name:"Stormlord", emoji:"⛈️", types:["Electric","Draconic"],
    ...
    learnset:[[1,"jolt"],[10,"draconic_breath"],[20,"volt_jet"],[30,"draconic_pulse"],[40,"stormbolt"],[50,"wyrm_strike"],[60,"volt_surge"],[5,"hydra_dance"],[38,"ancient_breath"]],
  ...
  357: { id:357, name:"Thornspire", emoji:"🌳", types:["Nature","Metal"],
    ...
    learnset:[[1,"vine_lash"],[10,"chrome_claw"],[20,"root_lance"],[30,"alloy_tail"],[40,"canopy_crash"],[50,"forge_blast_2"],[60,"verdant_surge"],[5,"thornwall"],[38,"alloy_edge"]],
  ...
  360: { id:360, name:"Duskmantle", emoji:"🌙", types:["Dark","Mental"],
    ...
    learnset:[[1,"fairy_wind"],[10,"void_rend"],[20,"fae_requiem"],[30,"nether_sphere"],[40,"phantom_claw"],[50,"synaptic_shatter"],[60,"neural_storm"],[5,"shadowstep"],[38,"dreamweave"]],
    catchRate:10, expYield:318, rarity:"rare",
  ...
  361: { id:361, name:"Tectolith", emoji:"🌍", types:["Earth","Draconic"],
    ...
    learnset:[[1,"geoblast"],[10,"draconic_claw"],[20,"fissure_slam"],[30,"draconic_pulse"],[40,"terra_spike"],[50,"wyrm_strike"],[60,"eon_crash"],[5,"hydra_dance"],[38,"primordial_roar"]],
    catchRate:10, expYield:320, rarity:"rare",
  ...
  363: { id:363, name:"Chromavast", emoji:"🎨", types:["Normal","Mental"],
    ...
    learnset:[[1,"cranial_ram"],[10,"mental"],[20,"crushing_bulk"],[30,"psi_strike"],[40,"radiance_cannon"],[50,"synaptic_shatter"],[60,"neural_storm"],[5,"battle_cry"],[38,"dreamweave"]],
  ...
  364: { id:364, name:"Deepcrawler", emoji:"🦀", types:["Aquatic","Metal"],
    ...
    learnset:[[1,"aquatic_gun"],[10,"chrome_claw"],[20,"tidal_crush"],[30,"alloy_tail"],[40,"tsunami"],[50,"forge_blast_2"],[60,"sea_serpent_strike"],[5,"fortify"],[38,"alloy_edge"]],
  ...
  365: { id:365, name:"Cinderking", emoji:"🔥", types:["Fire","Dark"],
    ...
    learnset:[[1,"flicker"],[10,"void_rend"],[20,"inferno_jet"],[30,"nether_sphere"],[40,"solar_flare"],[50,"phantom_claw"],[60,"conflagration"],[5,"char_dance"],[38,"umbral_claw"]],
  ...
  366: { id:366, name:"Starlance", emoji:"⭐", types:["Mental","Metal"],
    ...
    learnset:[[1,"chrome_claw"],[10,"mental"],[20,"alloy_tail"],[30,"psi_strike"],[40,"forge_blast_2"],[50,"synaptic_shatter"],[60,"neural_storm"],[5,"alloy_edge"],[38,"prism_ward"]],
  ...
  369: { id:369, name:"Gravithorn", emoji:"🔮", types:["Mental","Earth"],
    ...
    learnset:[[1,"geoblast"],[10,"mental"],[20,"terra_spike"],[30,"psi_strike"],[40,"fissure_slam"],[50,"synaptic_shatter"],[60,"neural_storm"],[5,"prism_ward"],[38,"dreamweave"]],
    catchRate:9, expYield:320, rarity:"rare",
  ...
  371: { id:371, name:"Nullform", emoji:"⬛", types:["Dark","Normal"],
    ...
    learnset:[[1,"void_rend"],[10,"cranial_ram"],[20,"nether_sphere"],[30,"crushing_bulk"],[40,"phantom_claw"],[50,"radiance_cannon"],[60,"neural_storm"],[5,"shadowstep"],[38,"battle_cry"]],
  ...
  372: { id:372, name:"Prismancer", emoji:"🌈", types:["Draconic","Mineral"],
    ...
    learnset:[[1,"mental"],[10,"draconic_pulse"],[20,"psi_strike"],[30,"draconic_claw"],[40,"synaptic_shatter"],[50,"wyrm_strike"],[60,"neural_storm"],[5,"hydra_dance"],[48,"cataclysm_breath"]],
  ...
  373: { id:373, name:"Voidrend", emoji:"🌌", types:["Dark","Spectral"],
    ...
    learnset:[[1,"void_rend"],[5,"shade_dash"],[8,"null_void"],[10,"phantom_claw"],[15,"revenant_charge"],[20,"nether_sphere"],[25,"ectoplasm_strike"],[30,"shadowstep"],[35,"shadowstorm"],[40,"umbral_claw"],[45,"spirit_calamity"],[48,"cataclysm_breath"],[50,"synaptic_shatter"],[60,"neural_storm"]],
  ...
  374: { id:374, name:"Auroradrake", emoji:"🌠", types:["Ice","Draconic"],
    ...
    learnset:[[1,"cold_beam"],[10,"draconic_breath"],[20,"cryo_lance"],[30,"draconic_pulse"],[40,"whiteout"],[50,"scale_storm"],[60,"cataclysm_breath"],[5,"hydra_dance"],[48,"ancient_breath"]],
    catchRate:7, expYield:338, rarity:"rare",
  ...
  375: { id:375, name:"Fluxserpent", emoji:"⚡", types:["Electric","Mental"],
    ...
    learnset:[[1,"jolt"],[10,"mental"],[20,"volt_jet"],[30,"psi_strike"],[40,"stormbolt"],[50,"synaptic_shatter"],[60,"neural_storm"],[5,"stun_pulse"],[48,"volt_surge"]],
  ...
  376: { id:376, name:"Solarwrath", emoji:"☀️", types:["Fire","Fairy"],
    ...
    learnset:[[1,"flicker"],[10,"fairy_wind"],[20,"solar_flare"],[30,"fae_requiem"],[40,"pyroclasm"],[50,"synaptic_shatter"],[60,"neural_storm"],[5,"char_dance"],[48,"solar_flare"]],
    catchRate:7, expYield:338, rarity:"rare",
  ...
  378: { id:378, name:"Dreamweald", emoji:"💭", types:["Mental","Dream"],
    ...
    learnset:[[1,"fairy_wind"],[5,"prism_ward"],[8,"trance_meditation"],[10,"mental"],[15,"lucid_acuity"],[20,"fae_requiem"],[25,"nocturne_charge"],[30,"psi_strike"],[35,"hypnic_breath"],[40,"synaptic_shatter"],[45,"eternal_dream"],[48,"cortex_spike"],[50,"neural_storm"],[55,"cosmic_nightmare"],[58,"slumber_eruption"],[60,"dreamweave"],[65,"hypnos_storm"]],
    catchRate:7, expYield:340, rarity:"rare",
  ...
  381: { id:381, name:"Crystalmind", emoji:"💎", types:["Mental","Metal"],
    ...
    learnset:[[1,"chrome_claw"],[10,"mental"],[20,"alloy_edge"],[30,"psi_strike"],[40,"forge_blast_2"],[50,"synaptic_shatter"],[60,"neural_storm"],[5,"prism_ward"],[48,"cortex_spike"]],
  ...
  382: { id:382, name:"Oblivionwing", emoji:"🖤", types:["Dark","Draconic"],
    ...
    learnset:[[1,"draconic_claw"],[10,"void_rend"],[20,"wyrm_strike"],[30,"nether_sphere"],[40,"scale_storm"],[50,"phantom_claw"],[60,"cataclysm_breath"],[5,"hydra_dance"],[52,"primordial_roar"]],
  ...
  384: { id:384, name:"Solarcrown", emoji:"🌞", types:["Fire","Stellar"],
    ...
    learnset:[[1,"solar_flare"],[5,"char_dance"],[8,"sun_burst"],[10,"mental"],[12,"flash_fire"],[15,"nova_strike"],[20,"pyroclasm"],[25,"nova_burst"],[30,"psi_strike"],[40,"searing_gale"],[45,"comet_flare"],[50,"synaptic_shatter"],[52,"dreamweave"],[55,"supernova_eruption"],[60,"neural_storm"]],
  ...
  385: { id:385, name:"Permafrost", emoji:"🧊", types:["Ice","Earth"],
    ...
    learnset:[[1,"glacial_punch"],[10,"geoblast"],[20,"cryo_lance"],[30,"fissure_slam"],[40,"whiteout"],[50,"terra_spike"],[60,"cold_beam"],[5,"winter_shroud"],[52,"fortify"]],
    catchRate:5, expYield:355, rarity:"rare",
  ...
  387: { id:387, name:"Deepvoid", emoji:"🕳️", types:["Dark","Aquatic"],
    ...
    learnset:[[1,"tidal_rush"],[10,"void_rend"],[20,"tidal_crush"],[30,"nether_sphere"],[40,"tsunami"],[50,"phantom_claw"],[60,"sea_serpent_strike"],[5,"shadowstep"],[52,"abyssal_jet"]],
    catchRate:5, expYield:355, rarity:"rare",
  ...
  388: { id:388, name:"Chronolith", emoji:"⏳", types:["Earth","Mental"],
    ...
    learnset:[[1,"stone_slide"],[10,"mental"],[20,"fossil_rush"],[30,"psi_strike"],[40,"stone_slide"],[50,"synaptic_shatter"],[60,"neural_storm"],[5,"prism_ward"],[52,"cortex_spike"]],
    catchRate:5, expYield:358, rarity:"rare",
  ...
  390: { id:390, name:"Voidgarden", emoji:"🌸", types:["Nature","Poison"],
    ...
    learnset:[[1,"fairy_wind"],[10,"nether_sphere"],[20,"fae_requiem"],[30,"void_rend"],[40,"synaptic_shatter"],[50,"phantom_claw"],[60,"neural_storm"],[5,"dreamweave"],[52,"umbral_claw"]],
  ...
  391: { id:391, name:"Titanfang", emoji:"🦷", types:["Normal","Draconic"],
    ...
    learnset:[[1,"cranial_ram"],[10,"draconic_breath"],[20,"crushing_bulk"],[30,"draconic_claw"],[40,"radiance_cannon"],[50,"wyrm_strike"],[60,"eon_crash"],[5,"hydra_dance"],[52,"primordial_roar"]],
  ...
  392: { id:392, name:"Eondrake", emoji:"🐉", types:["Draconic","Mental"],
    ...
    learnset:[[1,"draconic_pulse"],[10,"psi_strike"],[20,"wyrm_strike"],[30,"synaptic_shatter"],[40,"scale_storm"],[50,"neural_storm"],[60,"cataclysm_breath"],[5,"hydra_dance"],[55,"time_fracture"]],
  ...
  393: { id:393, name:"Nullstorm", emoji:"🌀", types:["Dark","Electric"],
    ...
    learnset:[[1,"void_rend"],[10,"jolt"],[20,"nether_sphere"],[30,"volt_jet"],[40,"phantom_claw"],[50,"volt_surge"],[60,"neural_storm"],[5,"shade_dash"],[55,"stun_pulse"]],
  ...
  394: { id:394, name:"Solarvast", emoji:"🌟", types:["Draconic","Stellar"],
    ...
    learnset:[[1,"inferno_jet"],[5,"char_dance"],[8,"sun_burst"],[10,"draconic_breath"],[12,"arcane_roar"],[15,"searing_glare"],[18,"basilisk_might"],[20,"solar_flare"],[22,"emperor_inferno"],[25,"starlight_charge"],[28,"abyss_ray"],[30,"draconic_pulse"],[35,"cosmic_slam"],[40,"pyroclasm"],[50,"cataclysm_breath"],[55,"primordial_roar"],[55,"astral_resolve"],[60,"ancient_breath"],[65,"galaxy_apocalypse"]],
  ...
  395: { id:395, name:"Glacierend", emoji:"❄️", types:["Ice","Draconic"],
    ...
    learnset:[[1,"cold_beam"],[5,"hydra_dance"],[10,"draconic_claw"],[12,"scale_crash"],[15,"ice_claw"],[18,"drake_tail"],[20,"cryo_lance"],[22,"reptilian_gust"],[25,"cryogenic_breath"],[28,"drake_armor"],[30,"draconic_pulse"],[35,"frostbite_strike"],[40,"whiteout"],[45,"absolute_zero"],[50,"scale_storm"],[55,"ancient_breath"],[60,"cataclysm_breath"]],
    catchRate:4, expYield:370, rarity:"legendary",
  ...
  396: { id:396, name:"Thunderpeak", emoji:"⚡", types:["Electric","Metal"],
    ...
    learnset:[[1,"jolt"],[10,"chrome_claw"],[20,"volt_jet"],[30,"alloy_tail"],[40,"stormbolt"],[50,"forge_blast_2"],[60,"volt_surge"],[5,"fortify"],[55,"alloy_edge"]],
  ...
  398: { id:398, name:"Voidcrown", emoji:"🌌", types:["Dark","Fairy"],
    ...
    learnset:[[1,"fae_requiem"],[10,"void_rend"],[20,"synaptic_shatter"],[30,"nether_sphere"],[40,"neural_storm"],[50,"phantom_claw"],[60,"void_dominion"],[5,"dreamweave"],[55,"void_dominion"]],
  ...
  399: { id:399, name:"Stonekeeper", emoji:"⛰️", types:["Earth","Spectral"],
    ...
    learnset:[[1,"stone_slide"],[10,"nether_sphere"],[20,"fossil_rush"],[30,"phantom_claw"],[40,"stone_slide"],[50,"void_rend"],[60,"neural_storm"],[5,"fortify"],[55,"prism_ward"]],
    catchRate:4, expYield:370, rarity:"rare",
  ...
  400: { id:400, name:"Primordiax", emoji:"🔥", types:["Fire","Primal"],
    ...
    learnset:[[1,"inferno_jet"],[10,"geoblast"],[15,"atavistic_focus"],[20,"magma_surge"],[25,"ancient_pulse"],[30,"fissure_slam"],[35,"ancient_calm"],[40,"solar_flare"],[45,"raw_fury"],[50,"terra_spike"],[60,"mantle_surge"],[5,"char_dance"],[55,"mantle_surge"]],
  ...
  402: { id:402, name:"Scalit", emoji:"🐣", types:["Draconic","Mental"],
    ...
    learnset:[[1,"draconic_breath"],[1,"mental"],[12,"draconic_claw"],[20,"psi_strike"],[28,"hydra_dance"],[32,"wyrm_strike"]],
  ...
  403: { id:403, name:"Dracomind", emoji:"🐲", types:["Draconic","Mental"],
    ...
    learnset:[[1,"draconic_breath"],[1,"mental"],[15,"draconic_claw"],[25,"psi_strike"],[35,"hydra_dance"],[45,"wyrm_strike"],[55,"synaptic_shatter"]],
  ...
  404: { id:404, name:"Veildrak", emoji:"🐉", types:["Draconic","Mental"],
    ...
    learnset:[[1,"draconic_pulse"],[1,"psi_strike"],[5,"hydra_dance"],[15,"ancient_meditation"],[20,"wyrm_strike"],[25,"dragon_calm"],[30,"synaptic_shatter"],[35,"abyss_ray"],[40,"scale_storm"],[50,"neural_storm"],[60,"cataclysm_breath"],[60,"time_fracture"]],
  ...
  408: { id:408, name:"Glimmerling", emoji:"💎", types:["Crystal"],
    ...
    learnset:[[1,"collide"],[1,"fortify"],[5,"crystal_jab"],[9,"shard_strike"],[12,"facet_focus"],[14,"fairy_wind"],[17,"gem_focus"],[19,"crystal_pulse"],[22,"crystalline_speed"],[25,"sapphire_charge"],[31,"prism_ray"]],
  ...
  411: { id:411, name:"Thrumquill", emoji:"🐤", types:["Sonic"],
    ...
    learnset:[[1,"collide"],[1,"chirp"],[5,"echo_strike"],[9,"blitz"],[14,"sound_rush"],[19,"draco_jab"],[25,"rumble_smash"]],
  ...
  412: { id:412, name:"Echostride", emoji:"🦤", types:["Draconic","Sonic"],
    ...
    learnset:[[1,"collide"],[5,"echo_strike"],[10,"drumstroke"],[14,"sound_rush"],[17,"soundproof"],[19,"draconic_breath"],[24,"rumble_smash"],[30,"skyboom_strike"],[36,"draconic_claw"],[42,"resonance_quake"]],
  ...
  413: { id:413, name:"Resonadon", emoji:"🦤", types:["Draconic","Sonic"],
    ...
    learnset:[[1,"sound_rush"],[1,"draconic_breath"],[24,"rumble_smash"],[36,"draconic_claw"],[42,"skyboom_strike"],[48,"bass_blast"],[54,"rampage"],[60,"resonance_quake"],[66,"threnody"]],
  ...
  417: { id:417, name:"Glacigeist", emoji:"👻", types:["Spectral"],
    ...
    learnset:[[1,"ghost_jab"],[1,"flurries"],[6,"ghost_pulse"],[8,"ectoplasm_armor"],[11,"cold_snap"],[16,"specter_pulse"],[18,"fade"],[22,"borealis_ray"],[28,"phantom_beam"]],
  ...
  418: { id:418, name:"Frostmarion", emoji:"❄️", types:["Ice","Spectral"],
    ...
    learnset:[[1,"ghost_jab"],[6,"ghost_pulse"],[10,"ectoplasm_armor"],[16,"specter_pulse"],[22,"borealis_ray"],[28,"phantom_beam"],[34,"cold_beam"],[40,"soul_lance"],[46,"rime_shard"]],
  ...
  419: { id:419, name:"Pallidoll", emoji:"🎎", types:["Ice","Spectral"],
    ...
    learnset:[[1,"specter_pulse"],[1,"borealis_ray"],[15,"eidolon_dance"],[28,"phantom_beam"],[40,"soul_lance"],[46,"cold_beam"],[52,"phantom_force"],[58,"whiteout"],[64,"soul_burst"],[70,"winter_shade"]],
  ...
  422: { id:422, name:"Tempesteam", emoji:"♨️", types:["Fire","Vapor"],
    ...
    learnset:[[1,"steam_burst"],[1,"inferno_jet"],[1,"second_wind"],[16,"boiling_rage"],[20,"condense_form"],[26,"boil"],[28,"burning_mist"],[32,"boiling_strike"],[36,"molten_tide"],[38,"nimbus_eruption"],[40,"steam_slam"],[44,"searing_gale"],[46,"smog_drill"],[50,"geyser_storm"],[56,"lava_spout"],[62,"miasma_apocalypse"]],
  ...
  423: { id:423, name:"Pebblite", emoji:"🪨", types:["Mineral"],
    ...
    learnset:[[1,"collide"],[1,"fortify"],[5,"mineral_jab"],[8,"crystal_shard"],[10,"shard_volley"],[12,"shard_form"],[14,"flint_focus"],[16,"ore_punch"],[18,"embedded_spike"],[20,"calcite_resonance"],[22,"lode_strike"],[24,"gem_scatter"],[25,"shard_burst"],[26,"mineral_blast"],[28,"cobble_smash"],[30,"gemburst"]],
  ...
  424: { id:424, name:"Geodon", emoji:"🦔", types:["Metal","Mineral"],
    ...
    learnset:[[1,"collide"],[5,"mineral_jab"],[8,"slate_armor"],[12,"quarry_speed"],[16,"ore_punch"],[20,"shard_burst"],[22,"chrome_claw"],[28,"cobble_smash"],[34,"bulwark"],[36,"mineral_blast"],[40,"ore_smash"],[46,"heavy_slam"]],
  ...
  426: { id:426, name:"Pummelo", emoji:"🦗", types:["Fighting"],
    ...
    learnset:[[1,"quick_punch"],[1,"battle_cry"],[5,"straight_jab"],[7,"high_kick"],[9,"leg_sweep"],[11,"spinning_kick"],[14,"body_check"],[17,"ki_blast"],[19,"mind_jolt"],[22,"uppercut"],[25,"roundhouse"]],
  ...
  427: { id:427, name:"Brawlith", emoji:"🦗", types:["Fighting","Mental"],
    ...
    learnset:[[1,"quick_punch"],[5,"straight_jab"],[10,"battle_meditation"],[14,"body_check"],[16,"martial_aura"],[19,"mind_jolt"],[22,"fighter_s_resolve"],[25,"roundhouse"],[28,"ki_burst"],[31,"psi_burst"],[37,"iron_fist"],[43,"cortex_ram"]],
  ...
  428: { id:428, name:"Zenkaiser", emoji:"🦗", types:["Fighting","Mental"],
    ...
    learnset:[[1,"roundhouse"],[1,"mind_jolt"],[15,"fighter_s_resolve"],[20,"ki_burst"],[25,"cortex_ram"],[30,"heaven_strike"],[35,"recovery_stance"],[37,"iron_fist"],[40,"galaxy_punch_2"],[43,"psi_blade"],[46,"spirit_bomb"],[49,"brawl"],[55,"mental"],[61,"haymaker"],[67,"expanding_force"]],
  ...
  429: { id:429, name:"Lullasnout", emoji:"🌙", types:["Dream"],
    ...
    learnset:[[1,"collide"],[1,"lullaby_song"],[5,"dream_jab"],[7,"reverie_focus"],[10,"dream_pulse"],[12,"doze_calm"],[15,"somnia_ray"],[17,"slumber_armor"],[20,"chomp"],[22,"lullaby_strike"],[26,"lucid_beam"],[28,"trance_wave"]],
  ...
  430: { id:430, name:"Drowsetapir", emoji:"🌙", types:["Dark","Dream"],
    ...
    learnset:[[1,"collide"],[5,"dream_jab"],[8,"reverie_charge"],[11,"slumber_armor"],[15,"somnia_ray"],[17,"hypnos_speed"],[20,"chomp"],[22,"lullaby_strike"],[26,"lucid_beam"],[28,"nocturne_charge"],[32,"void_pulse"],[38,"dread_burst"],[40,"gloom_haunt"],[44,"nightmare_storm"]],
  ...
  431: { id:431, name:"Nocturnbaku", emoji:"🌙", types:["Dark","Dream"],
    ...
    learnset:[[1,"lucid_beam"],[1,"void_pulse"],[8,"nightmare_strike"],[12,"gloom_haunt"],[16,"terror_slash"],[20,"oneiric_press"],[24,"dreamscape_smash"],[26,"somnia_blast"],[28,"phobia_aura"],[32,"phantasm_lock"],[38,"nightmare_storm"],[40,"fright_resolve"],[44,"nether_sphere"],[48,"dread_finisher"],[50,"dream_devourer"],[56,"phantasm_calamity"],[62,"soul_rend"],[66,"mirage_apocalypse"]],
  ...
  434: { id:434, name:"Primammoth", emoji:"🦣", types:["Nature","Primal"],
    ...
    learnset:[[1,"beast_charge"],[1,"pod_blast"],[20,"wild_rage"],[28,"crushing_jaws"],[30,"feral_armor"],[36,"wild_aura"],[40,"primal_smash"],[45,"apex_predator"],[46,"verdant_orb"],[50,"raw_fury"],[52,"ancient_strike"],[55,"ancient_calm"],[58,"jungle_hammer"],[64,"primeval_eruption"],[70,"world_devour"]],
  ...
  435: { id:435, name:"Knucklite", emoji:"🦍", types:["Mineral"],
    ...
    learnset:[[1,"collide"],[1,"fortify"],[5,"mineral_jab"],[10,"ore_punch"],[15,"quick_punch"],[20,"lode_strike"],[26,"body_check"]],
  ...
  436: { id:436, name:"Cragfist", emoji:"🦍", types:["Fighting","Mineral"],
    ...
    learnset:[[1,"collide"],[5,"mineral_jab"],[10,"battle_meditation"],[15,"quick_punch"],[18,"fighter_s_resolve"],[20,"ore_punch"],[24,"iron_will"],[26,"body_check"],[32,"cobble_smash"],[38,"iron_fist"],[44,"seismic_force"]],
  ...
  437: { id:437, name:"Goliathon", emoji:"🦍", types:["Fighting","Mineral"],
    ...
    learnset:[[1,"ore_punch"],[1,"iron_fist"],[14,"crippling_blow"],[16,"smack_down"],[18,"recovery_stance"],[20,"stone_cleave"],[22,"spear_thrust"],[24,"heaven_strike"],[26,"cobble_smash"],[28,"quake_pulse"],[32,"spirit_bomb"],[34,"telluric_wave"],[38,"seismic_force"],[40,"underground_crush"],[44,"obsidian_strike"],[46,"granite_press"],[48,"diamond_crash"],[50,"brawl"],[56,"quarry_crush"],[60,"continental_shift"],[62,"quake_barrage"],[68,"basalt_eruption"]],
  ...
  439: { id:439, name:"Seraphene", emoji:"🎐", types:["Fairy","Sonic"],
    ...
    learnset:[[1,"echo_pulse"],[1,"fairy_wind"],[15,"resonate"],[20,"pulse_wave"],[26,"prism_flare"],[32,"harmonic_burst"],[38,"lunar_burst"],[44,"siren_song"],[50,"prism_resonance"]],
  ...
  442: { id:442, name:"Bloatleech", emoji:"🩸", types:["Vapor"],
    ...
    learnset:[[1,"vapor_jab"],[1,"mist_pulse"],[5,"septic_prick"],[8,"fume_blow"],[10,"fog_beam"],[12,"vapor_ray"],[15,"acid_spray"],[18,"cumulus_meditation"],[20,"brume_resonance"],[26,"virulent_surge"]],
  ...
  443: { id:443, name:"Miasmire", emoji:"🩸", types:["Poison","Vapor"],
    ...
    learnset:[[1,"vapor_jab"],[5,"septic_prick"],[8,"corrosive_bite"],[10,"toxic_thread"],[15,"acid_spray"],[18,"mist_veil"],[20,"brume_resonance"],[22,"noxious_gas"],[24,"condense"],[26,"virulent_surge"],[28,"acid_mist"],[30,"caustic_shock"],[32,"miasma_cloud"],[34,"cloud_smash"],[38,"ooze_bomb"],[40,"nimbus_flood"],[44,"miasma_wave"],[50,"corrosive_fog"],[52,"murk_screen"]],
  ...
  444: { id:444, name:"Squeaklet", emoji:"🐿️", types:["Sonic"],
    ...
    learnset:[[1,"chirp"],[1,"echo_strike"],[5,"blitz"],[8,"discord"],[10,"echo_pulse"],[12,"silent_strike"],[15,"sound_rush"],[18,"echo_chamber"],[20,"shake_smash"],[26,"pulse_wave"]],
  ...
  445: { id:445, name:"Sentrike", emoji:"🐿️", types:["Normal","Sonic"],
    ...
    learnset:[[1,"echo_strike"],[5,"blitz"],[10,"drumstroke"],[12,"echo_chamber"],[15,"sound_rush"],[18,"wail"],[20,"shake_smash"],[26,"pulse_wave"],[32,"crushing_bulk"],[38,"decibel_burst"],[44,"earsplit"],[50,"skyboom_strike"]],
  ...
  446: { id:446, name:"Sporelet", emoji:"🍄", types:["Vapor"],
    ...
    learnset:[[1,"collide"],[1,"mist_pulse"],[5,"vapor_jab"],[8,"cumulus_meditation"],[10,"slumber_dust"],[12,"haze_focus"],[15,"fog_beam"],[18,"acid_mist"],[20,"brume_resonance"],[26,"pod_blast"]],
  ...
  447: { id:447, name:"Fumycet", emoji:"🍄", types:["Nature","Vapor"],
    ...
    learnset:[[1,"collide"],[5,"vapor_jab"],[15,"fog_beam"],[16,"wisp_speed"],[18,"mist_veil"],[20,"pod_blast"],[22,"stream_burst"],[24,"acid_mist"],[26,"brume_resonance"],[28,"evaporate"],[32,"mycelia_net"],[34,"smog_drill"],[38,"verdant_orb"],[44,"corrosive_fog"],[50,"spore_burst"]],
  ...
  448: { id:448, name:"Cobblepup", emoji:"🦡", types:["Mineral"],
    ...
    learnset:[[1,"collide"],[1,"fortify"],[5,"mineral_jab"],[10,"shard_volley"],[12,"calcite_resonance"],[15,"ore_punch"],[18,"shard_form"],[20,"lode_strike"],[26,"cobble_smash"]],
  ...
  449: { id:449, name:"Oredigger", emoji:"🦡", types:["Dark","Mineral"],
    ...
    learnset:[[1,"collide"],[5,"mineral_jab"],[10,"throat_chop"],[15,"ore_punch"],[18,"slate_armor"],[20,"chomp"],[26,"cobble_smash"],[28,"abyssal_wave"],[32,"dusk_slash"],[38,"obsidian_strike"],[40,"run_down"],[44,"jaw_crush"],[50,"shadowstep"]],
  ...
  450: { id:450, name:"Jabshell", emoji:"🦐", types:["Fighting"],
    ...
    learnset:[[1,"quick_punch"],[1,"battle_cry"],[5,"straight_jab"],[8,"warrior_block"],[10,"body_check"],[12,"sonic_palm"],[15,"leg_sweep"],[18,"shockwave_kick"],[20,"power_drive"],[26,"roundhouse"]],
  ...
  451: { id:451, name:"Smashclaw", emoji:"🦐", types:["Fighting","Fire"],
    ...
    learnset:[[1,"quick_punch"],[5,"straight_jab"],[12,"crippling_blow"],[15,"body_check"],[18,"uppercut"],[20,"power_drive"],[24,"spear_thrust"],[26,"flame_charge"],[32,"iron_fist"],[38,"ignition_kick"],[44,"brawl"],[50,"flare_uppercut"]],
  ...
  452: { id:452, name:"Dozit", emoji:"🦥", types:["Dream"],
    ...
    learnset:[[1,"collide"],[1,"lullaby_song"],[5,"dream_jab"],[7,"reverie_focus"],[10,"dream_pulse"],[12,"somnia_punch"],[15,"somnia_ray"],[17,"hypnos_speed"],[20,"lucid_beam"],[22,"slumber_armor"],[26,"lullaby_aura"]],
  ...
  453: { id:453, name:"Lullavoir", emoji:"🦥", types:["Dream","Fairy"],
    ...
    learnset:[[1,"dream_pulse"],[1,"fairy_wind"],[6,"enchant"],[8,"trance_meditation"],[12,"lullaby_strike"],[14,"dream_drain"],[15,"somnia_ray"],[18,"nocturne_charge"],[20,"lucid_beam"],[24,"disarming_voice"],[25,"lucid_acuity"],[26,"vampiric_kiss"],[30,"moonglow"],[32,"prism_flare"],[35,"starlit_dream"],[38,"somnia_blast"],[44,"lunar_burst"],[46,"hypnos_storm"],[50,"lullaby_song"]],
  ...
  455: { id:455, name:"Knellgeist", emoji:"🔔", types:["Metal","Spectral"],
    ...
    learnset:[[1,"ghost_pulse"],[1,"specter_pulse"],[12,"wrought_shockwave"],[15,"void_wail"],[18,"magnetic_mine"],[20,"phantom_beam"],[22,"counterforge"],[26,"forge_blast_2"],[28,"plasma_smelt"],[32,"grating_din"],[38,"soul_burst"],[44,"chromium_ray"],[50,"phantom_force"]],
  ...
  456: { id:456, name:"Mistgill", emoji:"🦎", types:["Vapor"],
    ...
    learnset:[[1,"collide"],[1,"mist_pulse"],[5,"vapor_jab"],[10,"aquatic_gun"],[12,"stream_burst"],[15,"fog_beam"],[18,"wisp_speed"],[20,"brume_resonance"],[22,"haze_strike"],[26,"bubble_jet"]],
  ...
  457: { id:457, name:"Vaporlotl", emoji:"🦎", types:["Aquatic","Vapor"],
    ...
    learnset:[[1,"aquatic_gun"],[1,"mist_pulse"],[8,"aquatic_pulse"],[10,"stream_burst"],[15,"fog_beam"],[18,"wisp_speed"],[20,"bubble_jet"],[22,"murk_screen"],[26,"brume_resonance"],[28,"cumulus_strike"],[32,"tidal_sweep"],[36,"marine_blessing"],[38,"steam_burst"],[40,"mist_press"],[44,"tidal_rush"],[50,"nimbus_eruption"],[52,"smoke_calm"]],
  ...
  459: { id:459, name:"Tengrath", emoji:"👺", types:["Fighting","Wind"],
    ...
    learnset:[[1,"breeze"],[5,"straight_jab"],[10,"swift_form"],[12,"sonic_palm"],[15,"body_check"],[18,"battle_rhythm"],[20,"wind_scythe"],[24,"shockwave_kick"],[26,"roundhouse"],[30,"roar_strike"],[32,"tornado_kick"],[38,"iron_fist"],[44,"brawl"],[50,"typhoon"]],
  ...
  461: { id:461, name:"Resonethe", emoji:"🎵", types:["Mental","Sonic"],
    ...
    learnset:[[1,"echo_pulse"],[1,"mind_jolt"],[15,"pulse_wave"],[20,"psi_burst"],[26,"harmonic_burst"],[32,"resonance_quake"],[38,"mental"],[44,"threnody"],[50,"synaptic_shatter"]],
...
const GYM_LEADERS = {
  ...
  drake: {
    ...
    teams:{
      single:[
        {monsterId:172, level:48, moves:["draconic_breath","draconic_claw","cranial_ram","hydra_dance"]},
        {monsterId:173, level:50, moves:["draconic_claw","draconic_pulse","hydra_dance","rampage"]}
      ],
      double:[
        {monsterId:172, level:47, moves:["draconic_breath","draconic_claw","cranial_ram","hydra_dance"]},
        {monsterId:174, level:48, moves:["draconic_claw","alloy_tail","draconic_breath","forge_blast_2"]},
        {monsterId:175, level:49, moves:["aquatic_gun","draconic_breath","tidal_rush","draconic_claw"]},
        {monsterId:173, level:50, moves:["draconic_claw","draconic_pulse","hydra_dance","rampage"]}
      ],
      triple:[
        {monsterId:172, level:47, moves:["draconic_breath","draconic_claw","cranial_ram","hydra_dance"]},
        {monsterId:174, level:48, moves:["draconic_claw","alloy_tail","draconic_breath","forge_blast_2"]},
        {monsterId:175, level:49, moves:["aquatic_gun","draconic_breath","tidal_rush","draconic_claw"]},
        {monsterId:176, level:49, moves:["jolt","draconic_breath","volt_jet","draconic_claw"]},
        {monsterId:177, level:50, moves:["cold_beam","draconic_breath","whiteout","draconic_claw"]},
        {monsterId:173, level:50, moves:["draconic_claw","draconic_pulse","hydra_dance","rampage"]}
      ]
    }
  },
...
const RIVAL_BATTLES = {
  rival_1: {
    ...
    teams:{
      single:[
        {monsterId:81, level:13, moves:["jolt","blitz","graze","daunt"]},
        {monsterId:187, level:15, moves:["collide","cranial_ram","daunt","crushing_bulk"]}
      ],
      double:[
        {monsterId:81, level:12, moves:["jolt","blitz","graze","daunt"]},
        {monsterId:95, level:13, moves:["mud_spray","cranial_ram","tectonic_shift","crushing_bulk"]},
        {monsterId:187, level:15, moves:["collide","cranial_ram","daunt","crushing_bulk"]}
      ],
      triple:[
        {monsterId:81, level:12, moves:["jolt","blitz","graze","daunt"]},
        {monsterId:95, level:13, moves:["mud_spray","cranial_ram","tectonic_shift","crushing_bulk"]},
        {monsterId:16, level:14, moves:["flicker","blitz","collide","daunt"]},
        {monsterId:187, level:15, moves:["collide","cranial_ram","daunt","crushing_bulk"]}
      ]
    }
  },
  rival_2: {
    ...
    teams:{
      single:[
        {monsterId:82, level:30, moves:["volt_jet","static_strike","crushing_bulk","stun_pulse"]},
        {monsterId:95, level:33, moves:["mud_spray","cranial_ram","tectonic_shift","crushing_bulk"]}
      ],
      double:[
        {monsterId:82, level:30, moves:["volt_jet","static_strike","crushing_bulk","stun_pulse"]},
        {monsterId:109, level:31, moves:["volt_jet","wingbeat","wind_scythe","stormbolt"]},
        {monsterId:95, level:33, moves:["mud_spray","cranial_ram","tectonic_shift","crushing_bulk"]}
      ],
      triple:[
        {monsterId:82, level:30, moves:["volt_jet","static_strike","crushing_bulk","stun_pulse"]},
        {monsterId:109, level:31, moves:["volt_jet","wingbeat","wind_scythe","stormbolt"]},
        {monsterId:121, level:32, moves:["chomp","breeze","void_pulse","wingbeat"]},
        {monsterId:95, level:33, moves:["mud_spray","cranial_ram","tectonic_shift","crushing_bulk"]}
      ]
    }
  },
  rival_3: {
    ...
    teams:{
      single:[
        {monsterId:82,  level:50, moves:["stormbolt","volt_jet","hydra_dance","crushing_bulk"]},
        {monsterId:171, level:51, moves:["mental","draconic_pulse","mind_jolt","psi_strike"]},
        {monsterId:281, level:54, moves:["alloy_tail","tectonic_shift","forge_blast_2","stormbolt"]}
      ],
      double:[
        {monsterId:82,  level:50, moves:["stormbolt","volt_jet","hydra_dance","crushing_bulk"]},
        {monsterId:171, level:51, moves:["mental","draconic_pulse","mind_jolt","psi_strike"]},
        {monsterId:234, level:52, moves:["draconic_breath","tectonic_shift","draconic_pulse","geoblast"]},
        {monsterId:281, level:54, moves:["alloy_tail","tectonic_shift","forge_blast_2","stormbolt"]}
      ],
      triple:[
        {monsterId:82,  level:50, moves:["stormbolt","volt_jet","hydra_dance","crushing_bulk"]},
        {monsterId:171, level:51, moves:["mental","draconic_pulse","mind_jolt","psi_strike"]},
        {monsterId:234, level:52, moves:["draconic_breath","tectonic_shift","draconic_pulse","geoblast"]},
        {monsterId:109, level:52, moves:["typhoon","volt_jet","wind_scythe","stormbolt"]},
        {monsterId:281, level:54, moves:["alloy_tail","tectonic_shift","forge_blast_2","stormbolt"]}
      ]
    }
  },
  rival_4: {
    ...
    teams:{
      single:[
        {monsterId:82,  level:62, moves:["stormbolt","hydra_dance","crushing_bulk","volt_jet"]},
        {monsterId:171, level:63, moves:["mental","draconic_pulse","psi_strike","inner_calm"]},
        {monsterId:282, level:65, moves:["forge_blast_2","alloy_tail","tectonic_shift","volt_jet"]}
      ],
      double:[
        {monsterId:82,  level:62, moves:["stormbolt","hydra_dance","crushing_bulk","volt_jet"]},
        {monsterId:171, level:63, moves:["mental","draconic_pulse","psi_strike","inner_calm"]},
        {monsterId:250, level:64, moves:["tectonic_shift","crag_strike","stone_slide","landslide"]},
        {monsterId:282, level:65, moves:["forge_blast_2","alloy_tail","tectonic_shift","volt_jet"]},
        {monsterId:65,  level:66, moves:["petal_blitz","verdant_orb","verdant_surge","canopy_crash"]}
      ],
      triple:[
        {monsterId:82,  level:62, moves:["stormbolt","hydra_dance","crushing_bulk","volt_jet"]},
        {monsterId:171, level:63, moves:["mental","draconic_pulse","psi_strike","inner_calm"]},
        ...
        {monsterId:282, level:65, moves:["forge_blast_2","alloy_tail","tectonic_shift","volt_jet"]},
        {monsterId:65,  level:66, moves:["petal_blitz","verdant_orb","verdant_surge","canopy_crash"]},
        {monsterId:234, level:66, moves:["draconic_breath","tectonic_shift","draconic_pulse","geoblast"]}
      ]
    }
  },
  rival_5: {
    ...
    teams:{
      single:[
        {monsterId:171, level:71, moves:["psi_strike","draconic_pulse","temporal_rift","inner_calm"]},
        {monsterId:282, level:73, moves:["forge_blast_2","stormbolt","tungsten_ram","anvil_drop"]},
        {monsterId:321, level:75, moves:["rampage","pyroclasm","draconic_pulse","hydra_dance"]}
      ],
      double:[
        {monsterId:82,  level:70, moves:["stormbolt","hydra_dance","arc_flash","overcharge"]},
        {monsterId:171, level:71, moves:["psi_strike","draconic_pulse","temporal_rift","inner_calm"]},
        {monsterId:250, level:72, moves:["tectonic_shift","crag_strike","tectonic_slam","geoblast"]},
        {monsterId:282, level:73, moves:["forge_blast_2","stormbolt","tungsten_ram","anvil_drop"]},
        {monsterId:264, level:74, moves:["petal_blitz","verdant_surge","verdant_orb","toxify"]}
      ],
      triple:[
        {monsterId:82,  level:70, moves:["stormbolt","hydra_dance","arc_flash","overcharge"]},
        {monsterId:171, level:71, moves:["psi_strike","draconic_pulse","temporal_rift","inner_calm"]},
...
const UMBRA_BATTLES = {
  umbra_grunt_1: {
    ...
    teams:{
      single:[
        {monsterId:118, level:14, moves:["chomp","blitz","dusk_slash","graze"]},
        {monsterId:121, level:16, moves:["chomp","breeze","void_pulse","wingbeat"]}
      ],
      double:[
        {monsterId:118, level:14, moves:["chomp","blitz","dusk_slash","graze"]},
        {monsterId:119, level:15, moves:["jaw_crush","dusk_slash","void_pulse","crushing_bulk"]},
        {monsterId:121, level:16, moves:["chomp","breeze","void_pulse","wingbeat"]}
      ],
      triple:[
        {monsterId:118, level:14, moves:["chomp","blitz","dusk_slash","graze"]},
  ...
  umbra_shade: {
    ...
    teams:{
      single:[
        {monsterId:269, level:59, moves:["jaw_crush","void_pulse","dusk_slash","nether_sphere"]},
  ...
  umbra_phantom_grunt: {
    ...
    teams:{
      ...
      double:[
        {monsterId:119, level:65, moves:["jaw_crush","void_pulse","dusk_slash","nether_sphere"]},
        {monsterId:267, level:66, moves:["jaw_crush","void_pulse","dusk_slash","shade_dash"]},
        {monsterId:269, level:67, moves:["jaw_crush","void_pulse","dusk_slash","nether_sphere"]},
        {monsterId:125, level:68, moves:["void_pulse","ooze_bomb","virulent_surge","dusk_slash"]}
      ],
      triple:[
        {monsterId:119, level:65, moves:["jaw_crush","void_pulse","dusk_slash","nether_sphere"]},
  ...
  umbra_remnant_lab: {
    ...
    teams:{
      ...
      double:[
        {monsterId:52,  level:68, moves:["inferno_jet","pyroclasm","solar_flare","ooze_bomb"]},
        {monsterId:55,  level:69, moves:["pyroclasm","inferno_jet","searing_gale","ooze_bomb"]},
        {monsterId:159, level:70, moves:["ooze_bomb","virulent_surge","sludge_cannon","toxify"]},
        {monsterId:315, level:72, moves:["magma_stone","pyroclasm","crag_strike","caldera_meltdown"]}
      ],
      triple:[
        {monsterId:52,  level:68, moves:["inferno_jet","pyroclasm","solar_flare","ooze_bomb"]},
        {monsterId:55,  level:69, moves:["pyroclasm","inferno_jet","searing_gale","ooze_bomb"]},
        {monsterId:156, level:69, moves:["virulent_surge","ooze_bomb","toxify","corrosion_fang"]},
        {monsterId:159, level:70, moves:["ooze_bomb","virulent_surge","sludge_cannon","toxify"]},
        {monsterId:315, level:72, moves:["magma_stone","pyroclasm","crag_strike","caldera_meltdown"]}
      ]
    }
  ...
  umbra_remnant_archive: {
    ...
    teams:{
      single:[
        ...
        {monsterId:133, level:73, moves:["jaw_crush","crag_strike","nether_sphere","void_pulse"]},
  ...
  umbra_remnant_nexus: {
    ...
    teams:{
      single:[
        {monsterId:269, level:74, moves:["jaw_crush","void_pulse","dusk_slash","nether_sphere"]},
      ...
      double:[
        {monsterId:267, level:73, moves:["jaw_crush","void_pulse","dusk_slash","shade_dash"]},
        {monsterId:269, level:74, moves:["jaw_crush","void_pulse","dusk_slash","nether_sphere"]},
        {monsterId:270, level:75, moves:["void_pulse","lunar_burst","nether_sphere","prism_flare"]},
        {monsterId:319, level:77, moves:["void_pulse","lunar_burst","nether_sphere","soul_rend"]},
        {monsterId:320, level:78, moves:["stormbolt","forge_blast_2","forge_strike","anvil_drop"]}
  ...
  umbra_commander_phantom: {
    ...
    teams:{
      single:[
        {monsterId:270, level:69, moves:["void_pulse","lunar_burst","nether_sphere","prism_flare"]},
        {monsterId:136, level:72, moves:["forge_blast_2","void_pulse","forge_strike","void_rend"]},
        {monsterId:319, level:74, moves:["void_pulse","lunar_burst","nether_sphere","soul_rend"]}
      ],
      double:[
        {monsterId:269, level:68, moves:["jaw_crush","void_pulse","nether_sphere","dusk_slash"]},
        {monsterId:270, level:69, moves:["void_pulse","lunar_burst","nether_sphere","prism_flare"]},
        {monsterId:133, level:70, moves:["jaw_crush","crag_strike","nether_sphere","void_pulse"]},
        {monsterId:136, level:72, moves:["forge_blast_2","void_pulse","forge_strike","void_rend"]},
        {monsterId:319, level:74, moves:["void_pulse","lunar_burst","nether_sphere","soul_rend"]}
      ],
      triple:[
        ...
        {monsterId:270, level:69, moves:["void_pulse","lunar_burst","nether_sphere","prism_flare"]},
        {monsterId:133, level:70, moves:["jaw_crush","crag_strike","nether_sphere","void_pulse"]},
        {monsterId:125, level:71, moves:["void_pulse","ooze_bomb","virulent_surge","dusk_slash"]},
        {monsterId:136, level:72, moves:["forge_blast_2","void_pulse","forge_strike","void_rend"]},
        {monsterId:319, level:74, moves:["void_pulse","lunar_burst","nether_sphere","soul_rend"]}
      ]
    }
...
const VAELDRIS_WIELDERS = {
  wielder_lysara: {
    ...
    team:[
      {monsterId:462, level:98, moves:["mental","wind_scythe","lunar_burst","aura_veil_strike"]},
      {monsterId:463, level:99, moves:["lunar_burst","geoblast","prism_flare","luma_quake"]},
  ...
  wielder_morrigan: {
    ...
    team:[
      {monsterId:465, level:98, moves:["nether_sphere","void_pulse","void_rend","nyx_fang"]},
      {monsterId:466, level:99, moves:["pyroclasm","sludge_wave","void_pulse","toxic_blaze"]},
  ...
  wielder_kael: {
    ...
    team:[
      {monsterId:468, level:98, moves:["volt_jet","forge_blast_2","volt_surge","ampere_rail"]},
      {monsterId:469, level:99, moves:["crag_strike","draconic_pulse","obsidian_crash","arc_strike"]},
  ...
  wielder_thessaly: {
    ...
    team:[
      {monsterId:471, level:98, moves:["pod_blast","ooze_bomb","verdant_orb","root_toxin"]},
      {monsterId:472, level:99, moves:["crag_strike","forge_blast_2","obsidian_crash","mineral_lance"]},
  ...
  wielder_nereus: {
    ...
    team:[
      {monsterId:474, level:98, moves:["tidal_rush","mental","tsunami","thought_stream"]},
      {monsterId:475, level:99, moves:["jaw_crush","venom_lance","void_pulse","dark_corrosion"]},
  ...
  wielder_caelia: {
    ...
    team:[
      ...
      {monsterId:478, level:99, moves:["wind_scythe","forge_blast_2","typhoon","ferrous_gale"]},
  ...
  wielder_dravek: {
    ...
    team:[
      {monsterId:480, level:98, moves:["pyroclasm","forge_blast_2","solar_flare","pyro_alloy"]},
      {monsterId:481, level:99, moves:["void_pulse","geoblast","obsidian_fang","smoldering_abyss"]},
  ...
  wielder_nylara: {
    ...
    team:[
      {monsterId:483, level:98, moves:["cold_beam","forge_blast_2","alloy_edge","cryo_plate"]},
      {monsterId:484, level:99, moves:["jaw_crush","obsidian_crash","eclipse_shroud","cryo_shatter"]},
  ...
  wielder_solenne: {
    ...
    team:[
      ...
      {monsterId:487, level:99, moves:["lunar_burst","tidal_rush","celestial_wave","moonlit_surge"]},
  ...
  wielder_rax: {
    ...
    team:[
      {monsterId:489, level:98, moves:["alloy_tail","crag_strike","obsidian_crash","iron_fortress"]},
      {monsterId:490, level:99, moves:["pyroclasm","void_pulse","solar_flare","forge_blast"]},
  ...
  wielder_tempris: {
    ...
    team:[
      {monsterId:492, level:98, moves:["volt_jet","mental","volt_surge","psycho_surge"]},
      {monsterId:493, level:99, moves:["forge_blast_2","whiteout","alloy_edge","icebound_lattice"]},
  ...
  wielder_vayne: {
    ...
    team:[
      {monsterId:495, level:98, moves:["specter_pulse","tectonic_shift","void_pulse","nihil_quake"]},
      {monsterId:496, level:99, moves:["mental","shear_strike","psi_strike","venom_mind"]},
  ...
  wielder_azura: {
    ...
    team:[
      {monsterId:498, level:98, moves:["mental","lunar_burst","psi_strike","cosmic_dust"]},
      {monsterId:499, level:99, moves:["draconic_pulse","solar_flare","ancient_breath","stellar_flare"]},
...
const QUESTS_DATA = [
  ...
  { id:"q1", title:"First Steps", desc:"Defeat 3 wild Lumori on Route 1 to prove your mettle.", location:"route1", type:"boss", requiredBadges:0,
    boss:{monsterId:181, level:8, moves:["collide","cranial_ram","daunt","blitz"]},
  ...
  { id:"q2", title:"Seedvale's Lost Pet", desc:"A child in Seedvale lost their Pudgeling. Find and defeat the wild one on Route 1.", location:"route1", type:"boss", requiredBadges:0,
    boss:{monsterId:185, level:7, moves:["collide","breeze","daunt","wingbeat"]},
  ...
  { id:"q3", title:"Bug Catcher's Challenge", desc:"A bug catcher on Route 1 challenges you to battle his prized Caterpet!", location:"route1", type:"boss", requiredBadges:0,
    boss:{monsterId:198, level:10, moves:["mandible_bite","silk_spray","collide","fortify"]},
  ...
  { id:"q4", title:"Meadow Guardian", desc:"A powerful Bushbear guards the meadow clearing. Defeat it!", location:"route1", type:"boss", requiredBadges:0,
    boss:{monsterId:70, level:12, moves:["vine_lash","collide","sharp_leaves","daunt"]},
  ...
  { id:"q6", title:"Night Prowler", desc:"A mysterious dark Lumori has been spotted on Route 1 at night. Defeat it!", location:"route1", type:"boss", requiredBadges:1,
    boss:{monsterId:118, level:15, moves:["chomp","blitz","dusk_slash","daunt"]},
  ...
  { id:"q7", title:"Fairy Ring Mystery", desc:"Strange lights glow in Fairy Meadow. Investigate by defeating the guardian.", location:"fairy_meadow_south", type:"boss", requiredBadges:0,
    boss:{monsterId:60, level:10, moves:["fairy_wind","collide","bewitching_kiss","blitz"]},
  ...
  { id:"q8", title:"The Stubborn Sproutling", desc:"A giant Sproutling blocks the path! Battle it to clear the way.", location:"route1", type:"boss", requiredBadges:0,
    boss:{monsterId:7, level:11, moves:["vine_lash","collide","sharp_leaves","slumber_dust"]},
  ...
  { id:"q9", title:"Route 1 Champion", desc:"Become the undisputed champion of Route 1 by defeating the alpha!", location:"route1", type:"boss", requiredBadges:1,
    boss:{monsterId:179, level:18, moves:["cranial_ram","crushing_bulk","blitz","radiance_cannon"]},
  ...
  { id:"q10", title:"Ashford Arena Amateur", desc:"Win the Ashford amateur tournament!", location:"ashford", type:"boss", requiredBadges:1,
    boss:{monsterId:183, level:16, moves:["crushing_bulk","cranial_ram","blitz","radiance_cannon"]},
  ...
  { id:"q11", title:"Tidewatch Fisherman", desc:"A fisherman challenges you with his strongest Aquatic Lumori!", location:"tidewatch", type:"boss", requiredBadges:1,
    boss:{monsterId:25, level:22, moves:["tidal_rush","tidal_sweep","bubble_jet","fortify"]},
  ...
  { id:"q12", title:"Coral Reef Explorer", desc:"Explore the Coral Reef and defeat its guardian.", location:"coral_reef", type:"boss", requiredBadges:2,
    boss:{monsterId:37, level:28, moves:["tidal_rush","forge_blast_2","stone_slide","fortify"]},
  ...
  { id:"q15", title:"The Lurking Depth", desc:"Something massive lurks in the Deep Trench. Defeat it!", location:"deep_trench", type:"boss", requiredBadges:2,
    boss:{monsterId:41, level:35, moves:["forge_blast_2","tidal_rush","tungsten_ram","tsunami"]},
  ...
  { id:"q16", title:"Jungle Expedition", desc:"Navigate the Lumoria Jungle and defeat the territorial alpha.", location:"lumoria_jungle", type:"boss", requiredBadges:1,
    boss:{monsterId:67, level:20, moves:["vine_lash","mud_spray","sharp_leaves","tectonic_shift"]},
  ...
  { id:"q17", title:"Ancient Ruins Scholar", desc:"A scholar needs help clearing Lumori from the Ancient Ruins.", location:"ancient_ruins", type:"boss", requiredBadges:1,
    boss:{monsterId:166, level:22, moves:["mind_jolt","psi_burst","blitz","second_wind"]},
  ...
  { id:"q18", title:"Tidal Wave Warning", desc:"A rogue Aquatic Lumori threatens Tidewatch harbor!", location:"tidewatch", type:"boss", requiredBadges:2,
    boss:{monsterId:39, level:28, moves:["tidal_rush","typhoon","tidal_sweep","wingbeat"]},
  ...
  { id:"q19", title:"Pearl Diver", desc:"Dive for pearls in the Coral Reef, but beware the guardian!", location:"coral_reef", type:"boss", requiredBadges:2,
    boss:{monsterId:34, level:26, moves:["prism_flare","tidal_rush","fairy_wind","bubble_jet"]},
  ...
  { id:"q20", title:"Route 2 Ranger", desc:"The Route 2 ranger needs help with an aggressive wild Lumori.", location:"route2", type:"boss", requiredBadges:1,
    boss:{monsterId:8, level:18, moves:["sharp_leaves","vine_lash","septic_prick","crushing_bulk"]},
  ...
  { id:"q21", title:"Volcanic Challenge", desc:"Brave the Volcano Core and defeat its fiery guardian!", location:"volcano_core", type:"boss", requiredBadges:3,
    boss:{monsterId:20, level:35, moves:["inferno_jet","tectonic_shift","pyroclasm","geoblast"]},
  ...
  { id:"q24", title:"Cinder Mole Hunt", desc:"A rare Cindermole has been spotted in the Lava Fields!", location:"lava_fields", type:"boss", requiredBadges:3,
    boss:{monsterId:19, level:32, moves:["inferno_jet","tectonic_shift","mud_spray","flicker"]},
  ...
  { id:"q25", title:"Iron Canyon Explorer", desc:"Explore the treacherous Iron Canyon and defeat its sentinel.", location:"iron_canyon", type:"boss", requiredBadges:3,
    boss:{monsterId:148, level:34, moves:["alloy_tail","jaw_crush","forge_blast_2","chrome_claw"]},
  ...
  { id:"q28", title:"Molten Core Mystery", desc:"Strange energy readings in the Volcano Core need investigation.", location:"volcano_core", type:"boss", requiredBadges:3,
    boss:{monsterId:14, level:36, moves:["inferno_jet","stone_slide","tectonic_shift","pyroclasm"]},
    reward:{type:"money", amount:3000}, rewardText:"3000 coins" },
  ...
  { id:"q38", title:"Lightning Rod", desc:"Capture the wild electricity surging through Route 5.", location:"route5", type:"boss", requiredBadges:4,
    boss:{monsterId:93, level:40, moves:["volt_jet","crag_strike","stone_slide","static_strike"]},
  ...
  { id:"q41", title:"Blizzard Warning", desc:"A massive blizzard Lumori rampages near Frostpeak!", location:"frostpeak", type:"boss", requiredBadges:4,
    boss:{monsterId:50, level:44, moves:["whiteout","cold_beam","frost_crash","fortify"]},
  ...
  { id:"q42", title:"Frozen Lake Monster", desc:"Break through the ice and battle the creature beneath!", location:"mirror_lake", type:"boss", requiredBadges:4,
    boss:{monsterId:45, level:42, moves:["whiteout","tidal_rush","cold_beam","tsunami"]},
    reward:{type:"money", amount:4000}, rewardText:"4000 coins" },
  { id:"q43", title:"Avalanche Alert", desc:"Stop the Lumori causing avalanches on Route 5!", location:"route5", type:"boss", requiredBadges:4,
    boss:{monsterId:56, level:43, moves:["whiteout","forge_blast_2","cold_beam","alloy_tail"]},
  ...
  { id:"q44", title:"Crystal Depths Expedition", desc:"Delve into the Crystal Depths and claim the crystal prize.", location:"crystal_depths", type:"boss", requiredBadges:5,
    boss:{monsterId:195, level:48, moves:["crystal_lance","crag_strike","stone_slide","landslide"]},
  ...
  { id:"q45", title:"Frostpeak Ski Challenge", desc:"Win the Frostpeak ski challenge battle tournament!", location:"frostpeak", type:"boss", requiredBadges:4,
    boss:{monsterId:47, level:42, moves:["cold_beam","frost_crash","blitz","whiteout"]},
    reward:{type:"money", amount:3000}, rewardText:"3000 coins" },
  { id:"q46", title:"Ice Sculptor's Request", desc:"An ice sculptor needs rare ice crystals. Defeat the Lumori guarding them.", location:"frostpeak", type:"boss", requiredBadges:4,
    boss:{monsterId:55, level:44, moves:["cold_beam","forge_blast_2","alloy_tail","whiteout"]},
  ...
  { id:"q47", title:"Polar Expedition", desc:"Join the polar expedition and face the apex predator!", location:"route5", type:"boss", requiredBadges:4,
    boss:{monsterId:54, level:45, moves:["whiteout","tectonic_shift","cold_beam","geoblast"]},
  ...
  { id:"q48", title:"The Frozen Guardian", desc:"Awaken and battle the legendary frozen guardian of Frostpeak.", location:"frostpeak", type:"boss", requiredBadges:5,
    boss:{monsterId:48, level:50, moves:["whiteout","cold_beam","tidal_rush","frost_crash"]},
  ...
  { id:"q49", title:"Glacial Passage", desc:"Clear the glacial passage for travelers by defeating the blockade.", location:"crystal_depths", type:"boss", requiredBadges:5,
    boss:{monsterId:61, level:46, moves:["whiteout","breeze","cold_beam","typhoon"]},
    reward:{type:"money", amount:3500}, rewardText:"3500 coins" },
  { id:"q50", title:"Chillgust Chase", desc:"A rare Chillgust has been spotted! Track it down!", location:"storm_plateau", type:"boss", requiredBadges:4,
    boss:{monsterId:62, level:45, moves:["whiteout","typhoon","cold_beam","wind_scythe"]},
    reward:{type:"item", itemId:"swiftFeather", qty:1}, rewardText:"Swift Feather" },
  ...
  { id:"q51", title:"Shadow Stalker", desc:"A shadow stalks Shadowmere at night. Put it to rest.", location:"shadowmere", type:"boss", requiredBadges:5,
    boss:{monsterId:119, level:48, moves:["jaw_crush","void_pulse","dusk_slash","nether_sphere"]},
    reward:{type:"item", itemId:"blackGlasses", qty:1}, rewardText:"Black Glasses" },
  { id:"q52", title:"Haunted Grove Terror", desc:"The Haunted Grove has become more dangerous. Investigate!", location:"haunted_grove", type:"boss", requiredBadges:5,
    boss:{monsterId:124, level:48, moves:["nether_sphere","void_pulse","jaw_crush","septic_prick"]},
  ...
  { id:"q55", title:"Crystal Spire Mystery", desc:"Unlock the Crystal Spire's secrets by defeating its protector.", location:"crystal_spire", type:"boss", requiredBadges:5,
    boss:{monsterId:58, level:48, moves:["cold_beam","prism_flare","mental","whiteout"]},
  ...
  { id:"q56", title:"Dark Canyon Depths", desc:"Venture into the Dark Canyon and face what lurks within.", location:"dark_canyon", type:"boss", requiredBadges:6,
    boss:{monsterId:133, level:52, moves:["void_pulse","crag_strike","nether_sphere","jaw_crush"]},
    reward:{type:"item", itemId:"ultraOrb", qty:5}, rewardText:"5 Ultra Orbs" },
  { id:"q57", title:"Shadowmere Underworld", desc:"The underworld beneath Shadowmere holds a powerful foe.", location:"shadowmere", type:"boss", requiredBadges:5,
    boss:{monsterId:79, level:48, moves:["void_pulse","verdant_orb","vine_lash","nether_sphere"]},
    reward:{type:"item", itemId:"maxPotion", qty:5}, rewardText:"5 Luma Infusions" },
  { id:"q58", title:"Grave Moss Collector", desc:"Collect rare grave moss by defeating its parasitic host.", location:"haunted_grove", type:"boss", requiredBadges:5,
    boss:{monsterId:130, level:46, moves:["nether_sphere","verdant_orb","void_pulse","sharp_leaves"]},
    reward:{type:"money", amount:3500}, rewardText:"3500 coins" },
  { id:"q59", title:"The Umbravine", desc:"A monstrous Umbravine has rooted in Route 6. Remove it!", location:"route6", type:"boss", requiredBadges:5,
    boss:{monsterId:79, level:50, moves:["void_pulse","verdant_orb","pod_blast","nether_sphere"]},
    reward:{type:"item", itemId:"miracleSeed", qty:1}, rewardText:"Miracle Seed" },
  { id:"q60", title:"Nightfall Reckoning", desc:"Face the most powerful dark Lumori in all of Shadowmere.", location:"shadowmere", type:"boss", requiredBadges:6,
    boss:{monsterId:123, level:55, moves:["jaw_crush","ooze_bomb","void_pulse","nether_sphere"]},
    reward:{type:"item", itemId:"xAttack", qty:5}, rewardText:"5 Power Charges" },
  ...
  { id:"q62", title:"Mystic Forest Patrol", desc:"Patrol the Mystic Forest and defeat rogue Lumori.", location:"mystic_forest", type:"boss", requiredBadges:6,
    boss:{monsterId:78, level:50, moves:["nether_sphere","sharp_leaves","void_pulse","verdant_orb"]},
    reward:{type:"money", amount:4000}, rewardText:"4000 coins" },
  { id:"q63", title:"Sky Harbor Defense", desc:"Sky Harbor is under attack! Defend it from the invader!", location:"sky_harbor", type:"boss", requiredBadges:6,
    boss:{monsterId:112, level:52, moves:["typhoon","wind_scythe","wingbeat","jetstream"]},
    reward:{type:"item", itemId:"revive", qty:5}, rewardText:"5 Luma Shards" },
  { id:"q64", title:"Poison Swamp Cleanup", desc:"Clear the toxic Lumori polluting the Poison Swamp.", location:"poison_swamp_upper", type:"boss", requiredBadges:6,
    boss:{monsterId:74, level:52, moves:["sludge_wave","tectonic_shift","acid_rain","toxify"]},
  ...
  { id:"q65", title:"Wind Bridge Battle", desc:"A wind elemental guards the Wind Bridge. Cross by defeating it!", location:"wind_bridge", type:"boss", requiredBadges:6,
    boss:{monsterId:115, level:52, moves:["typhoon","wind_scythe","cyclone_blade","jetstream"]},
    reward:{type:"money", amount:4500}, rewardText:"4500 coins" },
  { id:"q66", title:"Umbra Base Infiltrator", desc:"Infiltrate the abandoned Umbra Base and clear remaining forces.", location:"umbra_base", type:"boss", requiredBadges:6,
    boss:{monsterId:122, level:54, moves:["void_pulse","wingbeat","typhoon","jaw_crush"]},
    reward:{type:"item", itemId:"ultraOrb", qty:5}, rewardText:"5 Ultra Orbs" },
  { id:"q67", title:"Mental Duel", desc:"Oracle's apprentice challenges you to a psychic duel!", location:"skyvault", type:"boss", requiredBadges:6,
    boss:{monsterId:117, level:54, moves:["mental","typhoon","cyclone_blade","inner_calm"]},
    reward:{type:"money", amount:5000}, rewardText:"5000 coins" },
  ...
  { id:"q70", title:"Dreamweaver", desc:"A Lumori weaves dreams into reality. Snap out of it by fighting!", location:"mystic_forest", type:"boss", requiredBadges:6,
    boss:{monsterId:142, level:52, moves:["prism_flare","fairy_wind","mental","lunar_burst"]},
    reward:{type:"item", itemId:"pixieDust", qty:1}, rewardText:"Fairy Essence" },
  ...
  { id:"q71", title:"Draconic's Trial", desc:"Pass the Draconic's Trial at Dragonspire to prove your worth.", location:"dragonspire", type:"boss", requiredBadges:7,
    boss:{monsterId:173, level:60, moves:["rampage","draconic_pulse","hydra_dance","radiance_cannon"]},
  ...
  { id:"q72", title:"Route 8 Warden", desc:"The Route 8 warden tests all who pass.", location:"route8", type:"boss", requiredBadges:7,
    boss:{monsterId:321, level:58, moves:["rampage","pyroclasm","draconic_pulse","hydra_dance"]},
    reward:{type:"item", itemId:"dragonFang", qty:1}, rewardText:"Draconic Fang" },
  { id:"q73", title:"Victory Road Preview", desc:"Get a taste of Victory Road by defeating its gatekeeper!", location:"victoryroad", type:"boss", requiredBadges:8,
    boss:{monsterId:152, level:60, moves:["tungsten_ram","crag_strike","alloy_tail","forge_blast_2"]},
    reward:{type:"item", itemId:"xAttack", qty:5}, rewardText:"5 Power Charges" },
  { id:"q74", title:"Draconic Egg Protector", desc:"Protect the dragon eggs from poachers by defeating their leader!", location:"dragonspire", type:"boss", requiredBadges:7,
    boss:{monsterId:172, level:56, moves:["draconic_claw","draconic_breath","crushing_bulk","hydra_dance"]},
    reward:{type:"item", itemId:"maxPotion", qty:5}, rewardText:"5 Luma Infusions" },
  { id:"q75", title:"The Draconic Sage", desc:"An ancient dragon sage challenges worthy trainers.", location:"dragonspire", type:"boss", requiredBadges:8,
    boss:{monsterId:175, level:62, moves:["tidal_rush","draconic_pulse","tsunami","draconic_claw"]},
  ...
  { id:"q76", title:"Stormforged Encounter", desc:"A rare Stormforged has been spotted near Thunder Cliffs!", location:"thunder_cliffs", type:"boss", requiredBadges:4,
    boss:{monsterId:320, level:45, moves:["volt_jet","forge_blast_2","forge_strike","static_strike"]},
    reward:{type:"item", itemId:"metalCoat", qty:1}, rewardText:"Iron Shell" },
  { id:"q77", title:"Route 8 Ambush", desc:"Bandits ambush travelers on Route 8. Stop them!", location:"route8", type:"boss", requiredBadges:7,
    boss:{monsterId:119, level:56, moves:["jaw_crush","void_pulse","dusk_slash","nether_sphere"]},
    reward:{type:"item", itemId:"revive", qty:5}, rewardText:"5 Luma Shards" },
  { id:"q78", title:"The Apex Hunter", desc:"Track down the apex predator of Dragonspire.", location:"dragonspire", type:"boss", requiredBadges:8,
    boss:{monsterId:176, level:60, moves:["volt_jet","draconic_pulse","stormbolt","draconic_claw"]},
    reward:{type:"item", itemId:"dragonFang", qty:1}, rewardText:"Draconic Fang" },
  { id:"q79", title:"Legends Awakening", desc:"The ancient legends stir. Face a lesser dragon to prove readiness.", location:"dragonspire", type:"boss", requiredBadges:8,
    boss:{monsterId:171, level:62, moves:["mental","draconic_pulse","psi_strike","rampage"]},
  ...
  { id:"q80", title:"Summit Sentinel", desc:"The Summit's sentinel bars entry to the unworthy.", location:"summit", type:"boss", requiredBadges:8,
    boss:{monsterId:151, level:62, moves:["forge_blast_2","stormbolt","tungsten_ram","radiance_cannon"]},
  ...
  { id:"q81", title:"Bloomhaven Blossom Festival", desc:"Win the annual Blossom Festival tournament!", location:"bloomhaven", type:"boss", requiredBadges:8,
    boss:{monsterId:9, level:58, moves:["petal_blitz","verdant_orb","lunar_burst","canopy_crash"]},
  ...
  { id:"q82", title:"Toxic Waste Crisis", desc:"Miasma City's toxic waste has spawned a dangerous Lumori!", location:"miasmacity", type:"boss", requiredBadges:9,
    boss:{monsterId:158, level:60, moves:["sludge_wave","tectonic_shift","acid_rain","toxify"]},
    reward:{type:"item", itemId:"maxPotion", qty:5}, rewardText:"5 Luma Infusions" },
  { id:"q83", title:"Terravault Excavation", desc:"Join the excavation and battle what you unearth!", location:"terravault", type:"boss", requiredBadges:10,
    boss:{monsterId:107, level:62, moves:["tectonic_shift","geoblast","fissure_slam","mud_spray"]},
    reward:{type:"item", itemId:"softSand", qty:1}, rewardText:"Coarse Sand" },
  ...
  { id:"q86", title:"Ironforge Masterwork", desc:"Defeat the Ironforge champion's ultimate creation!", location:"ironforge", type:"boss", requiredBadges:13,
    boss:{monsterId:151, level:68, moves:["tungsten_ram","forge_blast_2","stormbolt","alloy_tail"]},
    reward:{type:"item", itemId:"metalCoat", qty:1}, rewardText:"Iron Shell" },
  ...
  { id:"q89", title:"Route 9 Pioneer", desc:"Be the first to explore the new Route 9!", location:"route9", type:"boss", requiredBadges:8,
    boss:{monsterId:8, level:55, moves:["petal_blitz","sharp_leaves","pod_blast","verdant_orb"]},
    reward:{type:"money", amount:5000}, rewardText:"5000 coins" },
  { id:"q90", title:"Route 10 Toxin", desc:"Clear the toxic Lumori blocking Route 10.", location:"route10", type:"boss", requiredBadges:9,
    boss:{monsterId:156, level:58, moves:["ooze_bomb","virulent_surge","toxify","acid_rain"]},
  ...
  { id:"q95", title:"Route 15 Rockslide", desc:"Clear the massive rockslide on Route 15.", location:"route15", type:"boss", requiredBadges:14,
    boss:{monsterId:192, level:66, moves:["tectonic_shift","crag_strike","stone_slide","landslide"]},
    reward:{type:"item", itemId:"maxPotion", qty:5}, rewardText:"5 Luma Infusions" },
  { id:"q96", title:"Route 16 Enchantment", desc:"Break through the fairy enchantment on Route 16.", location:"route16", type:"boss", requiredBadges:15,
    boss:{monsterId:146, level:68, moves:["lunar_burst","forge_blast_2","prism_flare","celestial_wave"]},
    reward:{type:"item", itemId:"ultraOrb", qty:10}, rewardText:"10 Ultra Orbs" },
  { id:"q97", title:"Bloomhaven Herb Garden", desc:"The herb garden has been overrun! Reclaim it!", location:"bloomhaven", type:"boss", requiredBadges:8,
    boss:{monsterId:64, level:56, moves:["ooze_bomb","pod_blast","spore_burst","verdant_orb"]},
    reward:{type:"item", itemId:"miracleSeed", qty:1}, rewardText:"Miracle Seed" },
  { id:"q98", title:"Miasma Underbelly", desc:"Explore the toxic underbelly of Miasma City.", location:"miasmacity", type:"boss", requiredBadges:9,
    boss:{monsterId:165, level:60, moves:["resonance_hum","ooze_bomb","virulent_surge","shear_strike"]},
    reward:{type:"money", amount:6000}, rewardText:"6000 coins" },
  { id:"q99", title:"Terravault Deep Mine", desc:"Delve into the deepest mine shaft of Terravault.", location:"terravault", type:"boss", requiredBadges:10,
    boss:{monsterId:154, level:62, moves:["tectonic_shift","forge_strike","forge_blast_2","geoblast"]},
    reward:{type:"item", itemId:"xDefense", qty:5}, rewardText:"5 Guard Charges" },
  { id:"q100", title:"The Great Silkwood Tree", desc:"The Great Tree's guardian challenges all who approach!", location:"silkwood", type:"boss", requiredBadges:11,
    boss:{monsterId:202, level:62, moves:["resonance_hum","lunar_burst","silk_bind","prism_flare"]},
    reward:{type:"money", amount:7000}, rewardText:"7000 coins" },
  ...
  { id:"q102", title:"Volcanic Awakening", desc:"Volcanox rumbles in the Volcano Core. Calm it by battle!", location:"volcano_core", type:"boss", requiredBadges:10,
    boss:{monsterId:315, level:70, moves:["pyroclasm","crag_strike","caldera_meltdown","tectonic_shift"]},
    reward:{type:"item", itemId:"masterOrb", qty:1}, rewardText:"Master Orb" },
  { id:"q103", title:"Abyssal Draconic", desc:"Abyssdrake lurks in the Deep Trench. Challenge the abyss!", location:"deep_trench", type:"boss", requiredBadges:8,
    boss:{monsterId:316, level:70, moves:["tsunami","draconic_pulse","rampage","tidal_rush"]},
    reward:{type:"item", itemId:"masterOrb", qty:1}, rewardText:"Master Orb" },
  { id:"q104", title:"Temporal Rift", desc:"Chronoseer appears in the Crystal Spire. Face time itself!", location:"crystal_spire", type:"boss", requiredBadges:14,
    boss:{monsterId:317, level:70, moves:["mental","temporal_rift","psi_strike","inner_calm"]},
    reward:{type:"item", itemId:"masterOrb", qty:1}, rewardText:"Master Orb" },
  { id:"q105", title:"World Seed", desc:"Terranova awakens in the Ancient Ruins. Face nature's fury!", location:"ancient_ruins", type:"boss", requiredBadges:14,
    boss:{monsterId:318, level:70, moves:["tectonic_shift","verdant_orb","worldseed_quake","petal_blitz"]},
    reward:{type:"item", itemId:"masterOrb", qty:1}, rewardText:"Master Orb" },
  { id:"q106", title:"Void Star Rising", desc:"Voidstar manifests in the Dark Canyon. Face the void!", location:"void_rift", type:"boss", requiredBadges:15,
    boss:{monsterId:319, level:70, moves:["void_pulse","lunar_burst","nether_sphere","mental"]},
    reward:{type:"item", itemId:"masterOrb", qty:1}, rewardText:"Master Orb" },
  { id:"q107", title:"Storm Forged Legend", desc:"The legendary Stormforged descends on Iron Canyon!", location:"iron_canyon", type:"boss", requiredBadges:13,
    boss:{monsterId:320, level:70, moves:["volt_jet","tungsten_ram","forge_blast_2","forge_strike"]},
    reward:{type:"item", itemId:"masterOrb", qty:1}, rewardText:"Master Orb" },
  { id:"q108", title:"Champion's Rematch", desc:"Champion Lumian offers a rematch at full power!", location:"summit", type:"boss", requiredBadges:16,
    boss:{monsterId:321, level:80, moves:["rampage","draconic_pulse","pyroclasm","hydra_dance"]},
  ...
  { id:"q109", title:"Ultimate Trial", desc:"Face the ultimate trial: a gauntlet of the strongest wild Lumori!", location:"victoryroad", type:"boss", requiredBadges:16,
    boss:{monsterId:173, level:78, moves:["rampage","draconic_pulse","hydra_dance","radiance_cannon"]},
  ...
  { id:"q110", title:"The Final Quest", desc:"Complete every challenge Lumoria has to offer.", location:"summit", type:"boss", requiredBadges:16,
    boss:{monsterId:171, level:80, moves:["mental","draconic_pulse","temporal_rift","rampage"]},
  ...
  { id:"q111", title:"Verdant Trail Ranger", desc:"A veteran ranger patrols Route 9 and tests every trainer who passes.", location:"route9", type:"boss", requiredBadges:8,
    boss:{monsterId:74, level:57, moves:["celestial_wave","petal_blitz","lunar_burst","verdant_orb"]},
    reward:{type:"money", amount:6000}, rewardText:"6000 coins" },
  { id:"q112", title:"Evolved Vine Colossus", desc:"A fully evolved Grass titan has made Route 9 its territory. Claim it!", location:"route9", type:"boss", requiredBadges:8,
    boss:{monsterId:68, level:58, moves:["tectonic_shift","verdant_orb","root_lance","petal_blitz"]},
    reward:{type:"item", itemId:"miracleSeed", qty:1}, rewardText:"Miracle Seed" },
  { id:"q113", title:"Bloomhaven Bug Wrangler", desc:"The local bug wrangler challenges you with his prized evolved insects.", location:"bloomhaven", type:"boss", requiredBadges:8,
    boss:{monsterId:203, level:57, moves:["lunar_burst","resonance_hum","prism_flare","silk_bind"]},
    reward:{type:"item", itemId:"silverPowder", qty:1}, rewardText:"Carapace Dust" },
  ...
  { id:"q114", title:"Toxic Passage Brawler", desc:"A battle-hardened Poison trainer blocks the toxic passage.", location:"route10", type:"boss", requiredBadges:9,
    boss:{monsterId:159, level:60, moves:["acid_rain","sludge_wave","venom_lance","geoblast"]},
  ...
  { id:"q115", title:"Miasma City Chemist", desc:"A Miasma City chemist tests trainers with toxic-type experiments.", location:"miasmacity", type:"boss", requiredBadges:9,
    boss:{monsterId:163, level:61, moves:["sludge_wave","virulent_surge","venom_lance","toxify"]},
    reward:{type:"item", itemId:"poisonBarb", qty:1}, rewardText:"Venom Thorn" },
  ...
  { id:"q118", title:"Desert Draconic Duel", desc:"A legendary desert dragon has been spotted at Route 11. Challenge it!", location:"route11", type:"boss", requiredBadges:10,
    boss:{monsterId:107, level:64, moves:["draconic_claw","tectonic_shift","geoblast","rampage"]},
    reward:{type:"item", itemId:"softSand", qty:1}, rewardText:"Coarse Sand" },
  { id:"q119", title:"Terravault Iron Giant", desc:"An ancient iron giant guards the entrance to Terravault's mines.", location:"terravault", type:"boss", requiredBadges:10,
    boss:{monsterId:103, level:63, moves:["tectonic_shift","tidal_rush","geoblast","tidal_crush"]},
    reward:{type:"item", itemId:"xDefense", qty:5}, rewardText:"5 Guard Charges" },
  ...
  { id:"q120", title:"Silk Road Weaver", desc:"The legendary Silk Road Weaver challenges trainers who disturb its web.", location:"route12", type:"boss", requiredBadges:11,
    boss:{monsterId:202, level:65, moves:["lunar_burst","resonance_hum","silk_bind","prism_flare"]},
  ...
  { id:"q121", title:"Silkwood Ancient Beetle", desc:"An ancient evolved beetle protects the Great Silkwood Tree's roots.", location:"silkwood", type:"boss", requiredBadges:11,
    boss:{monsterId:201, level:65, moves:["shear_strike","alloy_tail","forge_blast_2","mandible_crush"]},
    reward:{type:"item", itemId:"silverPowder", qty:1}, rewardText:"Carapace Dust" },
  { id:"q122", title:"Rock Beetle King", desc:"The Rock Beetle King rules the Silk Road tunnels deep below.", location:"route12", type:"boss", requiredBadges:11,
    boss:{monsterId:205, level:65, moves:["resonance_hum","tectonic_shift","crag_strike","mandible_crush"]},
    reward:{type:"item", itemId:"hardStone", qty:1}, rewardText:"Crag Shard" },
  ...
  { id:"q126", title:"Ironwork Sentinel", desc:"The Ironwork Path's mechanical sentinel bars all unworthy trainers.", location:"route14", type:"boss", requiredBadges:13,
    boss:{monsterId:149, level:69, moves:["tungsten_ram","forge_blast_2","alloy_tail","forge_strike"]},
  ...
  { id:"q127", title:"Ironforge Champion Smith", desc:"The master blacksmith of Ironforge forged his Lumori as hard as steel.", location:"ironforge", type:"boss", requiredBadges:13,
    boss:{monsterId:154, level:69, moves:["forge_blast_2","tectonic_shift","tungsten_ram","anvil_drop"]},
    reward:{type:"item", itemId:"metalCoat", qty:1}, rewardText:"Iron Shell" },
  ...
  { id:"q128", title:"Granite Pass Guardian", desc:"A Rock master guards the narrowest point of Granite Pass.", location:"route15", type:"boss", requiredBadges:14,
    boss:{monsterId:196, level:71, moves:["crag_strike","frost_crash","whiteout","crystal_lance"]},
  ...
  { id:"q129", title:"Umbra Void Patrol", desc:"The Umbra Order agents have set up a checkpoint on Route 15! Clear them out!", location:"route15", type:"boss", requiredBadges:14,
    boss:{monsterId:119, level:67, moves:["jaw_crush","void_pulse","dusk_slash","nether_sphere"]},
    reward:{type:"item", itemId:"ultraOrb", qty:10}, rewardText:"10 Ultra Orbs",
    umbra:true },
  ...
  { id:"q132", title:"Commander Phantom's Last Stand", desc:"Commander Phantom has regrouped on Route 16! Stop The Umbra Order before they re-open the Void Rift!", location:"route16", type:"boss", requiredBadges:15,
    boss:{monsterId:120, level:70, moves:["jaw_crush","void_pulse","void_rend","dusk_slash"]},
  ...
  { id:"ngq09", title:"Prismatic Trial — Wave 1", desc:"A mysterious trainer calling himself the Prismatic Warden challenges all who enter the Rift. Defeat him to prove your worth.", location:"prismatic_rift", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:379, level:85, moves:["draconic_claw","phantom_claw","wyrm_strike","cataclysm_breath"]},
  ...
  { id:"ngq10", title:"Prismatic Trial — Wave 2", desc:"The Prismatic Warden's partner has emerged. Face the storm entity she commands.", location:"prismatic_rift", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:380, level:87, moves:["stormbolt","tailwind_strike","volt_surge","neural_storm"]},
  ...
  { id:"ngq11", title:"Apex Gauntlet — Round 1", desc:"The Apex Gauntlet is a legendary test. Face the first guardian of the Summit.", location:"apex_summit", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:389, level:90, moves:["stormbolt","draconic_pulse","volt_surge","cataclysm_breath"]},
  ...
  { id:"ngq12", title:"Apex Gauntlet — Round 2", desc:"The second guardian awaits. Its power dwarfs all that came before.", location:"apex_summit", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:392, level:92, moves:["time_fracture","cataclysm_breath","synaptic_shatter","neural_storm"]},
  ...
  { id:"ngq14", title:"Rex Omega Challenge", desc:"Gym Leader Rex has trained in the NG+ era. His Normal-types are now truly fearsome.", location:"ashford", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:391, level:82, moves:["cranial_ram","crushing_bulk","radiance_cannon","draconic_claw"]},
  ...
  { id:"ngq15", title:"Zephyra Omega Challenge", desc:"Gym Leader Zephyra has embraced the void-touched wind Lumori. Her speed is now unmatched.", location:"gusthaven", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:370, level:84, moves:["stormbolt","tailwind_strike","volt_surge","wind_scythe"]},
  ...
  { id:"ngq16", title:"Atlas Omega Challenge", desc:"Gym Leader Atlas wields NG+ steel behemoths. Can you crack his iron fortress?", location:"ironforge", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:334, level:83, moves:["forge_blast_2","alloy_tail","terra_spike","fissure_slam"]},
  ...
  { id:"ngq17", title:"The Void Scholar", desc:"A researcher who survived exposure to a Void Rift challenges you with a void-type team.", location:"void_rift", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:373, level:86, moves:["void_rend","phantom_claw","nether_sphere","cataclysm_breath"]},
  ...
  { id:"ngq18", title:"Champion++ — The True Test", desc:"The Champion has been training since your first victory. This rematch will push you beyond your limits.", location:"victoryroad", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:400, level:98, moves:["mantle_surge","solar_flare","terra_spike","conflagration"]},
  ...
  { id:"ngq20", title:"Director Shade — Final Form", desc:"Director Shade has absorbed void energy and returned more powerful than ever. End this once and for all.", location:"void_nexus", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:352, level:90, moves:["void_rend","synaptic_shatter","neural_storm","phantom_claw"]},
  ...
  { id:"ngq21", title:"The Draconic Veil Seeker", desc:"Legends speak of a Draconic-Mental lineage hidden in the Prismatic Rift. Find and face the evolved form.", location:"prismatic_rift", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:404, level:88, moves:["veil_collapse","cataclysm_breath","synaptic_shatter","wyrm_strike"]},
    reward:{type:"item", itemId:"prismaticShard", qty:3}, rewardText:"3 Prismatic Shards" },
  ...
  { id:"ngq23", title:"Void Council: The Tactician", desc:"Councilor Vale commands a perfectly coordinated team built around prediction and counters. Every switch is calculated.", location:"void_rift", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:343, level:88, moves:["shadowstep","psi_strike","synaptic_shatter","phantom_claw"]},
  ...
  { id:"ngq25", title:"Void Council: The Illusionist", desc:"Councilor Mira uses status, confusion, and misdirection. You will never know what hits you.", location:"prismatic_rift", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:378, level:89, moves:["dreamweave","fae_requiem","neural_storm","synaptic_shatter"]},
  ...
  { id:"ngq26", title:"Void Council: The Titan", desc:"Councilor Gorn fields the heaviest defensive walls in Lumoria. Chip through or be outlasted.", location:"apex_summit", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:385, level:91, moves:["whiteout","fissure_slam","cryo_lance","terra_spike"]},
  ...
  { id:"ngq27", title:"Void Council: The Grandmaster", desc:"Councilor Null is the most fearsome trainer in NG+ Lumoria. His team is the stuff of legend.", location:"apex_summit", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:398, level:95, moves:["void_dominion","neural_storm","fae_requiem","synaptic_shatter"]},
  ...
  { id:"ngq28", title:"Ancient Gauntlet — Entry", desc:"The Ancient Gauntlet is a legendary 10-battle challenge with no healing between fights. Attempt it only when fully prepared.", location:"void_nexus", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:352, level:87, moves:["void_rend","synaptic_shatter","phantom_claw","neural_storm"]},
  ...
  { id:"ngq29", title:"Ancient Gauntlet — The Final Wave", desc:"You've fought through everything the Gauntlet has. One last opponent stands between you and eternal glory.", location:"void_nexus", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:401, level:98, moves:["cosmic_veil","neural_storm","psi_strike","fae_requiem"]},
  ...
  { id:"ngq30", title:"The Drifting Duelist", desc:"A masked trainer wanders the NG+ routes seeking worthy challengers. They appear without warning and leave the same way.", location:"void_rift", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:356, level:88, moves:["stormbolt","draconic_pulse","wyrm_strike","volt_surge"]},
  ...
  { id:"ngq32", title:"The Storm Hermit", desc:"A recluse who has lived at the top of Apex Summit for 30 years. Their Lumori are battle-hardened beyond anything you have fought.", location:"apex_summit", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:389, level:93, moves:["volt_surge","cataclysm_breath","stormbolt","neural_storm"]},
  ...
  { id:"ngq33", title:"Rival Challenge: The First Rival", desc:"Your first rival has completed their own NG+ journey. Their team is unrecognisable from what you once faced.", location:"void_rift", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:345, level:89, moves:["wyrm_strike","void_rend","nether_sphere","cataclysm_breath"]},
    reward:{type:"money", amount:30000}, rewardText:"30000 coins" },
  { id:"ngq34", title:"Rival Challenge: The Team Rocket", desc:"Your nemesis rival has rebuilt their team around pure NG+ power. They want to settle the score permanently.", location:"apex_summit", type:"boss", requiresNGPlus:true, requiredBadges:0,
    boss:{monsterId:393, level:92, moves:["void_rend","stormbolt","nether_sphere","neural_storm"]},
