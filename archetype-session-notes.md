...
**Roadmap totals:** 33 batches in roadmap (all 33 firm — INSTRUMENTS entries landed); 26 roadmap done (INSTRUMENTS landed 2026-05-13 closes Manmade). **28 categories committed** (26 roadmap + 2 bonus PLANTS/FUNGI). **7 batches remaining** in roadmap: 7 Phenomena. BANNER permanently dropped 2026-05-12 session (parallels RIVER + URBAN drops in earlier Phase 1 work).
...
| Phenomena | NOT STARTED 0/7 | Receives multiple deferrals from earlier clusters. **Next active cluster.** |
