...
- [ ] **Umbra key-character appearance designs** — brainstorm + design the important people of Umbra: regional leaders/gym-equivalents, the player's **rival**, and the **Champion** (plus other notable named NPCs). Same goal as the wielders — distinctive, good-looking character designs with clear silhouette + color identity.
