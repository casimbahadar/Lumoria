...
| Phase 1 extension (post-roadmap-closure) | IN PROGRESS 2/? | FURNITURE + ANATOMY landed 2026-05-15 (FURNITURE 5 entries: chair, table, bed, couch/sofa, bookshelf; ANATOMY 3 entries: brain, eyeball, tongue — user picks from brainstorm-batch-1). Tracks any new top-level categories added beyond the original 35-batch roadmap. Open-ended; more potential additions via subsequent brainstorm batches. |
