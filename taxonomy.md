...
- `[321] Dragemian | Dragon/Fire | dragon-mythic` (sub: fire-dragon — alongside Calderaeth)
...
- `[327] Quarrex (→Gravithorn→Abyssforge) | Earth | golem` (base of the earth/gravity-golem line; see [377])
...
- `[334] Voltbrawler | Electric/Fighting | golem` (sub: battlebot / combat-automaton; re-themed 2026-06-12 from Metal/Fighting metal-brawler → pristine Electric/Fighting battlebot, adding a new type pairing to the golem roster)
...
- `[369] Gravithorn (→Abyssforge) | Earth/Mineral | golem` (mid of the earth-golem line — gravity by sheer mineral density; see [377])
...
- `[377] Quarrex→Gravithorn→Abyssforge | Earth/Mineral | golem` (sub: earth-golem; merged 2026-06-12 from 3 NG+ golem standalones — granite golem → dense gravity golem → ultra-dense core-titan. Consistent Earth→Earth/Mineral→Earth/Mineral; Earth/Mineral count 2)
