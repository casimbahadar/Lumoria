# Lumoria — Character Appearance / Art-Generation Prompts
...
## ⭐ The 13 Vaeldris Wielders
Each wields a Forgotten trio; their look should echo that trio's element + a "survivor of a lost world" gravity. Shared motif: a single relic of Vaeldris on each (a shard, a pauldron, a charm).
...
## 🌑 The Umbra Order *(villain team — eclipse / living-shadow motif)*
Goal: awaken the three Legendaries. Shared look: matte-black uniforms, eclipse-ring crest, violet underglow.
...
## 🏅 Lumoria Gym Leaders (16 — canon names/types)
Type-themed; arena-appropriate outfits.

| # | Leader · Type | Look / Palette · Prompt seed |
|--|--|--|
| 1 | **Rex** · Normal | versatile all-rounder coach, varsity jacket · grey/white · *"confident all-rounder gym leader in a varsity jacket, neutral palette"* |
| 2 | **Marina** · Water | sea-captain diver, teal coat + goggles · teal/navy · *"spirited sea-captain gym leader, diving goggles, teal coat"* |
| 3 | **Pyros** · Fire | volcanic firefighter-smith, ember-scarred · red/orange · *"fierce fire gym leader, ember-scarred, heat-shimmer coat"* |
| 4 | **Zara** · Electric | speedster in a charged racing suit · yellow/blue · *"energetic electric gym leader in a charged racing suit, lightning motifs"* |
| 5 | **Glacier** · Ice | calm mountaineer in furred white gear · white/ice-blue · *"calm ice gym leader, furred white mountaineering gear, frost breath"* |
| 6 | **Nyx** · Dark | nocturnal duelist, black coat + mask · black/purple · *"mysterious dark gym leader in a black coat and half-mask, night motifs"* |
| 7 | **Oracle** · Mental | veiled seer, third-eye circlet · violet/gold · *"serene mental gym leader, veiled, third-eye circlet, floating tarot motifs"* |
| 8 | **Drake** · Draconic | dragon-knight in scaled armor · crimson/gold · *"proud draconic gym leader in scaled crimson-and-gold armor"* |
| 9 | **Thorne** · Grass/Nature | druid-botanist, leaf-mantle · green/brown · *"earthy grass gym leader, leaf-mantle, vine-wrapped staff"* |
| 10 | **Viper** · Poison | alchemist-punk, toxin vials · purple/acid-green · *"edgy poison gym leader, bandolier of toxin vials, acid-green accents"* |
| 11 | **Atlas** · Fighting/Earth | titan strongman, stone bracers · bronze/earth · *"towering strongman gym leader, stone bracers, bronze and earth palette"* |
| 12 | **Mantis** · Fighting (blade) | martial artist, blade-gauntlets · jade/white · *"disciplined martial-artist gym leader with mantis-blade gauntlets, jade palette"* |
| 13 | **Zephyra** · Wind | aerial dancer, ribbon-silks · pale-blue/white · *"graceful wind gym leader, flowing ribbon-silks, aerial dancer pose"* |
| 14 | **Ferro** · Metal | engineer-knight in steel plate · steel/orange · *"stalwart metal gym leader in riveted steel plate, forge-orange visor glow"* |
| 15 | **Boulder** · Rock/Mineral | miner-geologist, gem-studded gear · brown/grey · *"sturdy rock gym leader, miner's gear studded with raw gems, brown-grey palette"* |
| 16 | **Seraphina** · Fairy/radiant *(final gym)* | radiant noble, winged circlet · white-gold/rose · *"radiant fairy gym leader in white-gold robes with a winged circlet, rose accents, ethereal glow"* |

---

## 👑 The Vanguard (Elite) + Champion
