...
- [ ] **Moveset finalization** — apply the deferred Phase 2 STAB-completeness cases for Stellar/Primal Lumori (5 currently at 4/5 STAB: #319 Voidraxis, #384 Solarcrown, #394 Solarvast, #401 Cosmoveil, #400 Primordiax). Once typing review determines which Forgotten gain rare types, assign their moves; may un-reserve some Stellar/Aether/Chrono exclusives that are no longer needed in the pool.
  - [2026-06-07] Pre-408 legacy Stellar/Primal typings for all 5 reviewed and CONFIRMED KEPT — each passes the legendary + intrinsic/multi-phrase lore test with no comparable pre-408 alternative (Voidraxis "Void Star", Solarcrown "solar plasma/coronal", Solarvast "stellar dragon born from the sun", Cosmoveil "condensed starlight", Primordiax "primordial titan/predates all"). No type changes. Moveset/STAB finalization remains deferred pending the broader Forgotten typing review.
