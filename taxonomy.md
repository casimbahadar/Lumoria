...
- `[369] Gravithorn (→Abyssforge) | Mental/Earth | golem` (mid of the earth/gravity-golem line — gravity-inversion psychic; see [377])
...
- `[377] Quarrex→Gravithorn→Abyssforge | Earth/Mineral | golem` (sub: earth-golem; merged 2026-06-12 from 3 NG+ golem standalones — granite golem → gravity-psychic → ultra-dense core-titan. Earth→Mental/Earth→Earth/Mineral; Earth/Mineral kept distinctive at count 1)
