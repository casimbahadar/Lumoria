...
**Phenomena cluster (3 left):** HOLOGRAM → EXPLOSIVE → WEATHER/ATMOSPHERIC *(SHADOW-CAST + BUBBLE + SMOKE + PERFUME landed 2026-05-13)*

**Roadmap totals:** 33 batches in roadmap (all 33 firm); 30 roadmap done (PERFUME landed 2026-05-13). **32 categories committed** (30 roadmap + 2 bonus PLANTS/FUNGI). **3 batches remaining** in roadmap: 3 Phenomena. BANNER permanently dropped 2026-05-12 session (parallels RIVER + URBAN drops in earlier Phase 1 work).
...
| Phenomena | IN PROGRESS 4/7 | SHADOW-CAST + BUBBLE + SMOKE + PERFUME landed 2026-05-13. BUBBLE resolved TOY's balloon + balloon-animal deferrals. SMOKE routed volcanic-smoke/ash-cloud/dust-cloud to NATURAL-DISASTER-side, mist/fog to WEATHER-side, incense-smoke to PERFUME-side. PERFUME resolved SMOKE's incense-smoke routing. Remaining deferrals targeting Phenomena: snowdrift / icicle-formation / polar-night → WEATHER. |
