...
**Phenomena cluster (4 left):** PERFUME → HOLOGRAM → EXPLOSIVE → WEATHER/ATMOSPHERIC *(SHADOW-CAST + BUBBLE + SMOKE landed 2026-05-13)*

**Roadmap totals:** 33 batches in roadmap (all 33 firm); 29 roadmap done (SMOKE landed 2026-05-13). **31 categories committed** (29 roadmap + 2 bonus PLANTS/FUNGI). **4 batches remaining** in roadmap: 4 Phenomena. BANNER permanently dropped 2026-05-12 session (parallels RIVER + URBAN drops in earlier Phase 1 work).
...
| Phenomena | IN PROGRESS 3/7 | SHADOW-CAST + BUBBLE + SMOKE landed 2026-05-13. BUBBLE resolved TOY's balloon + balloon-animal deferrals. SMOKE batch DROPPED Habitat's fumarole-deferral entirely and routed volcanic-smoke/ash-cloud/dust-cloud to NATURAL-DISASTER-side, mist/fog to WEATHER-side, incense-smoke to PERFUME-side. Remaining deferrals targeting Phenomena: snowdrift / icicle-formation / polar-night → WEATHER. |
