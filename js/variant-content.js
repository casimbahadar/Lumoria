...
(function (global) {
  ...
  const ANCHORS = {
    ...
    206: { noun: 'venom dragonet', features: ['its green-and-yellow banded scales', 'its elongated fangs', 'its slender coils'], coreLine: 'Its bright bands still warn of its venom.' },
    207: { noun: 'venom dragon', features: ['its purple-black scales', 'its dripping fangs', 'its long coils'], coreLine: 'Venom still beads at the tips of its fangs.' },
    208: { noun: 'venom wyrm', features: ['its olive-green banded scales', 'its vast coils', 'its great venom glands'], coreLine: 'A single bite still carries killing venom.' },
    ...
    230: { noun: 'dragon hatchling', features: ['its shiny copper-red scales', 'its oversized head', 'its crumpled unready wings'], coreLine: 'It still basks to warm its copper scales.' },
    231: { noun: 'water-wyvern', features: ['its aqua-blue and emerald scales', 'its streamlined body', 'its finned wings'], coreLine: 'It still knifes through water on finned wings.' },
    ...
    272: { noun: 'fire dragonet', features: ['its bright orange-red scales', 'its oversized eyes', 'its too-small flapping wings'], coreLine: 'It still flaps wings too small to lift it.' },
    273: { noun: 'fire dragon', features: ['its crimson-orange scales', 'its broad wingspan', 'its kindling breath'], coreLine: 'Its breath still kindles to flame on command.' },
    ...
    345: { noun: 'void serpent', features: ['its light-swallowing black scales', 'its dim crimson eyes', 'its vast coils'], coreLine: 'A visible darkness still pools around it.' },
    ...
    356: { noun: 'storm-lord dragon', features: ['its chrome-blue scales', 'its wings of crackling lightning', 'its commanding bulk'], coreLine: 'The sky still darkens when it takes wing.' },
    ...
    361: { noun: 'continent dragon', features: ['its body of compacted tectonic plates', 'the moss and stone across its back', 'its colossal length'], coreLine: 'Whole ecosystems still cling to its back.' },
    ...
    374: { noun: 'aurora dragon', features: ['its translucent banded scales', 'its green-violet-gold glow', 'its long body'], coreLine: 'Auroral light still ripples down its hide.' },
    ...
    382: { noun: 'oblivion dragon', features: ['its light-absorbing wings', 'its black scaled body', 'its vast shadow'], coreLine: 'Its shadow still falls darker than night.' },
    ...
    389: { noun: 'storm dragon', features: ['its permanent lightning crown', 'its charged scales', 'its dominant bulk'], coreLine: 'It still cows every lesser storm-creature near.' },
    ...
    391: { noun: 'titan predator', features: ['its impossibly vast body', 'its ancient apex frame', 'its earth-shaking tread'], coreLine: 'The ground still shakes with each of its steps.' },
    ...
    395: { noun: 'glacier dragon', features: ['its ancient glacial-ice scales', 'its vast cold body', 'its slow ponderous frame'], coreLine: 'Ages of ice still armour its hide.' },
    ...
    462: { noun: 'divine messenger', features: ['its radiant feathered form', 'its aura of lost things', 'its ancient bearing'], coreLine: 'It still seeks out those who have lost something dear.' },
    463: { noun: 'crystalline beast', features: ['its light-refracting crystal structures', 'its earthen body', 'its prismatic glow'], coreLine: 'Light still bends strangely through its body.' },
    464: { noun: 'celestial sentinel', features: ['its radiant metal plumage', 'its solemn bearing', 'its divine light'], coreLine: 'It still mourns as the last of its kind.' },
    465: { noun: 'nightmare serpent', features: ['its shadow-and-spirit coils', 'its barely-physical form', 'its cold gaze'], coreLine: 'It still blurs the line between beast and bad dream.' },
    466: { noun: 'darkfire beast', features: ['its lightless darkfire flames', 'its venom-smouldering body', 'its grim glow'], coreLine: 'Its darkfire still burns without giving light.' },
    467: { noun: 'mourning revenant', features: ['its frost-stilled form', 'its silent presence', 'its sorrowful mind'], coreLine: 'It still stands as if frozen at the moment of loss.' },
    468: { noun: 'superconductor dragon', features: ['its natural alloy scales', 'its zero-resistance current', 'its gleaming hide'], coreLine: 'Charge still flows through it without loss.' },
    469: { noun: 'strata beast', features: ['its strata-layered scales', 'its earthen hide', 'its geological build'], coreLine: 'Its scales still lay down strata like living rock.' },
    470: { noun: 'storm-grove beast', features: ['its verdant water-slick hide', 'its storm-touched mane', 'its quiet majesty'], coreLine: 'It still commands respect without any title.' },
    471: { noun: 'root titan', features: ['its mountain-cracking roots', 'its toxin-laced bark', 'its vast slow body'], coreLine: 'Its roots still work slowly through bedrock.' },
    472: { noun: 'walking mountain', features: ['its mountain-like body', 'its ore-veined stone', 'its colossal tread'], coreLine: 'It still moves like a mountain that chose to walk.' },
    473: { noun: 'earth colossus', features: ['its earth-wracked body', 'its mountainous fists', 'its tectonic strength'], coreLine: 'Its strength still feels too large for words.' },
    474: { noun: 'oracle leviathan', features: ['its deep-ocean body', 'its far-seeing mind', 'its vast presence'], coreLine: 'It still seems to know what has not yet happened.' },
    475: { noun: 'abyssal hunter', features: ['its lightless deep-sea body', 'its painless toxin', 'its silent approach'], coreLine: 'Its toxin still brings only a calm, sinking stillness.' },
    476: { noun: 'tide primarch', features: ['its glacial primal body', 'its tide-commanding presence', 'its ancient bulk'], coreLine: 'The sea still seems to part around it.' },
    477: { noun: 'sky spirit', features: ['its radiant veil-like form', 'its electric shimmer', 'its weightless drift'], coreLine: 'The air still moves as if to greet it.' },
    478: { noun: 'steel-feathered raptor', features: ['its vibrating steel feathers', 'its broad wings', 'its keen senses'], coreLine: 'Its feathers still hum with coming weather.' },
    479: { noun: 'sky wraith', features: ['its ever-aloft spectral body', 'its trailing cloud-vapour', 'its restless wings'], coreLine: 'It still refuses ever to touch the ground.' },
    480: { noun: 'forge beast', features: ['its volcanic-honed claws', 'its molten-metal hide', 'its blazing eyes'], coreLine: 'Its claws still hold a freshly-sharpened edge.' },
    481: { noun: 'ember primarch', features: ['its smouldering primal body', 'its earthen armour', 'its fierce independence'], coreLine: 'It still answers to no one but itself.' },
    482: { noun: 'venom dragon', features: ['its venom-laced flames', 'its loyal bearing', 'its compact dragon body'], coreLine: 'It still keeps the loyalty it learned as a hatchling.' },
    483: { noun: 'ice-steel beast', features: ['its ice-steel plating', 'its crystalline edges', 'its frozen sheen'], coreLine: 'Its ice-steel still holds an impossible edge.' },
    484: { noun: 'frost predator', features: ['its dark frost-rimed hide', 'its cold patient gaze', 'its silent stalk'], coreLine: 'Warmth still drains from all it stalks.' },
    485: { noun: 'frost spirit', features: ['its translucent frost-fairy form', 'its gentle glow', 'its drifting presence'], coreLine: 'It still follows of its own quiet choice.' },
    486: { noun: 'dream leviathan', features: ['its dream-veiled body', 'its tide-and-thought form', 'its serene drift'], coreLine: 'In its dream, the lost home still stands.' },
    487: { noun: 'moonwater fairy', features: ['its moonlit translucent body', 'its reflected glow', 'its graceful form'], coreLine: 'It still pours moonlight into still water by night.' },
    488: { noun: 'timeline dragon', features: ['its charged shifting scales', 'its far-seeing eyes', 'its restless aura'], coreLine: 'It still reaches for a timeline just out of grasp.' },
    489: { noun: 'crystal-iron titan', features: ['its crystal-and-iron body', 'its mountainous bulk', 'its unshakable stance'], coreLine: 'It still stands unmoved by almost anything.' },
    490: { noun: 'forge-smith beast', features: ['its forge-hot hands', 'its darkfire flames', 'its smith’s bearing'], coreLine: 'It could still forge a blade worth a kingdom.' },
    491: { noun: 'war dragon', features: ['its alloy-plated hide', 'its battle-honed limbs', 'its dutiful bearing'], coreLine: 'It still does its duty without complaint.' },
    492: { noun: 'oracle construct', features: ['its charged crystalline body', 'its predictive mind', 'its humming core'], coreLine: 'It still calculates the odds of everything.' },
    493: { noun: 'crystal-ice dynamo', features: ['its charged ice-crystal body', 'its overflowing output', 'its glittering frame'], coreLine: 'Its output still defies any measure.' },
    494: { noun: 'storm-grove beast', features: ['its storm-charged mane', 'its verdant hide', 'its carefree air'], coreLine: 'It alone still carries no memory of the loss.' },
    495: { noun: 'void primarch', features: ['its primal spectral form', 'its half-there body', 'its ambiguous presence'], coreLine: 'Whether it helps or harms is still never clear.' },
    496: { noun: 'grove psychic', features: ['its verdant psychic body', 'its calm aura', 'its gentle presence'], coreLine: 'A quiet comfort still radiates from it.' },
    497: { noun: 'tempest dragon', features: ['its storm-dark wings', 'its howling aura', 'its fearsome bulk'], coreLine: 'Fear of it is still the only reasonable response.' },
    498: { noun: 'cosmic oracle', features: ['its star-patterned scales', 'its radiant fairy-light', 'its serene form'], coreLine: 'Its scale-patterns still shift before great events.' },
    499: { noun: 'star dragon', features: ['its star-fire scales', 'its blazing wings', 'its fateful bearing'], coreLine: 'Its hatching is still bound to that fateful day.' },
    500: { noun: 'last wonder', features: ['its luminous spectral form', 'its wondrous bearing', 'its quiet radiance'], coreLine: 'It is still the last wonder its lost home produced.' }
  };
