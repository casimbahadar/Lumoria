...
**Phenomena cluster (6 left):** BUBBLE → SMOKE → PERFUME → HOLOGRAM → EXPLOSIVE → WEATHER/ATMOSPHERIC *(SHADOW-CAST landed 2026-05-13, opening the cluster)*

**Roadmap totals:** 33 batches in roadmap (all 33 firm); 27 roadmap done (SHADOW-CAST landed 2026-05-13 opens Phenomena). **29 categories committed** (27 roadmap + 2 bonus PLANTS/FUNGI). **6 batches remaining** in roadmap: 6 Phenomena. BANNER permanently dropped 2026-05-12 session (parallels RIVER + URBAN drops in earlier Phase 1 work).
...
| Phenomena | IN PROGRESS 1/7 | SHADOW-CAST landed 2026-05-13 opens the cluster. Receives multiple deferrals from earlier clusters (shadow-puppet from TOY landed SHADOW-CAST-domain candidate; balloon → BUBBLE; fumarole → SMOKE; snowdrift/icicle/polar-night → WEATHER). |
