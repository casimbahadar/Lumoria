...
- `[282] Gearbit→Cogvex→Mechavast | Steel/Ground | automaton`
...
- `[318] Gaiavorn | Ground/Grass | earth-golem` (4m titan with living forest canopy — variant golem; could double as treant — flag)
- `[319] Voidraxis | Dark/Fairy | void / cosmic abstract being` (mythical — second void/cosmic alongside Cerebraith)
- `[320] Galvathon | Steel/Electric | automaton` (mechanical titan)
